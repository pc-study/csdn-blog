...
通过新添加的 box 初始化 Vagrantfile：  
 Vagrant 启动主机：  
 ![在这里插入图片描述](/csdn-blog/images/dcf23a84d76bc8d2a90f438f5b10b349.png)

#### 3、Vagrant 连接主机

通过 `vagrant ssh` 连接已成功部署的 Centos 环境：  
 ![在这里插入图片描述](/csdn-blog/images/38cb39b5a1e9d936b9df42d64db169bc.png)  
 修改 root 用户密码：  
 修改玩 root 密码后，通过 `su -` 
切换 
到 root 用户。
...
![在这里插入图片描述](/csdn-blog/images/600ccc031b6ff54806c15a250e783715.png)  
...
![在这里插入图片描述](/csdn-blog/images/41364292028a1965437f4080bba4bdc7.png)  
...
![在这里插入图片描述](/csdn-blog/images/d46e2b57a5fa40fec1f0afa4b32f5698.png)  
...
Tapdata Agent本地目录结构及功能简介：  
 ![在这里插入图片描述](/csdn-blog/images/5e770bfc41490ce51ee4c980e2f41f8c.png)  
 **至此，Tapdata 环境准备已经完成。🎉**
...
![在这里插入图片描述](/csdn-blog/images/f3b9ebc19917274d719e69480ce2b00c.png)  
...
![在这里插入图片描述](/csdn-blog/images/c5b564da128fac96a2986087a69d95a5.png)
...
![在这里插入图片描述](/csdn-blog/images/ba9104cc775aa4ee73c108e48b8a9d71.png)  
...
![在这里插入图片描述](/csdn-blog/images/8a7c086465026566493873ddb8728ef9.png)  
 启动并挂载数据库:
...
![在这里插入图片描述](/csdn-blog/images/d1cb2382cf69b2bb9cbb95ad8ace750b.png)
...
![在这里插入图片描述](/csdn-blog/images/d462a3c091645a51a3fa89c24e03bd03.png)  
 **12C：**
...
![在这里插入图片描述](/csdn-blog/images/6755394826b17aa7ed6a08641bac8d84.png)
...
根据提示填写信息，具体可参考：[Oracle 创建连接](https://www.yuque.com/tapdata/cloud/chan-pin-shou-ce_lian-jie-guan-li_lian-jie-pei-zhi_oracle)  
 ![在这里插入图片描述](/csdn-blog/images/04daffcbb0e0a85237691712a40e4d57.png)  
 **注意：这里的 `Schema` 值需要大写！**
...
设置任务，本次选择 `全量+增量` 类型，`全量写入模式`：  
 ![在这里插入图片描述](/csdn-blog/images/9fc413102a7b11a78925550b5517ea2a.png)

#### 3、选择同步表

这里选择需要同步的表，添加到目标端：  
 ![在这里插入图片描述](/csdn-blog/images/a8547642b1e9b98132e0f916fa8f34fa.png)  
 同时还支持 `改名` 和 `字段映射`：  
 ![在这里插入图片描述](/csdn-blog/images/5b54be82d038912b690a7935c00924fd.png)  
 点击完成按钮，即可。如果点击没有反应，可以尝试退回上一步，再回来点击完成。

#### 4、启动任务

点击完成后，任务状态为 `待启动`，可以通过启动任务来开始：  
 ![在这里插入图片描述](/csdn-blog/images/cb713a52ba3accfcab243bf0d666e7fa.png)  
...
确认没有表 Lucifer，启动任务：  
 ![在这里插入图片描述](/csdn-blog/images/47677412e1b58a7644bedb0346a31272.png)

#### 5、运行监控

点击 `运行监控` 可以看到同步情：  
 ![在这里插入图片描述](/csdn-blog/images/f50ee6bef19f6a0be7c09cc23b991967.png)
...
连接 Oracle 12C 目标端，查询 Lucifer 表的数据：  
 ![在这里插入图片描述](/csdn-blog/images/4c3a1f68d2ea7fb91ac1ba4786016eb1.png)  
 发现数据已经同步成功。
...
![在这里插入图片描述](/csdn-blog/images/9b8d1e1b9784abc3b989e0041e767eb7.png)  

...
cover: '/images/5a69762ab0f1a6dc43c9e5ae4f82d282.png'
---
...
![](/images/5a69762ab0f1a6dc43c9e5ae4f82d282.png)

**目标数据库版本支持：**

![](/images/47de19fae6df5c4287823a190741f022.png)

**源端数据库迁移对象支持：**

![](/images/73fe40633efa36160c605cb4b4a31473.png)

### 安装包下载

KDTS 迁移工具内置在 KES V9 安装包中：

![](/images/231cee13fa9e73112bdaa1072c76c6c1.png)

直接前往官网下载 KES V9 安装包即可：

![](/images/b378a607e8eb9967d6d1d7a985c43c9d.png)
...
![](/images/39e2f8977c10640ae9fd373b3660e19e.png)

KDTS 网页端的默认登录用户名及密码：**kingbase/kingbase**，登录后界面如下：

![](/images/d5c56fecfc03e36910331a14343b3ee7.png)
...
![](/images/cfc1c3815916e8367b7394cfebd0146c.png)

填写源端数据库信息，测试连通性：

![](/images/d5a2eedc40a57a6042f98480c79077ca.png)

源端数据库添加成功：

![](/images/58780f6eb43c58a28345c8b25573db00.png)
...
![](/images/fb0662e5f63d07b7d6657b77f371bab9.png)
...
![](/images/3b0563f0e665038d1413dae58c2cfcd8.png)

目标端数据库添加成功：

![](/images/48c53ed4bbc8c7bdb4f3f65a0c326bbc.png)

### 迁移任务新建

配置好源和目标端数据库之后，就可以创建迁移任务，开始迁移：

![](/images/1e2e484961e3a192151b38bb84b80c4d.png)

选择刚刚配置好的数据库：

![](/images/1bb1234f38a1b5fd7ad881a52d92e4ef.png)

这里选择需要迁移的模式，或者直接搜索需要的模式：

![](/images/884a35311662b9343e93cd9be3f3c4e3.png)

Oracle 默认自带的模式我们不需要，直接搜索 **LUCIFER** 模式（**记住一定要大写**）：

![](/images/71076187c0e52235d160c1ba59ea9f1d.png)

选择所有对象进行迁移（**记得要手动滑动一下，后面还有一些可以勾选的对象**）：

![](/images/4593afdcda907952e047cdbce954f036.png)

点击下一步继续（这里我之前已经创建 lucifer 模式，可以直接覆盖）：

![](/images/7432d223a3bb22cff8507184e135b090.png)

迁移所有对象：

![](/images/a5fc4b144a3a1aa8427b12ef56f8c275.png)

这一步可以配置很多参数来适配迁移任务，还可以通过 KDMS 工具来做转换，这里我打算不做任何修改，看一下会有什么效果：

![](/images/da7912cbefbc8534e9a89e2e4899a098.png)

保存并迁移，查看迁移进度：

![](/images/f2ad7efaac13b1a2900257eec040d050.png)

可以看到短短 16s 就迁移成功了（虽然我的源数据库很简单）：

![](/images/86c1c2f3405227091a0746e9747953e3.png)

通过概览也可以查看 KDTS 的使用情况：

![](/images/13208345ffb520e635dbd56acdc5e57f.png)

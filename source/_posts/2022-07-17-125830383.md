---
title: '单机：Oracle 19C 数据库一键安装'
date: 2022-07-17 12:09:00
categories:
  - Oracle 数据库
tags:
  - oracle
  - 数据库
abbrlink: 125830383
csdn_url: https://luciferliu.blog.csdn.net/article/details/125830383
description: '前言 本文将演示如何使用脚本一键安装 Oracle 19C 单机数据库的全过程。 安装前准备 在生产环境中，Linux 操作系统和网络一般不是由 DBA 来配置，为了更贴合生产使用，本脚本仅用于安装 Oracle 数据库，请提前安装好 Linux 操作系统。 主机版本 主机IP 主机内存 磁盘空间'
keywords: 'oracle, 数据库'
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| rhel7.6 | 10.211.55.100 | 8G | 50G | 19C | 33806152 | 33808367 | 12.2.0.1.30 |
...
> [单机：Oracle 19C 数据库一键安装](https://www.bilibili.com/video/BV17F411K7Vv)

...
tags:
  ...
  - 数据库
abbrlink: 143920136
csdn_url: https://luciferliu.blog.csdn.net/article/details/143920136
description: '有一套 Oracle 11GR2 数据库，开发想要针对表中的某些列授权查询，其他列不可查询，按照常规的授权方式是无法针对表中的某些列进行授权查询的，最基础的都需要针对表进行授权。 首先排除网上那些所谓支持列单独授权的言论： Oracle 目前没有这种写法（测试版本为 11GR2 数据库）。 解决方案'
keywords: 'oracle, 数据库'

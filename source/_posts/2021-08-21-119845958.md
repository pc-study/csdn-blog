...
tags:
  ...
  - vagrant
abbrlink: 119845958
csdn_url: https://luciferliu.blog.csdn.net/article/details/119845958
...
cover: '/images/d1f159b57946aee10adf7fc80dbf8e90.webp'
---
#### 目录
...
* + [下载项目](#_26)
  + [安装软件](#_38)
  + [下载 Oracle 安装包](#_Oracle__42)
* [安装](#_54)
* + [编辑 vagrant.yml 文件](#_vagrantyml__56)
  + [开始安装](#_109)
* [使用方式](#_123)
* + [连接主机](#_127)
  + [关闭主机](#_137)
...
![《零基础安装 Oracle 数据库》单机系列 ④ 一键快速安装 Oracle 19C 数据库](/images/6498280d0b8037bd8fce04581e1ee035.webp)
...
**📢 注意：** 项目 `single_db/software/19300` 目录中有一个 `software.txt` 文件，内容为你需要上传的 Oracle 安装包。请确保安装包名称与以下名称相同，否则安装 **失败**！
...
![《零基础安装 Oracle 数据库》单机系列 ④ 一键快速安装 Oracle 19C 数据库 - 图4](/images/d1f159b57946aee10adf7fc80dbf8e90.webp)
...
![《零基础安装 Oracle 数据库》单机系列 ④ 一键快速安装 Oracle 19C 数据库 - 图5](/images/8ac9bb6f33c43eda2f1e9a4a73dddc99.webp)
...
![《零基础安装 Oracle 数据库》单机系列 ④ 一键快速安装 Oracle 19C 数据库 - 图6](/images/3d6bf124ce6cc5797d1667188a9ec43f.webp)

...
tags:
  ...
  - 数据库
abbrlink: 138720235
csdn_url: https://luciferliu.blog.csdn.net/article/details/138720235
description: '前言 Oracle 一键安装脚本，演示 Oracle Linux 6.10 一键安装 Oracle 12CR2 RAC（231017）过程（全程无需人工干预）。 安装准备 1、安装好操作系统，建议安装图形化 2、配置好网络 3、挂载本地 ISO 镜像源 4、上传软件安装包（安装基础包，补丁包） 5、'

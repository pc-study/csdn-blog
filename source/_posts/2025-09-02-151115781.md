...
date: 2025-09-02 16:10:19
categories:
  - 数据库
tags:
  - 数据库
abbrlink: 151115781
csdn_url: https://luciferliu.blog.csdn.net/article/details/151115781
description: '大家好，这里是 DBA 学习之路，专注于提升数据库运维效率。 前言 某客户生产环境 Oracle 19c RAC 集群突发磁盘空间告警，经排查发现 Grid 审计日志占用了 30GB 磁盘空间，目录下堆积了520 万个审计文件： 审计配置保留了默认设置，导致sys用户的每项操作都生成审计记录，在长期'
keywords: '数据库'
...
![外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传](https://img-home.csdnimg.cn/images/20230724024159.png?origin_url=%2Fassets%2Fimg%2Fnews%2F-1.png&pos_id=img-sx2KRwGU-1756800609475)

...
![](/csdn-blog/images/4b6f4dc458f49d2eb2ce5883127102b6.png)

正常应该显示为：

![](/csdn-blog/images/e87f5342be77f5e3adc4e9c107d8882c.png)
...
![](/csdn-blog/images/bc6460541a9b2975db34dfd6678ca61b.png)

结果发现还是乱码，查看一下数据库主机的客户端字符集：

![](/csdn-blog/images/bf07d747490f7b22b4087935fdbfcd90.png)
...
![](/csdn-blog/images/d3840ed9c9ee5e21cc6e4257137ce93b.png)
...
![](/csdn-blog/images/945748028c92a6fb4c33c9f427e00203.png)
...
![](/csdn-blog/images/6a3956a1c0fbb301984c02cf3af6ca07.png)

**📢 注意**：使用脚本安装好的数据库主机，会在 `/home/oracle/.bash_profile` 文件中自动配置好客户端字符集：

![](/csdn-blog/images/5cc219ad4fea3a02105fb9dc417b1bc4.png)
...
![](/csdn-blog/images/3b322c74161a629dcd1e0def0c0f872e.png)
...
![](/csdn-blog/images/08414abbb17b9f08345f2aeb9fddf8ed.png)
...
![](/csdn-blog/images/ea2694b2619e1fb138b7e1f1e01264f1.png)
...
![](/csdn-blog/images/d0bd1252cfd5152a26b834c9c308e916.png)

再次查询测试结果：

![](/csdn-blog/images/39e1568d541c514aee236a8f94c34fce.png)

显示乱码了，但是有朋友说，你这也不是一开始问题里的 ??? 啊！行，那就再测试一下取消客户端字符集：

![](/csdn-blog/images/549fcffe80bc0c0036df32355c81df31.png)
...
![](/csdn-blog/images/68fb420ee5294556f9bc204ad7862d77.png)

再次查询测试结果：

![](/csdn-blog/images/65896f4034cbf39885f3fc166d6a34c1.png)

好嘛！三个问号来了。

此时，即使我们把客户端字符集恢复正确：

![](/csdn-blog/images/d0c34bd891db91d9ad9fbe9ef6317ed6.png)

再次查询：

![](/csdn-blog/images/9d41b3503bbdbbb0015613ce1e5d4093.png)
...
![](/csdn-blog/images/90498291643c2cfb3a3185818111a582.png)

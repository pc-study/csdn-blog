...
![](/csdn-blog/images/28add9bbe5e5084e19377507f029871a.png)

直接双击打开 dmg：

![](/csdn-blog/images/f839ce28abd9cc801bddf22781a2ffdd.png)

将 oracle2word 程序移动到任何你想要移动的位置，我这里移动到 check 目录下（大家自行选择）：

![](/csdn-blog/images/462daec7111937565d2d6f5a8dff195c.png)
...
![](/csdn-blog/images/dfc089c8528a400a186a9a658fcfcb62.png)
...
![](/csdn-blog/images/bafcd19ae63c61f63ba3581ff24cc34a.png)

程序启动比较慢，稍等一会儿即可，这里我增加了机器码注册功能，一机一码：

![](/csdn-blog/images/7f1f629060dc931233e613511da0bbc4.png)

![](/csdn-blog/images/260a98ff4f1680cdd338e3bf056ddf36.png)

激活成功后，直接跳转到熟悉的使用界面：

![](/csdn-blog/images/46cf02b6cc9430430899aba4f7841f51.png)

将数据库巡检生成的 tar.gz 文件上传到巡检文件夹位置：

![](/csdn-blog/images/3b159b72877b89ca22e72974dde12fac.png)

填好对应的巡检信息之后，点击生成报告：

![](/csdn-blog/images/a4a23fc3444c68e2be8644f26965c6a4.png)

几秒钟，一个 word 巡检报告就生成了：

![](/csdn-blog/images/07aa3d0a5254e3032e2edeb2a83f4236.png)

![](/csdn-blog/images/8ffb93ee86a5f25d6d1df77e94a0718a.png)

## 报告展示

Word 报告内容基本没有变化，更之前版本一致，目录如下：

![](/csdn-blog/images/ed609b15b55f72a5a042365d3558f060.png)

![](/csdn-blog/images/974ea57cbc8977784a20dad7f27c5703.png)

![](/csdn-blog/images/276fc80a4f92db0a46e8e844320bd587.png)

其中比较亮眼的就是会有一些性能趋势图：

![](/csdn-blog/images/def3e0f0976ec905e3eede56b096678a.png)

![](/csdn-blog/images/906844db439b5d242078fba344fd07f8.png)

...
tags:
  ...
  - oracle
abbrlink: 142649802
csdn_url: https://luciferliu.blog.csdn.net/article/details/142649802
description: '大家好，这里是 Lucifer三思而后行，专注于提升数据库运维效率。 目录 前言 mount 阶段 控制文件 Checkpoint 分析 10046 分析 控制文件内容 - immediate trace name CONTROLF backup controlfile to trace 总结 往期'
keywords: '数据库, oracle'
...
* [mount 阶段](#mount__7)
* + [控制文件](#_10)
  + [Checkpoint 分析](#Checkpoint__131)
  + [10046 分析](#10046__206)
  + [控制文件内容](#_325)
  + - [immediate trace name CONTROLF](#immediate_trace_name_CONTROLF_330)
    - [backup controlfile to trace](#backup_controlfile_to_trace_1297)
* [总结](#_1473)
* [往期精彩文章推荐](#_1482)
...
>  file # 1：第二个控制文件 /u01/app/oracle/fast\_recovery\_area/lucifer/control02.ctl  
>  block#：block 号  
>  blocks：block 数量  
>  files：文件数

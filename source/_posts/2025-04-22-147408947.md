...
tags:
  ...
  - 数据库
abbrlink: 147408947
csdn_url: https://luciferliu.blog.csdn.net/article/details/147408947
description: '大家好，这里是 DBA学习之路，专注于提升数据库运维效率。 目录 前言 下载补丁 安装过程 检查 OPatch 坑一 更新 OPatch 解压 24396050 补丁包 安装前检查 坑二 坑三 安装补丁 写在最后 前言 上篇文章 《Oracle RAC 触发 BUG，crsd 无限重启！》 中提到通'
keywords: 'oracle, 数据库'
...
* [下载补丁](#_11)
* [安装过程](#_20)
* + [检查 OPatch](#_OPatch_22)
  + [坑一](#_35)
  + [更新 OPatch](#_OPatch_51)
  + [解压 24396050 补丁包](#_24396050__74)
  + [安装前检查](#_83)
  + [坑二](#_91)
  + [坑三](#_107)
  + [安装补丁](#_194)
...
![避坑指南｜Oracle RAC 补丁安装踩坑实录，你中招几个？](/images/29dde1dfae74282465140a05ba4a4f06.webp)

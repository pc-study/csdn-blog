---
title: '华为欧拉 openEuler 23.09 一键安装 Oracle 19C 单机 ASM'
date: 2024-06-18 16:18:25
categories:
  - Oracle 数据库
tags:
  - oracle
  - 数据库
abbrlink: 139776883
csdn_url: https://luciferliu.blog.csdn.net/article/details/139776883
description: '前言 Oracle 一键安装脚本，演示 openEuler 23.09 一键安装 Oracle 19C 单机 ASM 过程（全程无需人工干预）。 ⭐️ 脚本下载地址：Shell脚本安装Oracle数据库 安装准备 1、安装好操作系统，建议安装图形化 2、配置好网络 3、挂载本地 ISO 镜像源 4、'
keywords: 'oracle, 数据库'
cover: '/img/covers/oracle.svg'
---
## 前言

Oracle 一键安装脚本，演示 openEuler 23.09 一键安装 Oracle 19C 单机 ASM 过程（全程无需人工干预）。
...
OracleShellInstall 开始安装，详细安装过程可查看日志： tail -2000f /soft/print_shell_install_20240508141405.log                                                                                  
...
正在解压 Oracle 安装包以及补丁......已完成 (耗时: 179 秒)
正在安装 Grid 软件以及补丁......已完成 (耗时: 430 秒)
正在安装 Oracle 软件以及补丁......已完成 (耗时: 149 秒)
正在创建数据库......已完成 (耗时: 833 秒)
正在优化数据库......已完成 (耗时: 171 秒)

恭喜！Oracle 单机 ASM 安装成功 (耗时: 1920 秒)，现在是否重启主机：[Y/N] Y
...
LSNRCTL for Linux: Version 19.0.0.0.0 - Production on 08-MAY-2024 14:57:11
...
Start Date                08-MAY-2024 14:51:30
Uptime                    0 days 0 hr. 5 min. 41 sec
Trace Level               off
...
SQL*Plus: Release 19.0.0.0.0 - Production on Wed May 8 14:57:12 2024
Version 19.3.0.0.0
...
sys@LUCIFER 2024-05-08 14:57:12> show parameter name

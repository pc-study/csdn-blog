...
tags:
  ...
  - vagrant
abbrlink: 119878435
csdn_url: https://luciferliu.blog.csdn.net/article/details/119878435
...
cover: '/images/ff0f8dc8ae3a18d481d8e5f616e29730.webp'
---
## 前言
...
![《零基础安装 Oracle 数据库》RAC集群系列 ❺ 简单两步快速安装 Oracle 21C RAC 数据库](/images/6498280d0b8037bd8fce04581e1ee035.webp)
...
**📢 注意：** 项目 `rac_db/software/21300` 目录中有一个 `software.txt` 文件，内容为你需要上传的 Oracle 安装包。请确保安装包名称与以下名称相同，否则安装 **失败**！
...
![《零基础安装 Oracle 数据库》RAC集群系列 ❺ 简单两步快速安装 Oracle 21C RAC 数据库 - 图4](/images/ff0f8dc8ae3a18d481d8e5f616e29730.webp)
...
![《零基础安装 Oracle 数据库》RAC集群系列 ❺ 简单两步快速安装 Oracle 21C RAC 数据库 - 图5](/images/8599eb5091032ccea0f71928377b0352.webp)
...
![《零基础安装 Oracle 数据库》RAC集群系列 ❺ 简单两步快速安装 Oracle 21C RAC 数据库 - 图6](/images/6e8f31fd3ffc2245987dfea0b7454fab.webp)

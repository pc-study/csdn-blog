...
tags:
  ...
  - oracle
abbrlink: 149227585
csdn_url: https://luciferliu.blog.csdn.net/article/details/149227585
description: '大家好，这里是 DBA 学习之路，专注于提升数据库运维效率。 目录 前言 问题复现 问题分析 源库 (9i) 新库 (19c) 问题解决 尝试一：直接 UPDATE GLOBAL\NAME 表 (失败) 尝试二：使用 RENAME 命令 (成功，但有波折) 写在最后 前言 今天协助客户将 Oracl'
keywords: '数据库, oracle'
cover: '/images/a4a952af4f31fc02909c7fad549d22ef.webp'
---
...
* + [源库 (9i)](#_9i_47)
  + [新库 (19c)](#_19c_71)
* [问题解决](#_94)
* + [尝试一：直接 UPDATE GLOBAL\_NAME 表 (失败)](#_UPDATE_GLOBAL_NAME___96)
  + [尝试二：使用 RENAME 命令 (成功，但有波折)](#_RENAME___116)
* [写在最后](#_232)
...
![Oracle 数据库升级踩坑：DBLink ORA-02019 问题解决思路](/images/183d45ea4b75c7eaae8b0a8f1de9ea9f.webp)
...
![Oracle 数据库升级踩坑：DBLink ORA-02019 问题解决思路 - 图2](/images/075c40343568eaeff056311e9069fc87.webp)
...
### 尝试一：直接 UPDATE GLOBAL\_NAME 表 (失败)
...
**问题**：明明存在名为 `LUCIFER` 的 DBLink (`dba_db_links` 可查)，却无法删除，提示不存在！**为什么删不掉？** 搜了下 MOS，有一篇文档 [DB Parameters - Global Database Name (GLOBAL\_DB\_NAME) (Doc ID 2643771.1)](https://support.oracle.com/epmos/faces/DocContentDisplay?id=2643771.1) 比较符合：

![Oracle 数据库升级踩坑：DBLink ORA-02019 问题解决思路 - 图3](/images/a4a952af4f31fc02909c7fad549d22ef.webp)

这个跟我遇到的问题一致，都是 rename 方式修改了 global\_name 之后无法删除已创建的 DBLink，解决方案：

![Oracle 数据库升级踩坑：DBLink ORA-02019 问题解决思路 - 图4](/images/9fc423bbb2a083637de563211c9b389c.webp)

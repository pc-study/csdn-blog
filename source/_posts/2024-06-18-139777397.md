---
title: '统信 UOS V20 1001(c) 一键安装 Oracle 11GR2 单机'
date: 2024-06-18 16:30:50
categories:
  - Oracle 数据库
tags:
  - c语言
  ...
  - 开发语言
abbrlink: 139777397
csdn_url: https://luciferliu.blog.csdn.net/article/details/139777397
description: '前言 Oracle 一键安装脚本，演示 统信 UOS V20 1001© 一键安装 Oracle 11GR2 单机（全程无需人工干预）。 ⭐️ 脚本下载地址：Shell脚本安装Oracle数据库 前置准备 1、安装好操作系统，建议安装图形化 2、配置好网络 3、挂载本地 ISO 镜像源 4、上传软件'
keywords: 'c语言, oracle, 开发语言'
cover: '/img/covers/oracle.svg'
---
## 前言

Oracle 一键安装脚本，演示 统信 UOS V20 1001© 一键安装 Oracle 11GR2 单机（全程无需人工干预）。
...
-rwxr-xr-x 1 root root     220512 6月  17 21:45 OracleShellInstall
-rwx------ 1 root root 1395582860 6月  17 17:02 p13390677_112040_Linux-x86-64_1of7.zip
-rwx------ 1 root root 1151304589 6月  17 17:02 p13390677_112040_Linux-x86-64_2of7.zip
```
...
OracleShellInstall 开始安装，详细安装过程可查看日志： tail -2000f /soft/print_shell_install_20240617221953.log                                          
...
正在解压 Oracle 安装包以及补丁......已完成 (耗时: 29 秒)
正在安装 Oracle 软件以及补丁......已完成 (耗时: 180 秒)
正在创建监听......已完成 (耗时: 7 秒)
正在创建数据库......已完成 (耗时: 196 秒)
正在优化数据库......已完成 (耗时: 10 秒)

恭喜！Oracle 一键安装执行完成 (耗时: 487 秒)，现在是否重启主机：[Y/N] Y
...
LSNRCTL for Linux: Version 11.2.0.4.0 - Production on 17-JUN-2024 22:35:05
...
Start Date                17-JUN-2024 22:32:04
...
SQL*Plus: Release 11.2.0.4.0 Production on Mon Jun 17 22:35:16 2024
...
sys@LUCIFER 2024-06-17 22:35:16> show parameter name

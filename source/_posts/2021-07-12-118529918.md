...
下面我就来手把手教大家如何在Linux上安装Oracle数据库。  
 ![](/csdn-blog/images/d5d490074e242b51bc06da3d78b02736.png)
...
使用XShell工具连接Linux主机root用户：  
 ![](/csdn-blog/images/93381df57cbc43f199aa2c215f2f3070.png)
...
![](/csdn-blog/images/06627787b6348f5324763efdbe68d685.png)
...
Parallels Desktop 挂载 Linux 主机镜像：  
 ![](/csdn-blog/images/1e67020ac4fdd223054386d8db4e8a0c.png)  
...
![](/csdn-blog/images/b72bb22488074c1f2dd6f1e90da0e53c.png)  
...
![](/csdn-blog/images/c652c7e166171173a83fe6bacf12c0f0.png)
...
![](/csdn-blog/images/5fe7118759a62bd89a04c05e05aad2d8.png)
...
![](/csdn-blog/images/4986d6455a5aacd1063ce414afa2c2e5.png)  
 ### 11、配置系统资源限制
...
![](/csdn-blog/images/ea6810fce47c27c0e2eb11b6aa5c9b3c.png)
...
![](/csdn-blog/images/a8e7edaecbc83766e62791e20d0a047f.png)
...
![](/csdn-blog/images/17f7c37beadb1a2ae7452d1f7bd40baa.png)  
 右键打开终端工具：  
 ![](/csdn-blog/images/fe820ede68693a1e070befb715fdc5d6.png)  
...
![](/csdn-blog/images/05a1c01a0869b2347003fa9cd3898b37.png)  
 不接收 Oracle 邮件推送：  
 ![](/csdn-blog/images/af7bae629622353f668108b1464cb6ab.png)  
 不更新 Oracle：  
 只安装 Oracle 软件：  
 ![](/csdn-blog/images/0ab72a8a668d79e2ecff9b3b46f052e2.png)  
 单
实例
安装：  
 选择企业版：  
 ![](/csdn-blog/images/2ef7d1571d3f742b5b7f3806bbc44a07.png)  
 选择安装目录：  
 ![](/csdn-blog/images/8970a8d455e6068dab6d1301ae0340cf.png)选择安装用户组：  
 ![](/csdn-blog/images/7fdec1d0fd8694d8088ce5c58d03b363.png)  
 Oracle 安装前必要检查：  
 ![](/csdn-blog/images/88e35a126bff4d0742a0c7e5036bce34.png)  
...
执行完点击retry重试：  
 ![](/csdn-blog/images/d9745971c56a9d3423788ba884110b64.png)  
 执行 root 脚本：  
 ![](/csdn-blog/images/ea7a32d6f84c9c156400b3a053061209.png)  
 root用户下执行脚本：
...
![](/csdn-blog/images/c512fd47fe1ae6039eee2879fde5c332.png)  
 ![](/csdn-blog/images/9f1db3f638d06f7deb45fbcbd9172cfd.png)  
 安装完成后，重启主机。
...
![](/csdn-blog/images/f2a82d33661186f74ca5d34a736eb8a3.png)
...
![](/csdn-blog/images/656dcf731c4310deb1977c36f03b9301.png)  
 创建数据库：  
 选择自定义模式：  
 输入实例名：  
 ![](/csdn-blog/images/bd33a3a4ee7891502e200c4da313fa02.png)  
 这里填写数据库实例名称和 dbname，本次填写 orcl。  
 不安装EM工具。  
 这里输入SYS和SYSTEM用户的密码，需要记住。  
 ![](/csdn-blog/images/4201096d8128622bbefa5fea23ede1c4.png)  
 这里选择前面建好的/oradata目录用来存放数据文件。  
 ![](/csdn-blog/images/dc9165ea4584e3616c4bb77278ef67d3.png)  
 不开启闪回日志，不开启归档日志，可以建好库之后再手动修改。  
 ![](/csdn-blog/images/59b4849c19b7886fd1832469fdf315d5.png)  
 数据库内存分配，选择手动分配，占用物理内存70%左右。  
 block\_size根据实际情况选择，一旦建库无法修改，默认8K。  
 ![](/csdn-blog/images/3ef183f1a9085f6f3cefea7ed9a78c58.png)  
 字符集根据需要进行选择，默认AL32UTF8。  
 ![](/csdn-blog/images/89a967267d83c72be333d2df53f5a5f7.png)  
 ![](/csdn-blog/images/43453fb95cd338f23c0a233830c98285.png)  
 等待建库完成即可。  
 ![](/csdn-blog/images/7c60dacab4301d344cc2e87d4430c2bf.png)

## 五、连接数据库

确保监听正常启动，并监听数据库：  
 ![](/csdn-blog/images/68da9188b5e1bda262a56b9863f0d492.png)

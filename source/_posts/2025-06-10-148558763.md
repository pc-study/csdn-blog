...
tags:
  ...
  - vastbase
abbrlink: 148558763
csdn_url: https://luciferliu.blog.csdn.net/article/details/148558763
description: '大家好，这里是 DBA 学习之路，专注于提升数据库运维效率。 目录 前言 介绍 环境准备 安装前配置 检查操作系统版本 关闭防火墙 关闭 selinux 安装依赖 时区配置 配置 RemoveIPC 关闭透明大页 系统参数配置 修改资源限制 创建用户 创建目录 解压安装包 VastBase 安装 i'
keywords: '数据库, linux, vastbase'
cover: '/images/396608868f5d7eca5a1b6cd484af6c43.webp'
---
...
* + [检查操作系统版本](#_42)
  + [关闭防火墙](#_54)
  + [关闭 selinux](#_selinux_63)
  + [安装依赖](#_83)
  + [时区配置](#_131)
  + [配置 RemoveIPC](#_RemoveIPC_145)
  + [关闭透明大页](#_178)
  + [系统参数配置](#_229)
  + [修改资源限制](#_280)
  + [创建用户](#_297)
  + [创建目录](#_311)
  + [解压安装包](#_319)
* [VastBase 安装](#VastBase__336)
* + [installer 安装（推荐）](#installer__337)
  + [运行安装程序](#_340)
  + [配置 License 授权文件](#_License__624)
  + [连接数据库](#_655)
...
![海量 Vastbase G100 V2.2.15 安装部署手册](/images/396608868f5d7eca5a1b6cd484af6c43.webp)

VCA 认证已考：

![海量 Vastbase G100 V2.2.15 安装部署手册 - 图2](/images/ca29f6073ed42cff34cc0aa48a92f1b8.webp)
...
![海量 Vastbase G100 V2.2.15 安装部署手册 - 图3](/images/282dc09d27bd8d4d81c55959c6957010.webp)
...
![海量 Vastbase G100 V2.2.15 安装部署手册 - 图4](/images/70ade2dc6fa037b31f4e938aa3f25127.webp)
...
![海量 Vastbase G100 V2.2.15 安装部署手册 - 图5](/images/178855360b9557490356a9d33393ae8f.webp)
...
![海量 Vastbase G100 V2.2.15 安装部署手册 - 图6](/images/bb28821ee70db85e742d6d2353a2308a.webp)
...
![海量 Vastbase G100 V2.2.15 安装部署手册 - 图7](/images/689fd8e8d98b2be437900c2a2a09885b.webp)

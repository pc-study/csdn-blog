---
title: 'Oracle 一键巡检自动生成 Word 报告'
date: 2024-11-08 12:11:50
categories:
  - 数据库
tags:
  - 数据库
  - oracle
abbrlink: 143622261
csdn_url: https://luciferliu.blog.csdn.net/article/details/143622261
description: '大家好，这里是 Lucifer三思而后行，专注于提升数据库运维效率。 目录 前言 介绍 演示 Oracle 数据库巡检 生成 Word 报告 - 放入巡检文件 配置 Python 环境 生成 Word 报告 Word 报告演示 往期精彩文章 前言 Oracle 数据库巡检通常需要消耗大量时间和精力，'
keywords: '数据库, oracle'
...
* [介绍](#_9)
* [演示](#_40)
* + [Oracle 数据库巡检](#Oracle__41)
  + [生成 Word 报告](#_Word__176)
  + - [放入巡检文件](#_177)
    - [配置 Python 环境](#_Python__186)
    - [生成 Word 报告](#_Word__257)
* [Word 报告演示](#Word__313)
* [往期精彩文章](#_321)
...
![](https://img-blog.csdnimg.cn/img_convert/b6304a22400c40808992b708f50aaa82.png)
...
**oscheck.sh** 是用来巡检主机相关信息以及配置检查。**dbcheck*.sql*\* 是用来巡检数据库相关信息，12c 包括 12c 以后的版本：18c，19c，21c，23ai。
...
![image.png](https://img-blog.csdnimg.cn/img_convert/321fa4cd35650764e31e65a5d886610e.png)
...
![](https://img-blog.csdnimg.cn/img_convert/bbfada21a2d37cb8fdf4e2d97c200a6c.png)
...
Word 报告可以查看：[Lucifer 有限公司-Oracle数据库4034009431\_LUCIFER巡检报告\_20241107.pdf](https://www.modb.pro/doc/137772)

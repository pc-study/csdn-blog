...
tags:
  ...
  - 数据库
abbrlink: 136733343
csdn_url: https://luciferliu.blog.csdn.net/article/details/136733343
description: '前言 Oracle 数据库巡检通常需要消耗大量时间和精力，包括收集数据库以及主机的相关信息。针对 Word 报告的样式调整，也是重复和费事的，所以我针对 Oracle 巡检所需检查的信息以及报告模板，写了一套自动巡检并且生成报告的脚本。巡检人员只需要执行脚本，脚本会自动生成一个完整的 Word 报告'
keywords: 'oracle, word, 数据库'
cover: '/images/8eefcec32c9273dab177584232db7f0f.webp'
---
## 前言
...
![Oracle 一键巡检自动生成 Word 报告](/images/8eefcec32c9273dab177584232db7f0f.webp)
...
![image.png](/images/8d98a8fff4a30faa13fc698932581679.webp)
...
![Oracle 一键巡检自动生成 Word 报告 - 图2](/images/f7fbfdc8150ba9ff5f4ff2865da82ff8.webp)

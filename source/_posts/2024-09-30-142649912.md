...
tags:
  ...
  - 达梦
abbrlink: 142649912
csdn_url: https://luciferliu.blog.csdn.net/article/details/142649912
description: '大家好，这里是公众号 DBA学习之路，分享一些学习国产数据库路上的知识和经验。 前言 相信很多用管了 Oracle 数据库的 DBA，很喜欢用 快速连接到数据库的方式。但是，刚安装好的达梦数据库执行 却会报错： 初看好像不支持，但是达梦其实也是支持通过操作系统认证使用免密的方式登录数据库，不过需要人'
keywords: 'ffmpeg, 数据库, 达梦'

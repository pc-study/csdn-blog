...
keywords: 'oracle, 数据库'
cover: '/images/af667c343224140f7afb9b6e02bc478b.webp'
---
...
![Oracle RAC 安装工具截图](/images/af667c343224140f7afb9b6e02bc478b.webp)
...
![Oracle RAC 安装完成截图](/images/2f96da5c9de50908320e65b27f1f9e78.webp)
...
![multipath 配置截图](/images/28f8b89b956f256aef86e6e10c4f18fb.webp)
...
![multipath 生效验证](/images/4a2bf50163fae9f09839804477c1b65e.webp)
...
![UDEV 配置验证](/images/dc5b09b82274602bb714102c85e23aa8.webp)
...
![ASMCA 启动界面](/images/073291507ce824a869413a264a8622b8.webp)

按照向导步骤创建 OMS 磁盘组：

![磁盘组创建步骤1](/images/433e5a3580961e7884b83ecaacb99b58.webp)

![磁盘组创建步骤2](/images/35b4a4c719e65d50bcf7d6bdc6d2336d.webp)

##### 创建 ACFS Volume

![Volume 创建界面](/images/0347696dce2aeea3cb659591c54674ec.webp)

![Volume 配置界面](/images/d35d69c83b033f09d10d40d6f9cde7be.webp)

![Volume 创建确认](/images/4630dbf291eb702e4db2b191ebc7ecb9.webp)
...
![ACFS 创建步骤1](/images/7fb867cf38f16a722209daa36c544617.webp)

![ACFS 创建步骤2](/images/0de775f25031e7faf8255d9865f051fc.webp)

![ACFS 创建完成](/images/721df933f5c7bbf4f2e4e69d2cdebcc4.webp)
...
![ACFS 挂载验证](/images/4d15ae215b0a68a1a5933da4752d6e38.webp)

验证挂载状态：

![挂载状态确认1](/images/9bdcaea3064895bcf08ebcc93e4bb98a.webp)

![挂载状态确认2](/images/91a73ede2a9462cc4606a7d02289d276.webp)
...
![官方依赖包要求](/images/65dcc6f8959167868d7817a4d3266122.webp)
...
![语言环境错误示例](/images/1ed9fabca1112645c361e7730a0325d4.webp)
...
![安装类型选择](/images/73121e21875f9eeba87cba175dfaba63.webp)

**步骤 2：** 软件更新配置

![软件更新配置](/images/2188ecbf805a311dc285a986735bc6d0.webp)

**步骤 3：** 先决条件检查

![先决条件检查](/images/977128032073f9a803380a70265188ee.webp)

**步骤 4：** 安装详细信息配置

![安装详细信息](/images/575b5fa77ab0a9bfbe96417a12075a7f.webp)

**关键配置点：**

* 全部勾选所有可选组件

![组件选择](/images/b7a47d2dfc4c92d3419c9295756b5b63.webp)

* 设置管理员密码（建议使用：Welcome1）

![管理员密码设置](/images/7793feeec8d4d8f03d7353285b47d76a.webp)

**步骤 5：** 数据库连接配置

填写之前创建的 RAC 数据库信息，**关键点：必须使用 SCAN IP 地址**

![数据库连接配置](/images/cf893d86d4336e3b92a5d8f0436510b3.webp)

数据库连接验证：

![数据库验证](/images/86a8e08a8f01926ffcbbc044f9e2e384.webp)

**步骤 6：** 先决条件验证和自动修复

![先决条件验证](/images/b7a76bbaf53c64a9fc87eb806ff8f69a.webp)

使用 Auto Fix 功能解决问题：

![自动修复](/images/e461dc7c80258e560856a4ca0360c422.webp)

![修复完成](/images/0923e3df051ac5a313403b26601290eb.webp)

**步骤 7：** SYSMAN 密码设置

设置 EMCC 登录用户密码：

![SYSMAN 密码设置](/images/4a2f48f8b7523d8cbb83b9e7a87c3f9b.webp)

**步骤 8：** 软件库位置配置

**重要：** 选择 ACFS 共享磁盘作为软件库位置：

![软件库位置配置](/images/95ccce31f2e981802a73fee52b34a533.webp)

**步骤 9：** 端口配置确认

确认以下端口配置并开启防火墙策略：

![端口配置](/images/5b020b5a5c29b54adf5c1a94a75aaf7a.webp)

**步骤 10：** 开始安装

![开始安装](/images/a247e67c1804119f0045097f09247d01.webp)

##### 安装过程监控

![安装进度监控](/images/f5239fe772d3dc018f6f5cdc91cd4c21.webp)

等待安装完成：

![安装基本完成](/images/dc6bec164436b9cffb4a8741b3be3039.webp)

##### 后安装配置

执行必要的 root 脚本：

![root 脚本执行提示](/images/c00d65890f35e0c2ffb7b62a28441a57.webp)
...
![安装完成界面](/images/5708ab4aa20047a72b39681a71db586f.webp)
...
![EMCC 登录界面](/images/366a6240cf4f83b53ad044e671572dd6.webp)

![主页面](/images/51f96fb6d3a012a8ed5f1f28f1e7c48d.webp)

导航到 Agent 部署页面：

![Agent 部署导航](/images/ba5ae2f1ea497172388658e5ad74f793.webp)

![Agent 添加选项](/images/437588dedfea4e4b93e37cbcd2d1a53f.webp)

配置 Agent 部署参数：

![Agent 配置1](/images/8c1132f579681be941cec027934fb960.webp)

![Agent 配置2](/images/a2f9f8b13da2cc92116715b33c56e40b.webp)

![Agent 配置3](/images/fcf0055765812ac006752c43796d42fd.webp)

![Agent 配置4](/images/81596e7cdeed79c69d572e4d6705b214.webp)

等待部署完成：

![Agent 部署进度](/images/9c9b66b3e35cebc9ca8dffbe4a75ee75.webp)

![Agent 部署完成](/images/016dbd11f1ca9c265e33c09d58b86ed7.webp)

##### 3.5.2 添加 OMS 节点

通过 EMCC 的过程库添加第二个 OMS 节点：

![过程库导航](/images/a9eefdc61b0e128eb270f2ea77f1ddab.webp)

搜索"添加"相关的过程：

![搜索添加过程](/images/19e60e9b6d63fee1d2a308c653a3ca3a.webp)

**重要提醒：** 确保每个 OMS 节点的端口配置保持一致，以简化后续维护工作。

![OMS 添加配置1](/images/017c24c8a87fe410dd8701da6c6e1427.webp)

![OMS 添加配置2](/images/1c743604cc3526a57420cc0190c9fada.webp)
...
![共享目录配置](/images/7bf37b6d5c117ea0fc19a17749c5d49d.webp)

继续配置向导：

![配置步骤1](/images/211ae395fc310837026ad7eee923e539.webp)

![配置步骤2](/images/5988263866231941d0658f15a3a22213.webp)

![配置步骤3](/images/0c1a6cd313ea7e5117ffa4119ba45d9d.webp)

![配置步骤4](/images/69b011c6152a05f3ed9ba197e131927c.webp)

等待第二节点部署完成：

![第二节点部署进度1](/images/dd1db6471ff6ab698ef2400fa5dea550.webp)

![第二节点部署进度2](/images/6f5880d282d50a505fdd14aa43ae2af9.webp)

![第二节点部署完成](/images/e0973622f72e03c98e1e220378e339d6.webp)
...
![节点1访问测试1](/images/ead9aa547a442773d2c5019b9d617dbf.webp)

![节点1访问测试2](/images/61835d0a09c58fef1f63118cbf58793d.webp)

![节点1功能验证](/images/edb1d28be293f4eceb506fb6581a970a.webp)

**节点 2 访问：** `https://192.168.6.81:7803/em`

![节点2访问测试1](/images/c3efc8d9a1853fdcb1fe489286e069be.webp)

![节点2访问测试2](/images/8c4da22fd5b652633e70cb800f28fb02.webp)

![节点2功能验证](/images/8d731bea6d3b6646dd1db83e8595c9f9.webp)
...
![故障模拟](/images/596cea0feef6b2c1b172b48983c984da.webp)

验证节点 1 已无法访问：

![节点1故障确认](/images/2b89a585345659117abe624993cc60da.webp)

验证节点 2 继续正常服务：

![节点2正常服务确认](/images/1fa52c9efcbe1baf068534e535e2810a.webp)
...
![SLB 配置参考](/images/4104f6af17f1618751e114b7b2683e57.webp)

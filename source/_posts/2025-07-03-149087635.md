...
![Oracle RAC 安装工具截图](/csdn-blog/images/af667c343224140f7afb9b6e02bc478b.png)
...
![Oracle RAC 安装完成截图](/csdn-blog/images/2f96da5c9de50908320e65b27f1f9e78.png)
...
![multipath 配置截图](/csdn-blog/images/28f8b89b956f256aef86e6e10c4f18fb.png)
...
![multipath 生效验证](/csdn-blog/images/4a2bf50163fae9f09839804477c1b65e.png)
...
![UDEV 配置验证](/csdn-blog/images/dc5b09b82274602bb714102c85e23aa8.png)
...
![ASMCA 启动界面](/csdn-blog/images/073291507ce824a869413a264a8622b8.png)

按照向导步骤创建 OMS 磁盘组：

![磁盘组创建步骤1](/csdn-blog/images/433e5a3580961e7884b83ecaacb99b58.png)

![磁盘组创建步骤2](/csdn-blog/images/35b4a4c719e65d50bcf7d6bdc6d2336d.png)

##### 创建 ACFS Volume

![Volume 创建界面](/csdn-blog/images/0347696dce2aeea3cb659591c54674ec.png)

![Volume 配置界面](/csdn-blog/images/d35d69c83b033f09d10d40d6f9cde7be.png)

![Volume 创建确认](/csdn-blog/images/4630dbf291eb702e4db2b191ebc7ecb9.png)
...
![ACFS 创建步骤1](/csdn-blog/images/7fb867cf38f16a722209daa36c544617.png)

![ACFS 创建步骤2](/csdn-blog/images/0de775f25031e7faf8255d9865f051fc.png)

![ACFS 创建完成](/csdn-blog/images/721df933f5c7bbf4f2e4e69d2cdebcc4.png)
...
![ACFS 挂载验证](/csdn-blog/images/4d15ae215b0a68a1a5933da4752d6e38.png)

验证挂载状态：

![挂载状态确认1](/csdn-blog/images/9bdcaea3064895bcf08ebcc93e4bb98a.png)

![挂载状态确认2](/csdn-blog/images/91a73ede2a9462cc4606a7d02289d276.png)
...
![官方依赖包要求](/csdn-blog/images/65dcc6f8959167868d7817a4d3266122.png)
...
![语言环境错误示例](/csdn-blog/images/1ed9fabca1112645c361e7730a0325d4.png)
...
![安装类型选择](/csdn-blog/images/73121e21875f9eeba87cba175dfaba63.png)

**步骤 2：** 软件更新配置

![软件更新配置](/csdn-blog/images/2188ecbf805a311dc285a986735bc6d0.png)

**步骤 3：** 先决条件检查

![先决条件检查](/csdn-blog/images/977128032073f9a803380a70265188ee.png)

**步骤 4：** 安装详细信息配置

![安装详细信息](/csdn-blog/images/575b5fa77ab0a9bfbe96417a12075a7f.png)

**关键配置点：**

* 全部勾选所有可选组件

![组件选择](/csdn-blog/images/b7a47d2dfc4c92d3419c9295756b5b63.png)

* 设置管理员密码（建议使用：Welcome1）

![管理员密码设置](/csdn-blog/images/7793feeec8d4d8f03d7353285b47d76a.png)

**步骤 5：** 数据库连接配置

填写之前创建的 RAC 数据库信息，**关键点：必须使用 SCAN IP 地址**

![数据库连接配置](/csdn-blog/images/cf893d86d4336e3b92a5d8f0436510b3.png)

数据库连接验证：

![数据库验证](/csdn-blog/images/86a8e08a8f01926ffcbbc044f9e2e384.png)

**步骤 6：** 先决条件验证和自动修复

![先决条件验证](/csdn-blog/images/b7a76bbaf53c64a9fc87eb806ff8f69a.png)

使用 Auto Fix 功能解决问题：

![自动修复](/csdn-blog/images/e461dc7c80258e560856a4ca0360c422.png)

![修复完成](/csdn-blog/images/0923e3df051ac5a313403b26601290eb.png)

**步骤 7：** SYSMAN 密码设置

设置 EMCC 登录用户密码：

![SYSMAN 密码设置](/csdn-blog/images/4a2f48f8b7523d8cbb83b9e7a87c3f9b.png)

**步骤 8：** 软件库位置配置

**重要：** 选择 ACFS 共享磁盘作为软件库位置：

![软件库位置配置](/csdn-blog/images/95ccce31f2e981802a73fee52b34a533.png)

**步骤 9：** 端口配置确认

确认以下端口配置并开启防火墙策略：

![端口配置](/csdn-blog/images/5b020b5a5c29b54adf5c1a94a75aaf7a.png)

**步骤 10：** 开始安装

![开始安装](/csdn-blog/images/a247e67c1804119f0045097f09247d01.png)

##### 安装过程监控

![安装进度监控](/csdn-blog/images/f5239fe772d3dc018f6f5cdc91cd4c21.png)

等待安装完成：

![安装基本完成](/csdn-blog/images/dc6bec164436b9cffb4a8741b3be3039.png)

##### 后安装配置

执行必要的 root 脚本：

![root 脚本执行提示](/csdn-blog/images/c00d65890f35e0c2ffb7b62a28441a57.png)
...
![安装完成界面](/csdn-blog/images/5708ab4aa20047a72b39681a71db586f.png)
...
![EMCC 登录界面](/csdn-blog/images/366a6240cf4f83b53ad044e671572dd6.png)

![主页面](/csdn-blog/images/51f96fb6d3a012a8ed5f1f28f1e7c48d.png)

导航到 Agent 部署页面：

![Agent 部署导航](/csdn-blog/images/ba5ae2f1ea497172388658e5ad74f793.png)

![Agent 添加选项](/csdn-blog/images/437588dedfea4e4b93e37cbcd2d1a53f.png)

配置 Agent 部署参数：

![Agent 配置1](/csdn-blog/images/8c1132f579681be941cec027934fb960.png)

![Agent 配置2](/csdn-blog/images/a2f9f8b13da2cc92116715b33c56e40b.png)

![Agent 配置3](/csdn-blog/images/fcf0055765812ac006752c43796d42fd.png)

![Agent 配置4](/csdn-blog/images/81596e7cdeed79c69d572e4d6705b214.png)

等待部署完成：

![Agent 部署进度](/csdn-blog/images/9c9b66b3e35cebc9ca8dffbe4a75ee75.png)

![Agent 部署完成](/csdn-blog/images/016dbd11f1ca9c265e33c09d58b86ed7.png)

##### 3.5.2 添加 OMS 节点

通过 EMCC 的过程库添加第二个 OMS 节点：

![过程库导航](/csdn-blog/images/a9eefdc61b0e128eb270f2ea77f1ddab.png)

搜索"添加"相关的过程：

![搜索添加过程](/csdn-blog/images/19e60e9b6d63fee1d2a308c653a3ca3a.png)

**重要提醒：** 确保每个 OMS 节点的端口配置保持一致，以简化后续维护工作。

![OMS 添加配置1](/csdn-blog/images/017c24c8a87fe410dd8701da6c6e1427.png)

![OMS 添加配置2](/csdn-blog/images/1c743604cc3526a57420cc0190c9fada.png)
...
![共享目录配置](/csdn-blog/images/7bf37b6d5c117ea0fc19a17749c5d49d.png)

继续配置向导：

![配置步骤1](/csdn-blog/images/211ae395fc310837026ad7eee923e539.png)

![配置步骤2](/csdn-blog/images/5988263866231941d0658f15a3a22213.png)

![配置步骤3](/csdn-blog/images/0c1a6cd313ea7e5117ffa4119ba45d9d.png)

![配置步骤4](/csdn-blog/images/69b011c6152a05f3ed9ba197e131927c.png)

等待第二节点部署完成：

![第二节点部署进度1](/csdn-blog/images/dd1db6471ff6ab698ef2400fa5dea550.png)

![第二节点部署进度2](/csdn-blog/images/6f5880d282d50a505fdd14aa43ae2af9.png)

![第二节点部署完成](/csdn-blog/images/e0973622f72e03c98e1e220378e339d6.png)
...
![节点1访问测试1](/csdn-blog/images/ead9aa547a442773d2c5019b9d617dbf.png)

![节点1访问测试2](/csdn-blog/images/61835d0a09c58fef1f63118cbf58793d.png)

![节点1功能验证](/csdn-blog/images/edb1d28be293f4eceb506fb6581a970a.png)

**节点 2 访问：** `https://192.168.6.81:7803/em`

![节点2访问测试1](/csdn-blog/images/c3efc8d9a1853fdcb1fe489286e069be.png)

![节点2访问测试2](/csdn-blog/images/8c4da22fd5b652633e70cb800f28fb02.png)

![节点2功能验证](/csdn-blog/images/8d731bea6d3b6646dd1db83e8595c9f9.png)
...
![故障模拟](/csdn-blog/images/596cea0feef6b2c1b172b48983c984da.png)

验证节点 1 已无法访问：

![节点1故障确认](/csdn-blog/images/2b89a585345659117abe624993cc60da.png)

验证节点 2 继续正常服务：

![节点2正常服务确认](/csdn-blog/images/1fa52c9efcbe1baf068534e535e2810a.png)
...
![SLB 配置参考](/csdn-blog/images/4104f6af17f1618751e114b7b2683e57.png)

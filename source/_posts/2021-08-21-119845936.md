...
tags:
  ...
  - vagrant
abbrlink: 119845936
csdn_url: https://luciferliu.blog.csdn.net/article/details/119845936
...
![《零基础安装 Oracle 数据库》单机系列 ③ 一键快速安装 Oracle 18C 数据库](/images/6498280d0b8037bd8fce04581e1ee035.webp)
...
![《零基础安装 Oracle 数据库》单机系列 ③ 一键快速安装 Oracle 18C 数据库 - 图2](/images/1866b7221473ac03f63196b09975244a.webp)

**📢 注意：** 项目 `single_db/software/18000` 目录中有一个 `software.txt` 文件，内容为你需要上传的 Oracle 安装包。请确保安装包名称与以下名称相同，否则安装 **失败**！
...
![《零基础安装 Oracle 数据库》单机系列 ③ 一键快速安装 Oracle 18C 数据库 - 图5](/images/644c43399983590f415749804cc0f3b4.webp)
...
![《零基础安装 Oracle 数据库》单机系列 ③ 一键快速安装 Oracle 18C 数据库 - 图6](/images/3d6bf124ce6cc5797d1667188a9ec43f.webp)

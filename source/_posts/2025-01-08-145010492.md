...
tags:
  ...
  - oracle
abbrlink: 145010492
csdn_url: https://luciferliu.blog.csdn.net/article/details/145010492
description: '目录 📚 前言 🌴 SQL 介绍 🌼 什么是 SQL 🌀 SQL 的类型 🌵 学习 SQL 的作用 🍄 数据库是什么 🐥 SQL 基础语言学习 🐤 CREATE TABLE – 创建表 🐑 INSERT – 插入数据 🐼 SELECT – 查询数据 🐫 DISTINCT – 去除重复值 🐸 WHER'
keywords: '数据库, sql, oracle'
...
* + [🌼 什么是 SQL](#__SQL_11)
  + [🌀 SQL 的类型](#_SQL__20)
  + [🌵 学习 SQL 的作用](#__SQL__25)
  + [🍄 数据库是什么](#__39)
* [🐥 SQL 基础语言学习](#_SQL__54)
* + [🐤 CREATE TABLE – 创建表](#_CREATE_TABLE___70)
  + [🐑 INSERT – 插入数据](#_INSERT___113)
  + [🐼 SELECT – 查询数据](#_SELECT___140)
  + [🐫 DISTINCT – 去除重复值](#_DISTINCT___167)
  + [🐸 WHERE – 条件过滤](#_WHERE___190)
  + [🐹 AND & OR – 运算符](#_AND__OR___219)
  + [🐰 ORDER BY – 排序](#_ORDER_BY___266)
  + [🐱 UPDATE – 更新数据](#_UPDATE___295)
  + [🐨 DELETE – 删除数据](#_DELETE___316)
  + [🐵 TRUNCATE TABLE – 清除表数据](#_TRUNCATE_TABLE___339)
  + [🐯 DROP TABLE – 删除表](#_DROP_TABLE___354)
* [🚀 SQL 高级言语学习](#_SQL__369)
* + [🚢 LIKE – 查找类似值](#_LIKE___370)
  + [🚤 IN – 锁定多个值](#_IN___410)
  + [⛵️ BETWEEN – 选取区间数据](#_BETWEEN___424)
  + [🚂 AS – 别名](#_AS___447)
  + [🚁 JOIN – 多表关联](#_JOIN___476)
  + [🚜 UNION – 合并结果集](#_UNION___530)
  + [🚌 NOT NULL – 非空](#_NOT_NULL___579)
  + [🚐 VIEW – 视图](#_VIEW___611)
* [🎯 SQL 常用函数学习](#_SQL__657)
* + [🍔 AVG – 平均值](#_AVG___666)
  + [🍕 COUNT – 汇总行数](#_COUNT___685)
  + [🍘 MAX – 最大值](#_MAX___716)
  + [🍢 MIN – 最小值](#_MIN___730)
  + [🍰 SUM – 求和](#_SUM___743)
  + [🍪 GROUP BY – 分组](#_GROUP_BY___755)
  + [🍭 HAVING – 句尾连接](#_HAVING___777)
  + [🍷 UCASE/UPPER – 大写](#_UCASEUPPER___798)
  + [🍶 LCASE/LOWER – 小写](#_LCASELOWER___812)
  + [👛 LEN/LENGTH – 获取长度](#_LENLENGTH___826)
  + [🍗 ROUND – 数值取舍](#_ROUND___841)
  + [🍞 NOW/SYSDATE – 当前时间](#_NOWSYSDATE___865)
* [🍺 写在最后](#__880)
* [好书推荐](#_889)
...
![基础篇：数据库 SQL 入门教程 - 图42](/images/d59aeb89afe68367b567c63ed4b92efe.webp)  
 **实例：**
...
![基础篇：数据库 SQL 入门教程 - 图43](/images/971a7275d517625a4bf6e7851a403799.webp)  
...
![基础篇：数据库 SQL 入门教程 - 图44](/images/31d623822f1bc011a1b963ad266c7a29.webp)  
...
![基础篇：数据库 SQL 入门教程 - 图45](/images/49606eca682dc4a2c2de86dc35e82955.webp)  
 同理，`NULL` 也可：
...
![基础篇：数据库 SQL 入门教程 - 图46](/images/a032591bc7a2b30f5d64fdfde07e0a8a.webp)  
 查询上面这个视图：  
 ![基础篇：数据库 SQL 入门教程 - 图47](/images/0e2913e1f0d8b372cfdcd656b14b37fb.webp)  
...
![基础篇：数据库 SQL 入门教程 - 图48](/images/0457e6d6911de8231e723d61637084b6.webp)  
 ![基础篇：数据库 SQL 入门教程 - 图49](/images/c8e426543dbf28e8932401b610619641.webp)  
...
![基础篇：数据库 SQL 入门教程 - 图50](/images/02d785b6d9d5296e69d41576b8de2ada.webp)  
...
![基础篇：数据库 SQL 入门教程 - 图51](/images/91acb8f2dde47757fbe696f9458207b4.webp)  
...
![基础篇：数据库 SQL 入门教程 - 图52](/images/803a1c0474b17819dd0fdbdae14fd476.webp)
...
![基础篇：数据库 SQL 入门教程 - 图53](/images/f184f4d2d089d9bdc55a6a50ec8dce39.webp)  
 **COUNT(DISTINCT 列名) ：**
...
![基础篇：数据库 SQL 入门教程 - 图54](/images/fc620e839d872220c653d8633f0ef9c7.webp)  
 **COUNT(列名) ：**
...
![基础篇：数据库 SQL 入门教程 - 图55](/images/8114da9188198dcdaad0bbc59cd62bb7.webp)
...
![基础篇：数据库 SQL 入门教程 - 图56](/images/9da0842c525f7cbc099bf045950a4990.webp)
...
![基础篇：数据库 SQL 入门教程 - 图57](/images/925a3dd2e35b7146735f7c0793feafe3.webp)
...
![基础篇：数据库 SQL 入门教程 - 图58](/images/cda8a96f727537f3fe91c83b56fb4c73.webp)
...
![基础篇：数据库 SQL 入门教程 - 图59](/images/1243cf316d43b26e9abd1253013a082f.webp)  
 如果不加 `GROUP BY`  则会报错：  
 ![基础篇：数据库 SQL 入门教程 - 图60](/images/81a5cc51f6f0735063a422cd0c6e1be9.webp)  
...
![基础篇：数据库 SQL 入门教程 - 图61](/images/62636dbc1624061c759828d824ee28db.webp)
...
![基础篇：数据库 SQL 入门教程 - 图62](/images/9d1b90dec4bb4de8d151e17daedad44c.webp)
...
![基础篇：数据库 SQL 入门教程 - 图63](/images/26aae03175e7ae77d04a5b276a8b73ed.webp)
...
![基础篇：数据库 SQL 入门教程 - 图64](/images/da9196df75065ed2a41fa22603c05274.webp)
...
![基础篇：数据库 SQL 入门教程 - 图65](/images/5aac38435d4ffce495450801288a9174.webp)  
 ![基础篇：数据库 SQL 入门教程 - 图66](/images/a8a6ed09b08de1d249ae5df5beddd56c.webp)  
 📢 注意：`ROUND` 取舍是 **四舍五入** 的！
...
![基础篇：数据库 SQL 入门教程 - 图67](/images/801361796a73d46b78a48ac367e5f441.webp)
...
![基础篇：数据库 SQL 入门教程 - 图68](/images/7e4ad2de863a47d5a5e5ffd4a5de6f14.webp)  
...
![基础篇：数据库 SQL 入门教程 - 图69](/images/de3c165bf98fec011fe2fe7fef7ad3a3.webp)

107张图表+209段代码+88个法则，菜鸟进阶bi备！基于标准SQL编写，明示各RDBMS（PostgreSQL DB2 MySQL Oracle SQL Server）的差异！

**本书🔗：**

> 京东：https://item.jd.com/12212242.html
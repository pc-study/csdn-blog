...
![](/csdn-blog/images/d40b1574272a25a7da8e35362a4c2efa.png)

**管理存储库的最低 CPU、RAM 和硬盘空间要求：**

![](/csdn-blog/images/9b1a95112c84ee830bd25265307a144f.png)

**📢注意**：EMCC 服务端物理内存至少 10G（建议 16G 以上），磁盘空间 500G 往上。

### EMCC 需要开放端口

![](/csdn-blog/images/8ae1ffa6360ac318dafc0b02a694218f.png)
...
![](/csdn-blog/images/01b7b3eff4bf0d9f769dfc50bc61423a.png)

点击上方软件下载链接会跳转到 [edelivery](https://edelivery.oracle.com/) 进行下载：

![](/csdn-blog/images/549788d332f2fddc566b1048c4ee01f9.png)
...
![](/csdn-blog/images/0824e8e7b4cee1c5ce5d960ed2542a63.png)

![](/csdn-blog/images/12c77c75cfc9d408ff82f9e095e8d9c1.png)

![](/csdn-blog/images/46825eb756715198cccd5ee07ae8873d.png)

选择上面我们提前创建好的安装目录：

![](/csdn-blog/images/3330ac71e2e3671e824dd2f3a56e1ba6.png)

这里忽略提示即可：

![](/csdn-blog/images/8454d6f73fb4dcea2928d0add473d3a9.png)

全部勾选：

![](/csdn-blog/images/cd45af06c57dbf27901783f262a31272.png)

密码有复杂度要求，设置后不能忘记（Passw0rd）：

![](/csdn-blog/images/2e5ea634f5eda8a19453aa1eb160cfa3.png)

数据库信息填写上方创建的数据库（验证通过会进入下一步）：

![](/csdn-blog/images/3b5f3645bff60c80d4465f4e1e95372f.png)

选择使用 SYS 用户安装：

![](/csdn-blog/images/d90228474bc18997951111a259d5b7ea.png)

![](/csdn-blog/images/ab6e5a6b92ef27d9aed2f5a23687f3e3.png)

SYSMAN 是 EMCC 登录用户，密码需要记住（Passw0rd）：

![](/csdn-blog/images/fb200def2d9ccd2179c8b8568a8c8673.png)

![](/csdn-blog/images/65969ac76dbdcac5d0689ba89840fd40.png)

以下端口均需开启：

![](/csdn-blog/images/ca704ed6132132d1291f715fca2ffbb7.png)

开始安装：

![](/csdn-blog/images/90dc35ebdce41a4db08fa4ea2864949b.png)

等待安装完成即可：

![](/csdn-blog/images/72d268224cbacd118e9776b927a92219.png)

执行 root.sh 脚本：

![](/csdn-blog/images/62c8ca4e4af7c2d5d3f28c535df99583.png)
...
![](/csdn-blog/images/85d4529bec81eeb2abbf5bda171ad10e.png)
...
![](/csdn-blog/images/00f7995f62999e6b800d75f6bc2cf8e6.png)

登录之后的界面如下：

![](/csdn-blog/images/275b3fc716fc7a346bf2600cd8961223.png)

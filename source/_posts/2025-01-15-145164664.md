...
tags:
  ...
  - 数据库
abbrlink: 145164664
csdn_url: https://luciferliu.blog.csdn.net/article/details/145164664
description: '大家好，这里是公众号 DBA学习之路，致力于分享数据库领域相关知识。 目录 前言 问题分析 enq: TM - contention 问题排查 外键索引缺失检查 并行 DML 检查 付费群咨询 写在最后 前言 今天收到应用反馈：在 发生了一起卡顿，持续 15 秒，到 结束，需要帮忙排查下原因。 先介'
keywords: 'oracle, 数据库'
cover: '/images/e78bc09350efffd4fe654b78a1b26e4e.webp'
---
...
* [前言](#_4)
* [问题分析](#_14)
* [enq: TM - contention](#enq_TM__contention_73)
* [问题排查](#_91)
* + [外键索引缺失检查](#_96)
  + [并行 DML 检查](#_DML__121)
* [付费群咨询](#_150)
...
等待事件对应的 SQL\_ID 为 `bwf9rt5u93cpx`，查看具体的 SQL：
...
> 通过 awr 报告可以发现：  
>  ![实战篇：enq: TM - contention 等待事件分析](/images/e78bc09350efffd4fe654b78a1b26e4e.webp)  
>  ![实战篇：enq: TM - contention 等待事件分析 - 图2](/images/49a5ad6401604f394d3d84e6bafcc84b.webp)  
>  基本上所有的等待事件都指向了 GC 集群之间资源回收与高速缓存融合的问题。这个就是因为集群资源未能及时回收且集群高速缓存融合速度慢有很大的关系：  
>  ![image.png](/images/7007775489dc3f42d8dafa54f56fb5ba.webp)  
>  ![image.png](/images/4d0ac6115491b39ebc63a5c2831501a3.webp)  

---
title: '统信 UOS V20 1070(e) 一键安装 Oracle 19C 单机'
date: 2024-06-18 16:39:23
categories:
  - Oracle 数据库
tags:
  - oracle
  - 数据库
abbrlink: 139777727
csdn_url: https://luciferliu.blog.csdn.net/article/details/139777727
description: '前言 Oracle 一键安装脚本，演示 统信 UOS V20 1070(e) 一键安装 Oracle 19C 单机（全程无需人工干预）。 ⭐️ 脚本下载地址：Shell脚本安装Oracle数据库 前置准备 1、安装好操作系统，建议安装图形化 2、配置好网络 3、挂载本地 ISO 镜像源 4、上传软件'
keywords: 'oracle, 数据库'
cover: '/img/covers/oracle.svg'
---
## 前言

Oracle 一键安装脚本，演示 统信 UOS V20 1070(e) 一键安装 Oracle 19C 单机（全程无需人工干预）。
...
-rwx------ 1 root root 3059705302  6月 17 14:11 LINUX.X64_193000_db_home.zip
-rwxr-xr-x 1 root root     220886  6月 17 14:06 OracleShellInstall
```
...
OracleShellInstall 开始安装，详细安装过程可查看日志： tail -2000f /soft/print_shell_install_20240617141328.log                                                                                  
正在获取操作系统信息......已完成 (耗时: 1 秒)
正在配置本地软件源......已完成 (耗时: 1 秒)
正在安装依赖包......已完成 (耗时: 151 秒)
正在禁用防火墙......已完成 (耗时: 5 秒)
正在禁用 selinux......已完成 (耗时: 1 秒)
正在配置 nsyctl......已完成 (耗时: 0 秒)
正在配置主机名和 /etc/hosts......已完成 (耗时: 0 秒)
正在创建用户和组......已完成 (耗时: 14 秒)
正在创建安装目录......已完成 (耗时: 0 秒)
...
正在解压 Oracle 安装包以及补丁......已完成 (耗时: 107 秒)
正在安装 Oracle 软件以及补丁......已完成 (耗时: 369 秒)
正在创建监听......已完成 (耗时: 10 秒)
正在创建数据库......已完成 (耗时: 898 秒)
正在优化数据库......已完成 (耗时: 33 秒)

恭喜！Oracle 一键安装执行完成 (耗时: 1599 秒)，现在是否重启主机：[Y/N] Y
...
LSNRCTL for Linux: Version 19.0.0.0.0 - Production on 18-JUN-2024 12:34:15
...
Start Date                17-JUN-2024 14:41:25
Uptime                    0 days 21 hr. 52 min. 50 sec
Trace Level               off
...
SQL*Plus: Release 19.0.0.0.0 - Production on Tue Jun 18 12:34:41 2024
Version 19.3.0.0.0
...
sys@LUCIFER 2024-06-18 12:34:41> show parameter name

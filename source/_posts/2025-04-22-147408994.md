...
tags:
  ...
  - ffmpeg
abbrlink: 147408994
csdn_url: https://luciferliu.blog.csdn.net/article/details/147408994
description: '大家好，这里是公众号 DBA学习之路，分享一些学习国产数据库路上的知识和经验。 目录 前言 问题分析 解决问题 更新 OPatch 解压补丁 安装补丁 前言 今天检查一套 Oracle RAC 12.2.0.1 数据库，检查集群状态时，发现集群命令一直夯着没反应： 经过一顿分析，终于解决问题，比较简'
keywords: 'oracle, bug, ffmpeg'
---
...
![image.png](/csdn-blog/images/5116424412b3ec1593c4c73e067efb27.png)
...
![image.png](/csdn-blog/images/eee429b17a33831f022e08ef06aadc03.png)

![image.png](/csdn-blog/images/0abc18a45636d1f0d575d684449fa827.png)

![image.png](/csdn-blog/images/80a09bc3c3f2ee7aa54a9ea3c6838509.png)

![image.png](/csdn-blog/images/b274421a50a6c87f8dab6e452c3be820.png)

MOS 内容与问题日志完全一致，确认是 BUG，需要进行补丁修复：

![image.png](/csdn-blog/images/0eca8ae86edfd03b5fe8ceb2cc932476.png)
...
![image.png](/csdn-blog/images/413f5d5d53b552c4658af739de0c88bf.png)

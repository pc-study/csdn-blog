---
title: 'December 2021 Apache Log4j Vulnerabilities on Oracle Products and Services(Doc ID 2827611.1)'
date: 2021-12-16 18:54:18
categories:
  - Oracle 数据库
tags:
  - apache
  ...
  - 数据库
abbrlink: 121981461
csdn_url: https://luciferliu.blog.csdn.net/article/details/121981461
description: 'In this Document PURPOSE SCOPE DETAILS Applicability of these vulnerabilities to Oracle cloud environments Applicability of Security Alert CVE-2021-45'
keywords: 'apache, oracle, 数据库'
...
* [SCOPE](#SCOPE_8)
* [DETAILS](#DETAILS_11)
* + [Applicability of these vulnerabilities to Oracle cloud environments](#Applicability_of_these_vulnerabilities_to_Oracle_cloud_environments_23)
  + [Applicability of Security Alert CVE-2021-45046 to Oracle on-premises products](#Applicability_of_Security_Alert_CVE202145046_to_Oracle_onpremises_products_31)
  + [1.0 Oracle products with patches or mitigation available](#10_Oracle_products_with_patches_or_mitigation_available_35)
  + [2.0 Oracle products with patches pending](#20_Oracle_products_with_patches_pending_104)
  + [3.0 Oracle products under investigation](#30_Oracle_products_under_investigation_194)
  + [4.0 Oracle products with impacted underlying Oracle components](#40_Oracle_products_with_impacted_underlying_Oracle_components_234)
  + [5.0 Oracle products not requiring patches](#50_Oracle_products_not_requiring_patches_250)

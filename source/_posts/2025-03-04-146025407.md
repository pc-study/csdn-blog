...
date: 2025-03-04 19:57:11
categories:
  - 多媒体处理
tags:
  - ffmpeg
abbrlink: 146025407
csdn_url: https://luciferliu.blog.csdn.net/article/details/146025407
description: '大家好，这里是公众号 DBA学习之路，分享一些学习国产数据库路上的知识和经验。 目录 前言 介绍 前置准备 集群扩容 配置 install.conf（单机） SSH 免密配置（单机） 扩容前准备 执行扩容（单机） 检查集群 前言 记得在金仓公众号看到过一篇文章：重生之我在甲方做DBA，从单机到集群，'
keywords: 'ffmpeg'
cover: '/images/6fac80c4c9ad144283bda71b26628bdd.webp'
---
...
* [前置准备](#_25)
* [集群扩容](#_80)
* + [配置 install.conf（单机）](#_installconf_81)
  + [SSH 免密配置（单机）](#SSH__115)
  + [扩容前准备](#_152)
  + [执行扩容（单机）](#_189)
  + [检查集群](#_356)
...
![金仓 KES V9 主备集群一键在线扩容 - 命令行方式](/images/6fac80c4c9ad144283bda71b26628bdd.webp)
...
![金仓 KES V9 主备集群一键在线扩容 - 命令行方式 - 图2](/images/7b7c9291c15d63fb997fd1461f93ce1a.webp)
...
![金仓 KES V9 主备集群一键在线扩容 - 命令行方式 - 图3](/images/9bffa7268a4ab0077c551079a76ca84a.webp)
...
待扩容节点配置 `install.conf` 文件，首先需要修改 all\_ip 选项：
...
![金仓 KES V9 主备集群一键在线扩容 - 命令行方式 - 图4](/images/4396ed712e53afbecc84af26a0504fb0.webp)
...
![金仓 KES V9 主备集群一键在线扩容 - 命令行方式 - 图5](/images/2c191032403b09ceb06ff3f3369b4d49.webp)
...
![金仓 KES V9 主备集群一键在线扩容 - 命令行方式 - 图6](/images/725afc0edafeb9499a9b3b4c3fe2124f.webp)

有一些集群的参数与单机配置有区别，所以需要提前修改操作系统参数，否则扩容过程中会有一些告警和报错：

![金仓 KES V9 主备集群一键在线扩容 - 命令行方式 - 图7](/images/2e31f8f8c093988e655b002e696e31eb.webp)

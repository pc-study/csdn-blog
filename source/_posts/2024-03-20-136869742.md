...
![](/csdn-blog/images/f515489e40c9015f8d5d91e81db3c921.png)

![](/csdn-blog/images/73acf309d3fa7745b27b8ccf7b8d403a.png)

这里选择上面我们解压的模板（根据所需选择，这里我选择 Small）：

![](/csdn-blog/images/5d88a3764dc9b776aa644afd1c52b88a.png)

![](/csdn-blog/images/57e311c3985dcabe5fb29f6a56f976ec.png)

![](/csdn-blog/images/c5cc2a5736ceb8097e4ed3351090a7d5.png)

建议不开启归档，减少后续运维事项：

![](/csdn-blog/images/6cb39c6685d2b935ed460b3d46118576.png)

注意监听状态需要提前开启，否则会报错：

![](/csdn-blog/images/68b4ae9231bca08621a5609301c44e5a.png)

![](/csdn-blog/images/665825bc9b1952a55c479d0bbccde784.png)

19C 数据库内存尽量设置在 8G 以上：

![](/csdn-blog/images/4ac0a5b6d3bd280275ebc63171319db0.png)

![](/csdn-blog/images/8e070cf7b40d61fb7837d392d3ff0c93.png)

![](/csdn-blog/images/389e0b44d01335aa0ab8d3ee8033ecd4.png)

![](/csdn-blog/images/3109442d1652a293d7a9a90be1b67c91.png)

密码不符合复杂度也没关系，点击 YES 就行：

![](/csdn-blog/images/2cf65d1bdf0afaefb82fd4721b132e1b.png)

开始创建数据库：

![](/csdn-blog/images/1e024a54d0c4ff91abff25abace143d3.png)

![](/csdn-blog/images/c9a3b39b6819ca683946005a6eb0d8f3.png)

等待完成即可：

![](/csdn-blog/images/d61c6346773c2a45d8a99b589ac3650f.png)

![](/csdn-blog/images/ce277a4a36acabe67ccb59acfa439958.png)
...
![](/csdn-blog/images/162eae858acb1507c6ebc5b59797c87d.png)

![](/csdn-blog/images/50c99bbc567fbee99d6652406c863d67.png)

![](/csdn-blog/images/c312f2bfbc3b2c1728f0219203933958.png)

![](/csdn-blog/images/56434e0d78944f42e01fc36f9014cfc8.png)

全部勾选：

![](/csdn-blog/images/17c95e7b113a988c7ea38c2658cc4df4.png)

密码要设置好，不能忘记：

![](/csdn-blog/images/f2b0b92be7ca2c35269e1a88c84af5dc.png)

数据库信息填写上方创建的数据库（验证通过会进入下一步）：

![](/csdn-blog/images/2179c5b7d28f03569d46bd52eb7024a5.png)

![](/csdn-blog/images/cc6ac9baf5269580501014f89cdbed79.png)

SYSMAN 是 EMCC 登录用户，密码需要记住：

![](/csdn-blog/images/242e9900f2bee1b10e4fcf2d8e5a39a0.png)

![](/csdn-blog/images/5db11b9a752b06524a15b44afa4d3c78.png)

以下端口均需开启：

![](/csdn-blog/images/50f6fa47bb5b0f6087d2420848fc0de9.png)

开始安装：

![](/csdn-blog/images/c039c41d6b6142ed9ca1cdac5dd4fe31.png)

等待安装完成即可：

![](/csdn-blog/images/f653288ba515d4b23245686f246ffc94.png)

需要执行 root.sh 脚本：

![](/csdn-blog/images/6d4f573e20f56e150c4e390b4546f7d0.png)
...
![](/csdn-blog/images/e8490e9cab42bbec547c3f2c3a3c8466.png)
...
![](/csdn-blog/images/dd547680296d14a30fd9acaeafd8334e.png)

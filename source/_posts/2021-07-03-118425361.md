...
![Oracle 通过脚本一键生成按月分区表 - 图3](/images/77db7076fda18802a49b58355be738b8.webp)

### 2、创建procedure

执行脚本创建procedure：  
 ![Oracle 通过脚本一键生成按月分区表 - 图4](/images/b1699adfc3ce63be92b2b25f817fee98.webp)  
 ```
...
![Oracle 通过脚本一键生成按月分区表 - 图5](/images/d5de16cf0743009a2b63330a54369edb.webp)  
 **📢 注意：确认procedure已成功创建。**
...
![Oracle 通过脚本一键生成按月分区表 - 图6](/images/fb8ab102c2a341cf8a46b6c783a9305b.png)  
 执行脚本如下：
...
![Oracle 通过脚本一键生成按月分区表 - 图9](/images/34d2011ce36e172d29a892fef6228906.png)  
 **查询分区表：**

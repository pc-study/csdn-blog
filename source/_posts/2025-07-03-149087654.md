...
cover: '/images/170a5dc0f63ec10eb1506d3166abaa54.png'
---
...
![image.png](/images/170a5dc0f63ec10eb1506d3166abaa54.png)

![数据生成功能](/images/020e90a713fef9eeba3c2cb6f2e8fdcd.png)

![寻求 AI 功能](/images/6f411a57f4d29f1e27ee401f3f0313ea.png)
...
![](/images/998dda0eca26b82aa8b48799c306a264.png)
...
![image.png](/images/c897a69151c3332aedfab7a28e753115.png)
...
![image.png](/images/31e7fb17e0a7cfc483439dc4257e4302.png)

![image.png](/images/40e67d688d184ab126c305c8d23b103e.png)

![image.png](/images/820d54a43ec5c8ae73413538a84a52cd.png)
...
![image.png](/images/58fa88181e5f813cbe46f6fbdced1ef1.png)

让我来看看结果如何：

![image.png](/images/167b7f93e13dca78f7030ecdb99649d6.png)

![image.png](/images/a8d1b489290f9800649a363e19d2d6c3.png)

没想到小百灵不仅提供了表结构，还创建了几个索引进行优化。

连接我的达梦测试库测试一下：

![image.png](/images/d82bce6aef995484f2f07623bccfd82c.png)

首先创建一下表空间和用户：

![image.png](/images/82b04bec34b9c9b04bbc08f07f9909bd.png)

![image.png](/images/39bd35d25691597a748cb9e42435c81e.png)

连接新建用户 lucifer，测试是否能建表：

![image.png](/images/3319b26687344b7bf3f9d8239c9d1507.png)

![image.png](/images/9decf99ccb816917586d2f6a6b7c9e92.png)

根据小百灵提示授予 `RESOURCE` 权限即可：

![image.png](/images/d82baab1da88767a9058d6c0467b3b59.png)

再次测试建表：

![image.png](/images/98c232ee639a43837f296e46891ee2c5.png)
...
![image.png](/images/f7329ab28f32840c973c8eee5440a989.png)

使用数据生成功能填充表数据：

![image.png](/images/00c821050fbd6221bf746d9cc3a182c5.png)
...
![image.png](/images/c7bb9e118b6c6999944d51787b677d42.png)

![image.png](/images/c054354317a1857df4f1ccb30f60f229.png)

![image.png](/images/5a73426e5e7fb9ce883e9a7291cac19d.png)

![image.png](/images/11181788ac0f3c35c6ad769af78cb938.png)

![image.png](/images/da7a09d1f2a8cafb1e457e4141db3d27.png)

![image.png](/images/8a6eb1a09c897618db46b12433bb0dd1.png)

分分钟就生成测试数据了，点赞！

接着，自然就是测试一下 SQL 能否正常运行了：

![image.png](/images/b5129dcb204bf26076cf10e2ff5eb7db.png)

SQL 可以正常执行并且返回结果，执行时间为：`33.037(毫秒)`

![image.png](/images/0a1ea3147a619fe408d732534cf45c17.png)
...
![image.png](/images/b214089db75cda439501dfd3468703e7.png)

![image.png](/images/379e3fe21e65a4ef303d4361fc05e2ac.png)

![image.png](/images/300fbcee9c23dba3bafd554ad7278a4b.png)

使用优化后的 SQL 执行：  
 ![image.png](/images/817a6afe6852f8292e77ed0f50b1371c.png)
...
![image.png](/images/863a862b6c6c6ec75ffc94e2ba87a170.png)

![image.png](/images/212738f2f89558bf89d19e416cf3bb1f.png)
...
![image.png](/images/d2876a10cca8b777228da6d6e862d134.png)

根据实际的环境修改一下脚本中的相关信息，比如文件路径，数据库服务名称等：

> 这里还有个问题，脚本需要在 dmdba 中运行，所以重启数据库服务需要用 `DmServiceDAMENG restart` 命令，需要优化一下。

![image.png](/images/a2d3167053ceadc0c40ac82dda99e660.png)
...
![image.png](/images/c1d284b04a0602635a755e7b788112e8.png)

没有生效，经过检查发现是 sed 命令没有替换成功，没有处理 `=` 号前面的空格问题导致：

![image.png](/images/5fd8477824cbcc1caa3df0381176a03f.png)
...
![image.png](/images/c7b347a6739b218ef242deb783beae60.png)

优化后重新执行：

![image.png](/images/2142fba3de9aa64e3ff61611485d004f.png)

再次检查归档启用情况：

![image.png](/images/f2106a5f1c2d895b782076abf6db2de7.png)

---
title: '统信 UOS V20 1001(c) 一键安装 Oracle 19C 单机'
date: 2024-06-18 16:33:51
categories:
  - Oracle 数据库
tags:
  - c语言
  ...
  - 开发语言
abbrlink: 139777516
csdn_url: https://luciferliu.blog.csdn.net/article/details/139777516
description: '前言 Oracle 一键安装脚本，演示 统信 UOS V20 1001© 一键安装 Oracle 19C 单机（全程无需人工干预）。 ⭐️ 脚本下载地址：Shell脚本安装Oracle数据库 前置准备 1、安装好操作系统，建议安装图形化 2、配置好网络 3、挂载本地 ISO 镜像源 4、上传软件安装'
keywords: 'c语言, oracle, 开发语言'
cover: '/img/covers/oracle.svg'
---
## 前言

Oracle 一键安装脚本，演示 统信 UOS V20 1001© 一键安装 Oracle 19C 单机（全程无需人工干预）。
...
-rwx------ 1 root root 3059705302 6月  18 12:04 LINUX.X64_193000_db_home.zip
-rwxr-xr-x 1 root root     220886 6月  18 12:00 OracleShellInstall
```
...
OracleShellInstall 开始安装，详细安装过程可查看日志： tail -2000f /soft/print_shell_install_20240618120552.log                                                                                  
...
正在安装 Oracle 软件以及补丁......已完成 (耗时: 309 秒)
正在创建监听......已完成 (耗时: 5 秒)
正在创建数据库......已完成 (耗时: 822 秒)
正在优化数据库......已完成 (耗时: 35 秒)

恭喜！Oracle 一键安装执行完成 (耗时: 1356 秒)，现在是否重启主机：[Y/N] Y
...
LSNRCTL for Linux: Version 19.0.0.0.0 - Production on 18-JUN-2024 12:30:51
...
Start Date                18-JUN-2024 12:29:41
...
SQL*Plus: Release 19.0.0.0.0 - Production on Tue Jun 18 12:31:12 2024
Version 19.3.0.0.0
...
sys@LUCIFER 2024-06-18 12:31:12> show parameter name

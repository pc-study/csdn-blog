...
tags:
  ...
  - tidb
abbrlink: 157245807
csdn_url: https://luciferliu.blog.csdn.net/article/details/157245807
description: '大家好，这里是公众号 DBA学习之路，分享一些学习数据库路上的知识和经验。 目录 前言 环境信息 Oracle 端配置 透明网关检查 安装 unixODBC 安装 MySQL ODBC 驱动 配置 ODBC 数据源 验证 ODBC 连通性 配置 Oracle TNS 配置透明网关参数 配置监听 验证'
keywords: 'oracle, 数据库, tidb'
cover: '/images/619f5daa22e83e88de9459139a7b0071.png'
---
...
* [前言](#_7)
* [环境信息](#_17)
* [Oracle 端配置](#Oracle__25)
* + [透明网关检查](#_26)
  + [安装 unixODBC](#_unixODBC_39)
  + [安装 MySQL ODBC 驱动](#_MySQL_ODBC__57)
  + [配置 ODBC 数据源](#_ODBC__69)
  + [验证 ODBC 连通性](#_ODBC__91)
  + [配置 Oracle TNS](#_Oracle_TNS_107)
  + [配置透明网关参数](#_126)
  + [配置监听](#_140)
  + [验证 TNS 连通性](#_TNS__160)
  + [创建 DBLink](#_DBLink_167)
  + [查询验证](#_176)
* [总结](#_187)
...
![](/images/619f5daa22e83e88de9459139a7b0071.png)

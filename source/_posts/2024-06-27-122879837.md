...
tags:
  ...
  - linux
abbrlink: 122879837
csdn_url: https://luciferliu.blog.csdn.net/article/details/122879837
description: '目录 前言 一、环境准备 二、创建数据库 1、初始化实例 ID 2、创建密码文件 3、编写初始化参数文件 4、创建目录 5、创建 spfile 文件 6、启动实例至 nomount 状态 7、编写建库脚本 8、执行建库脚本 9、运行脚本创建数据字典 三、知识拓展 前言 如何不使用 ，手动一步步快速创'
keywords: 'oracle, 数据库, linux'
cover: '/images/dfa9579e7fbcd0d04b552e344eb778dc.webp'
---
#### 目录
...
* + [1、初始化实例 ID](#1_ID_13)
  ...
  + [3、编写初始化参数文件](#3_38)
  + [4、创建目录](#4_50)
  + [5、创建 spfile 文件](#5_spfile__57)
  + [6、启动实例至 nomount 状态](#6_nomount__64)
  + [7、编写建库脚本](#7_70)
  + [8、执行建库脚本](#8_122)
  + [9、运行脚本创建数据字典](#9_136)
* [三、知识拓展](#_168)
...
进入到 $ORACLE\_HOME/dbs 目录下，使用 `orapwd` 查看命令帮助：
...
![Oracle 11GR2 实战指南之手工创建数据库](/images/dfa9579e7fbcd0d04b552e344eb778dc.webp)
...
![Oracle 11GR2 实战指南之手工创建数据库 - 图2](/images/936e0457c53d84a0dd36f77ca0780c97.webp)
...
运行构建数据字典视图、同义词和 PL/SQL 包以及支持 SQL\*Plus 正常运行所需的脚本。  
 ![Oracle 11GR2 实战指南之手工创建数据库 - 图3](/images/7d111ab252e21c15ad650c935d7c2070.webp)

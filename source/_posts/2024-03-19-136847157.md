---
title: 'openEuler 22.03（华为欧拉）一键安装 Oracle 19C（19.22） 数据库'
date: 2024-03-19 16:33:07
categories:
  - Oracle 数据库
tags:
  - oracle
  - 数据库
abbrlink: 136847157
csdn_url: https://luciferliu.blog.csdn.net/article/details/136847157
description: '前言 Oracle 一键安装脚本，演示 openEuler 22.03 一键安装 Oracle 19C 单机版过程（全程无需人工干预）：（脚本包括 ORALCE PSU/OJVM 等补丁自动安装） ⭐️ 脚本下载地址：Shell脚本安装Oracle数据库 脚本第三代支持 N 节点一键安装，不限制节点'
keywords: 'oracle, 数据库'
cover: '/images/c072bddc39ff1d1210fb54642d9a59ad.webp'
---
## 前言

**Oracle 一键安装脚本，演示 openEuler 22.03 一键安装 Oracle 19C 单机版过程（全程无需人工干预）：（脚本包括 ORALCE PSU/OJVM 等补丁自动安装）**

**⭐️ 脚本下载地址：[Shell脚本安装Oracle数据库](https://www.modb.pro/course/148)**

脚本第三代支持 N 节点一键安装，不限制节点数！

![openEuler 22.03（华为欧拉）一键安装 Oracle 19C（19.22） 数据库](/images/c072bddc39ff1d1210fb54642d9a59ad.webp)
...
**✨ 偷懒可以直接下载本文安装包合集：[openEuler 安装 Oracle 19C（19.22） 单机版安装包合集（包含补丁！！！）](https://www.modb.pro/doc/126597)**

## OpenEuler 22.03 操作系统安装

加载 ISO 镜像进入安装流程：

![openEuler 22.03（华为欧拉）一键安装 Oracle 19C（19.22） 数据库 - 图2](/images/48adc6b137262f46227aaaf6a1ad7562.png)

安装前检查：

![openEuler 22.03（华为欧拉）一键安装 Oracle 19C（19.22） 数据库 - 图3](/images/cc83733ba1795bc7d60b253343e23838.png)

选择系统安装语言：中文

![openEuler 22.03（华为欧拉）一键安装 Oracle 19C（19.22） 数据库 - 图4](/images/a92f50874829227e2722481e0cf37a38.webp)

进入安装界面，选择配置安装目的地：

![openEuler 22.03（华为欧拉）一键安装 Oracle 19C（19.22） 数据库 - 图5](/images/c7013662df249b1bb285e25491b08c9e.webp)

选择自定义配置：

![openEuler 22.03（华为欧拉）一键安装 Oracle 19C（19.22） 数据库 - 图6](/images/132a3447d583c3fc21c045aeeb2de11a.webp)

点击自动创建分区：

![openEuler 22.03（华为欧拉）一键安装 Oracle 19C（19.22） 数据库 - 图7](/images/4e588cdf619933b69e18a567fab18d50.webp)

删除 /home 分区目录：

![openEuler 22.03（华为欧拉）一键安装 Oracle 19C（19.22） 数据库 - 图8](/images/04d7683468e5e1d1791eea7180632c08.webp)

调整 swap 大小与内存一致：

![openEuler 22.03（华为欧拉）一键安装 Oracle 19C（19.22） 数据库 - 图9](/images/51ec940cb8d68abd4b9fa70315b5c4da.webp)

分配剩余空间给根目录：

![openEuler 22.03（华为欧拉）一键安装 Oracle 19C（19.22） 数据库 - 图10](/images/08c32fd6e57f678952c6c53c992b8fa0.webp)

配置完成，开始创建分区：

![openEuler 22.03（华为欧拉）一键安装 Oracle 19C（19.22） 数据库 - 图11](/images/7e7ba332a5cf4abf843771ea0bea46a3.webp)

软件选择，安装模式选择服务器：

![openEuler 22.03（华为欧拉）一键安装 Oracle 19C（19.22） 数据库 - 图12](/images/f2d847e9f21a3d45cce5473f5ea11481.webp)

![openEuler 22.03（华为欧拉）一键安装 Oracle 19C（19.22） 数据库 - 图13](/images/ba773f6e7c4cb342e976fbc1cf79ff42.webp)

配置主机名和网络：

![openEuler 22.03（华为欧拉）一键安装 Oracle 19C（19.22） 数据库 - 图14](/images/2998756005f31a30e80c3335bfe43d07.webp)

配置网卡自动连接：

![openEuler 22.03（华为欧拉）一键安装 Oracle 19C（19.22） 数据库 - 图15](/images/72155715d64f3839084f4e6006cebc62.webp)

配置网络 IPV4：

![openEuler 22.03（华为欧拉）一键安装 Oracle 19C（19.22） 数据库 - 图16](/images/dcf5fca1e5a8f01f255d213fd32425d8.webp)

保存配置信息：

![openEuler 22.03（华为欧拉）一键安装 Oracle 19C（19.22） 数据库 - 图17](/images/b2e1156b02c588fd0985f6106393d0c2.webp)

启用 root 用户，配置 root 密码：

![openEuler 22.03（华为欧拉）一键安装 Oracle 19C（19.22） 数据库 - 图18](/images/eebe804aaef6966581b34fb7405de5fa.webp)

创建用户 lucifer，配置密码：

![openEuler 22.03（华为欧拉）一键安装 Oracle 19C（19.22） 数据库 - 图19](/images/60ac9a374a151052c653256af09156cb.webp)

正式开始安装系统：

![openEuler 22.03（华为欧拉）一键安装 Oracle 19C（19.22） 数据库 - 图20](/images/2b6c5076d28a17a915214b960243fe40.webp)

安装完成，重启系统：

![openEuler 22.03（华为欧拉）一键安装 Oracle 19C（19.22） 数据库 - 图21](/images/d900cdc17c8ae24d8b1e43e8db7afd80.webp)

![openEuler 22.03（华为欧拉）一键安装 Oracle 19C（19.22） 数据库 - 图22](/images/374c3df186693b0700ff85dd8fb2a5ca.webp)

输入 root 账户密码进入系统：

![openEuler 22.03（华为欧拉）一键安装 Oracle 19C（19.22） 数据库 - 图23](/images/5902b1539b3cb3ad2540e8cbbb89b505.png)

openEuler 默认没有图形化界面，openEuler 安装桌面环境图形化界面【ukui】：
...
![openEuler 22.03（华为欧拉）一键安装 Oracle 19C（19.22） 数据库 - 图24](/images/d0475fb4b5a2e3f12a1b55240956afa5.png)

...
date: 2025-09-02 16:14:26
categories:
  - 数据库
tags:
  - tidb
abbrlink: 151115895
csdn_url: https://luciferliu.blog.csdn.net/article/details/151115895
description: '目录 前言 TiUP 安装 离线部署 准备 TiUP 离线组件包 部署离线环境 TiUP 组件 前言 tiup 镜像为部署集群或通过 tiup 执行相关工具的源，可以是本地的离线镜像（本地的一个目录）或远程镜像（官方镜像 ）。 TiUP 安装 在 TiDB 官方文档中，建议联网安装 TiUP 组件：'
keywords: 'tidb'
...
* [TiUP 安装](#TiUP__5)
* [离线部署](#_22)
* + [准备 TiUP 离线组件包](#_TiUP__23)
  + [部署离线环境 TiUP 组件](#_TiUP__160)

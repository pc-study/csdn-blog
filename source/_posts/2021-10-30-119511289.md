...
脚本
与 LogMiner 相关的有以下三个：  
 ![在这里插入图片描述](/csdn-blog/images/b0e47862b382c855daa0a20e287e2523.png)在默认情况下，Oracle已经安装了LogMiner工具，如果没有安装，可以依次执行以下 sql 脚本，创建 LogMiner 相关的对象：
...
![在这里插入图片描述](/csdn-blog/images/f1e660330737ce054e5ea20ac57653df.png)  
...
![在这里插入图片描述](/csdn-blog/images/1423d65f49c1e32d30e3bbef3531b501.png)  
...
![在这里插入图片描述](/csdn-blog/images/0e0c5c51af0c73c6e4d0de47afa73a39.png)  
 当使用 APPEND 参数，如果发现存在表，将导入数据进行增量导入，**如果有唯一限制时，有重复数据，将会导入失败**。  
 ![在这里插入图片描述](/csdn-blog/images/a2cfdc503b1a8a317c5d021a066f56fb.png)  
...
![在这里插入图片描述](/csdn-blog/images/f94ba6e946836edec6d3aee536524c6b.png)  
...
通过导入过程没有看到任何关于表已存在的提示，导入正常，查询数据：  
 ![在这里插入图片描述](/csdn-blog/images/41deb6cf088b15334ff8c09844d57002.png)  
...
![在这里插入图片描述](/csdn-blog/images/fa3e8d7150780238bff86ee0203fb9fb.png)  

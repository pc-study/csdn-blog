...
tags:
  ...
  - 数据库
abbrlink: 154742402
csdn_url: https://luciferliu.blog.csdn.net/article/details/154742402
description: '目录 前言 BR 工具 如何备份数据？ - 快照备份 日志备份 如何选择备份存储？ BR 安装配置 BR 备份部署 日志备份脚本 快照备份脚本 问题总结 网络限制 S3 权限 日志备份重复运行 快照备份中断 写在最后 前言 手里有几套 TiDB 集群数据库没有备份，一直在裸奔，几个备份厂商（爱数，N'
keywords: 'tidb, aws, 数据库'
cover: '/images/183733a36b20d5647e661181d13ede9d.webp'
---
#### 目录
...
![使用 BR 备份 TiDB 到 AWS S3 存储](/images/183733a36b20d5647e661181d13ede9d.webp)

集群快照数据备份的流程如下：

![使用 BR 备份 TiDB 到 AWS S3 存储 - 图2](/images/c8be4d0c2562f229283c423049979860.webp)

#### 日志备份

日志备份和 PITR 的架构如下：

![使用 BR 备份 TiDB 到 AWS S3 存储 - 图3](/images/a92b1f967a3c9a6d351a469e6be519b2.webp)

日志备份的流程如下：

![使用 BR 备份 TiDB 到 AWS S3 存储 - 图4](/images/a552e7e7c883db6cba43324adeab2913.webp)
...
![使用 BR 备份 TiDB 到 AWS S3 存储 - 图5](/images/ca2de634faef29c60df185116df4f276.webp)

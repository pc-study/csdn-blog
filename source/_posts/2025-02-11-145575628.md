...
![](/csdn-blog/images/276aab5ca5760928592b59bc07092582.png)
...
![](/csdn-blog/images/482ab7436c52aaaa0bd98868c7336748.png)
...
![](/csdn-blog/images/09f1575856f491b8c3481232a578d9cb.png)
...
![](/csdn-blog/images/1589bcda0b918787ec1a9d80550cb155.png)
...
![](/csdn-blog/images/5143590d3bcf5ce63c4f3c0e34fe45e9.png)
...
![](/csdn-blog/images/17408e3c6bcd00dd8e0c76fe87c8dd68.png)
...
![](/csdn-blog/images/126d714ef1a9f7046e07b45bfcf4f183.png)
...
![](/csdn-blog/images/36c24aed4f219b368a3eb5b11c6664a0.png)
...
![](/csdn-blog/images/7460e77f69afddef2d48b4deb550b549.png)
...
![](/csdn-blog/images/8dab1a7c466cf5aeed8819c77d98eadf.png)
...
![](/csdn-blog/images/6796948b675a89e20deedb52b55f98cc.png)
...
![](/csdn-blog/images/348f702d20b24df97da0a7953d1731c3.png)
...
![](/csdn-blog/images/190a6ad6ea5d5614bc2fcf0e858209f5.png)
...
![](/csdn-blog/images/52d16eb11e787d83f34dee72ab969298.png)
...
![](/csdn-blog/images/e5810fb9b9af96c16ddd56c11c09aa64.png)
...
![](/csdn-blog/images/77c0e9325f15aac7dfc018bd840c90f9.png)

直接跳出安装界面，选择集群安装：

![](/csdn-blog/images/1f829c6460d6cdde4b6a6d08f8149c9d.png)

![](/csdn-blog/images/d2bbaf832b5db29adfbceca177915a7f.png)

选择自定义安装：

![](/csdn-blog/images/ab8b2a812dce63a02a64f00829dc0d89.png)

![](/csdn-blog/images/cc025cc7d6bf8f7e403d49264c3c17c4.png)

修改 scan 名称，与 hosts 文件配置 scan 名称保持一致，输入 grid 用户密码，创建用户时两节点必须保持一致。先执行 setup，再执行 test，开始互信：

![](/csdn-blog/images/dfdadb9f415d89cfddad9e0a6da33956.png)

![](/csdn-blog/images/9c79eca069f48472a6c1e952c7916857.png)

确保对应网卡和IP网段对应即可，12CR1 心跳网段需要选 Private：

![](/csdn-blog/images/0b24243c2070bac04e9acc17a54e19f5.png)

![](/csdn-blog/images/c956c53190115101b1fbd923bbd03b87.png)

![](/csdn-blog/images/4c2fed9f4ca15db636e1358db4f2c06f.png)

安装时填创建 OCR 盘，一块盘冗余 External，目录选择udev绑的路径：

![](/csdn-blog/images/ade22a6a1fa0ead823ae95bc0ccf9bad.png)

![](/csdn-blog/images/4ba367fca118c7254f1df4d2d53babed.png)

![](/csdn-blog/images/daa637f6139bb3e56af9f65f3db72197.png)

![](/csdn-blog/images/d4fde3cb280c618dc23bb5b8363b080e.png)

![](/csdn-blog/images/3357403c83b6f538e3b755e95f763dbc.png)

![](/csdn-blog/images/1a16f1f861d91c840a00f2476acff129.png)

![](/csdn-blog/images/a353a807a4a5a7da5ec1c66181557bb7.png)

这里不选择自动执行 root.sh 脚本，因此容易失败，所以选择手动执行：

![](/csdn-blog/images/6f119c0823b141a59b0e4a04f630d8e0.png)

安装预检查，关于 DNS 和 NTP 相关的都可以忽略，继续下一步：

![](/csdn-blog/images/59cad8b6e1bbad47f8faca3d64bf534d.png)

开始安装 grid：

![](/csdn-blog/images/db76678a6be1ec0edbfc94d0f2803b13.png)

![](/csdn-blog/images/04bc179d5182cb1eab556ce32e993a7e.png)

root 用户下，两个节点顺序执行 root.sh，先节点一执行完，再节点二执行，两个节点的 root.sh 都执行完之后，继续安装：

![](/csdn-blog/images/a167d206eba9f7c186752c7de7888767.png)
...
![](/csdn-blog/images/b234ac47051e24953981f4ee28120a68.png)

安装完成：

![](/csdn-blog/images/647e05f32dced79da0c30ec3193864f4.png)
...
![](/csdn-blog/images/7f71fcaef344fd17dda2e7c7047f6e69.png)
...
![](/csdn-blog/images/c74704164e8505afde67eb36c4b620b2.png)
...
![](/csdn-blog/images/d00ca8fdd655b757e695e408bdfa570c.png)
...
![](/csdn-blog/images/10600ae9c83bf532d9e122504836026d.png)

![](/csdn-blog/images/501d65194690ef2d2eecc618619e174f.png)

![](/csdn-blog/images/c1a922a188402c458615509d44da4ba1.png)

![](/csdn-blog/images/791e2530739c0d0a3d7d66e29467da13.png)

![](/csdn-blog/images/c1a1cdf705c6983fd8d149b6394e925c.png)
...
![](/csdn-blog/images/89f2bcfc6a7f5b2f34250509c3f858d2.png)
...
![](/csdn-blog/images/d9e8ddd613637f69dddcb1c1b2b3eacc.png)

进入安装界面，不接收安全更新：

![](/csdn-blog/images/1eab879f7d01e4bb3300371093b1d2a2.png)

选择仅安装 Oracle 软件：

![](/csdn-blog/images/aa16be65fa296acfe98852f9d4cf540a.png)

选择集群模式：

![](/csdn-blog/images/ab3dcd2b22a2f0a2c129d80b19c419b2.png)

输入 oraprod 用户密码，先执行 setup，再执行 test，开始互信：

![](/csdn-blog/images/96cfe33f783f546a3ae83c6f3b197bb8.png)

![](/csdn-blog/images/81715a4011ebe0cf73aff1704dc1298a.png)

选择企业版：

![](/csdn-blog/images/5f5cead418f9d12c8dc32d1ea45fe867.png)

![](/csdn-blog/images/a66b0869f68fab6bc667d1ebbd125481.png)

默认即可：

![](/csdn-blog/images/c762b4834829692f02749b67f19f359c.png)

![](/csdn-blog/images/9d738a8f1021a82312509847660f2a5b.png)

安装预检查，由于我们只配了一个 SCAN，所以关于 DNS 相关的都无视，继续：

![](/csdn-blog/images/52e06175388ce59e5cf40da86d2583f4.png)

开始安装：

![](/csdn-blog/images/3a0904ecc9bbefe272537fe75e34231c.png)

![](/csdn-blog/images/0638d539b845ef1e5e7aa8d5bac2e253.png)

![](/csdn-blog/images/214989dcd4ae4cab6c19a5c4f5ccac9c.png)
...
![](/csdn-blog/images/ad801b709303b4f94deab8d4a2ddd218.png)
...
![](/csdn-blog/images/efac61820eb75eed0a32bd2c8495f480.png)

选择自定义模式：

![](/csdn-blog/images/0ea1abf3ba6a686f4c9acae016b0b5b8.png)

默认选择一版用途安装：

![](/csdn-blog/images/31d93c141896b6df30dde8b7ac0f3b88.png)

填写数据库名称 lucifer，由于默认添加为 1，2，实例名规划为 lucifer1/2；选择安装 CDB 模式，不创建 PDB：

![](/csdn-blog/images/f5ce62f24c2ebf23b594391d1ff2f172.png)

![](/csdn-blog/images/6e94b1bd550edd6a1108da5c67da0110.png)

![](/csdn-blog/images/159b5085a88b5d6db744507e035fe2bf.png)

![](/csdn-blog/images/ecd602b39e963f80c820051e8f5aec07.png)

默认即可，使用 OMF 模式：

![](/csdn-blog/images/556d66d3db7406fe9b5b857543e1cbdf.png)

![](/csdn-blog/images/495ef40448afeed655058785e3e325ff.png)

配置内存，使用 ASMM 模式，数据库总内存占用物理内存 70%-90% 之间：

![](/csdn-blog/images/6380e85bd2eecbc7d25dcae687b97d1a.png)

一般用途模式安装，block\_size 是无法修改的，process 进程数修改为1500，根据实际情况修改：

![](/csdn-blog/images/8440e0e5ca689158cf6b83f98555e581.png)

配置数据库字符集：默认 AL32UTF8，国家字符集：默认 AL16UTF16；根据实际业务情况修改成对应字符集：

![](/csdn-blog/images/631f8262ae443df3e85946d4d5af03f1.png)

![](/csdn-blog/images/8da59a461d6dedfa641fe575101c1c92.png)

![](/csdn-blog/images/f94645521a6061e685e5df10ae7c8328.png)

![](/csdn-blog/images/7bf72f3df7684d5004e37be83d0b0c87.png)

![](/csdn-blog/images/1a129d449857cb4b293544a3ff7e97fd.png)

开始安装：

![](/csdn-blog/images/1e3d49c77d2f64d301c2f245360c63d6.png)

经过漫长的等待，数据库建完了：

![](/csdn-blog/images/e3812428d103ffe8b999eeca20ef1238.png)
...
![](/csdn-blog/images/e45d6ef9c6381c3b18119ebea792b2fb.png)
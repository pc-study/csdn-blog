---
title: '第二章【Oracle自动化部署脚本】介绍'
date: 2021-06-14 01:58:31
categories:
  - 数据库
tags:
  - 数据库
  ...
  - shell
abbrlink: 117887517
csdn_url: https://luciferliu.blog.csdn.net/article/details/117887517
...
keywords: '数据库, 运维, linux, oracle, shell'
...
在 [第一章 诞生](https://blog.csdn.net/m0_50546016/article/details/117886814) 中介绍了【Oracle自动化部署脚本】的由来和实现。
...
>  ![rac主机名](/images/4e443d81a14e25dd612511e70f9c6762.webp)

###### `-o` 全称 ORACLE\_SID：Oracle实例名称，默认值为 orcl。
...
###### `-b` 全称 ENV\_BASE\_DIR：Oracle基础安装目录，默认值为/u01/app。
...
###### `-dd` 全称 DATA\_BASEDISK：数据盘对应的磁盘名称，**必填参数** 。支持多块磁盘填写，用逗号隔开。

> 使用方式：`-dd /dev/sdb,/dev/sdc,/dev/sdd`

###### `-od` 全称 OCR\_BASEDISK：裁决盘对应的磁盘名称，**必填参数** 。支持多块磁盘填写，用逗号隔开。

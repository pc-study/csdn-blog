...
tags:
  ...
  - database
abbrlink: 122839501
csdn_url: https://luciferliu.blog.csdn.net/article/details/122839501
description: '原文地址： 原文作者：Tim Hall 本文介绍 Oracle 数据库 21c 中的空间管理增强功能。 目录 SecureFiles 收缩 临时表空间自动收缩 撤消表空间自动收缩 SecureFiles 收缩 在以前的版本中，我们只能通过移动 lob 来释放 lob 的空间，这对于大型 lob 段可'

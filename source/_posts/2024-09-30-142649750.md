...
tags:
  ...
  - android
abbrlink: 142649750
csdn_url: https://luciferliu.blog.csdn.net/article/details/142649750
description: '大家好，这里是 Lucifer三思而后行，专注于提升数据库运维效率。 目录 前言 介绍 下载 dbops Gitee 下载 开发版下载 部署 dbops 解压缩 dbops 部署 ansible 使用 dbops 部署单机 连接测试 往期精彩文章推荐 前言 昨天群里有位朋友分享了芬达大佬的 MySQ'
keywords: '数据库, mysql, android'
...
* + [Gitee 下载](#Gitee__58)
  + [开发版下载](#_64)
* [部署 dbops](#_dbops_99)
* + [解压缩 dbops](#_dbops_102)
* [部署 ansible](#_ansible_120)
* [使用 dbops](#_dbops_206)
* + [部署单机](#_211)
* [连接测试](#_661)
* [往期精彩文章推荐](#_714)
...
> Gitee 下载地址：<https://gitee.com/fanderchan/dbops>
...
* 正确地配置 playbook/common\_config.yml 的通用参数部分信息
* 正确地配置 playbook/vars/var\_xxx.yml 的专有参数部分信息

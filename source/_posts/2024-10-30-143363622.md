...
date: 2024-10-30 14:07:32
categories:
  - 数据库
tags:
  - 数据库
abbrlink: 143363622
csdn_url: https://luciferliu.blog.csdn.net/article/details/143363622
description: '【多选题】KSQL 命令列出数据库中的所有角色或用户的元命令是什么？ 解题思路： 通过 ksql 连接 Kingbase 数据库执行命令查看： 可以看到 和 都是查看角色信息的命令，而 命令不存在， 是查看模式信息。'
keywords: '数据库'

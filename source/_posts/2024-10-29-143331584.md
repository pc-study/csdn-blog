...
date: 2024-10-29 15:53:08
categories:
  - 数据库
tags:
  - 数据库
abbrlink: 143331584
csdn_url: https://luciferliu.blog.csdn.net/article/details/143331584
description: '【单选题】在 KingbaseES V8 中，把表从一个表空间移动到另一个表空间会锁表吗？ 会 不会 解题思路： 创建表空间 tbs01: 查看准备环境： 另一个会话查看当前表是否存在锁： 模拟表移动表空间： 打开另一个会话查看表是否存在锁： 原会话回滚移动表空间的事务： 在新的会话中再次查看锁是否'
keywords: '数据库'

...
tags:
  ...
  - oracle
abbrlink: 142649781
csdn_url: https://luciferliu.blog.csdn.net/article/details/142649781
description: '大家好，这里是 Lucifer三思而后行，专注于提升数据库运维效率。 目录 前言 介绍 nomount 阶段 参数文件 分配 SGA 启动进程 总结 往期精彩文章推荐 前言 作为一名 DBA，应该都玩过 Oracle 数据库，最熟悉的操作应该就是开关库了： 但是执行这两个命令，数据库到底做了什么？相'
keywords: '数据库, oracle'
...
![](https://img-blog.csdnimg.cn/img_convert/ac4faeaa65704c7ca5b2b2c4bc38e64d.png)

...
tags:
  ...
  - 运维
abbrlink: 151115756
csdn_url: https://luciferliu.blog.csdn.net/article/details/151115756
description: '目录 前言 下载 rpm 包 downloadonly 在线镜像源下载 安装 rlwrap 插件 写在最后 前言 今天在一台数据库主机上想安装 rlwrap 插件（上下文切换，退格优化），方便运维操作，但是 rlwrap 需要前置安装 ，因为是内网环境，也不方便挂载镜像 ISO、没有 YUM 源的情'
keywords: 'centos, linux, 运维'
cover: '/images/f2ba5b734cccd1c99de5e27158da2914.webp'
---
#### 目录

* [前言](#_2)
* [下载 rpm 包](#_rpm__9)
* + [downloadonly](#downloadonly_11)
  + [在线镜像源下载](#_42)
* [安装 rlwrap 插件](#_rlwrap__77)
* [写在最后](#_98)
...
![教你 Centos 如何离线安装 rlwrap 插件（内网环境）](/images/f2ba5b734cccd1c99de5e27158da2914.webp)
...
![教你 Centos 如何离线安装 rlwrap 插件（内网环境） - 图2](/images/173e2d133ca8d38ade6faf7dc4683fed.webp)
...
* ncurses-devel-5.9-14.20130511.el7\_4.x86\_64.rpm
* readline-devel-6.2-11.el7.x86\_64.rpm
...
以 centos7.9 为例，打开：https://mirrors.tuna.tsinghua.edu.cn/centos-vault/7.9.2009/os/x86\_64/Packages/，搜索需要下载的依赖包进行右键下载即可：

![教你 Centos 如何离线安装 rlwrap 插件（内网环境） - 图3](/images/54c65d2b45623a88e3a5755e6e3c651f.webp)

![教你 Centos 如何离线安装 rlwrap 插件（内网环境） - 图4](/images/07b26f99c1cc4d1ec3b6803c111f815e.webp)
...
* centos6：
  + https://mirrors.tuna.tsinghua.edu.cn/centos-vault/6.10/os/x86\_64/Packages/ncurses-devel-5.7-4.20090207.el6.x86\_64.rpm
  + https://mirrors.tuna.tsinghua.edu.cn/centos-vault/6.10/os/x86\_64/Packages/readline-devel-6.0-4.el6.x86\_64.rpm
* centos7：
  + https://mirrors.tuna.tsinghua.edu.cn/centos-vault/7.9.2009/os/x86\_64/Packages/ncurses-devel-5.9-14.20130511.el7\_4.x86\_64.rpm
  + https://mirrors.tuna.tsinghua.edu.cn/centos-vault/7.9.2009/os/x86\_64/Packages/readline-devel-6.2-11.el7.x86\_64.rpm
* centos8：
  + https://mirrors.tuna.tsinghua.edu.cn/centos-vault/8.5.2111/BaseOS/x86\_64/os/Packages/ncurses-devel-6.1-9.20180224.el8.x86\_64.rpm
  + https://mirrors.tuna.tsinghua.edu.cn/centos-vault/8.5.2111/BaseOS/x86\_64/os/Packages/readline-devel-7.0-10.el8.x86\_64.rpm
* centos9：
  + https://mirrors.tuna.tsinghua.edu.cn/centos-stream/9-stream/AppStream/x86\_64/os/Packages/ncurses-devel-6.2-12.20210508.el9.x86\_64.rpm
  + https://mirrors.tuna.tsinghua.edu.cn/centos-stream/9-stream/AppStream/x86\_64/os/Packages/readline-devel-8.1-4.el9.x86\_64.rpm
* centos10：
  + https://mirrors.tuna.tsinghua.edu.cn/centos-stream/10-stream/AppStream/x86\_64/os/Packages/ncurses-devel-6.4-14.20240127.el10.x86\_64.rpm
  + https://mirrors.tuna.tsinghua.edu.cn/centos-stream/10-stream/AppStream/x86\_64/os/Packages/readline-devel-8.2-11.el10.x86\_64.rpm

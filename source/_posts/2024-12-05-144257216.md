...
tags:
  ...
  - 崖山
abbrlink: 144257216
csdn_url: https://luciferliu.blog.csdn.net/article/details/144257216
...
keywords: '数据库, yashandb, yashandb体验官, 崖山'
cover: '/images/070d4114b2dcac70155c94fa58da3c2f.webp'
---
...
![YashanDB 23.2 YAC 共享集群部署实战：轻松上手！](/images/204797f1d8bdc55d9aa8420dc27a4cc9.webp)
...
![YashanDB 23.2 YAC 共享集群部署实战：轻松上手！ - 图2](/images/070d4114b2dcac70155c94fa58da3c2f.webp)
...
![YashanDB 23.2 YAC 共享集群部署实战：轻松上手！ - 图3](/images/4b7366319f833ae2877c5ca791f6d3f0.webp)
...
![YashanDB 23.2 YAC 共享集群部署实战：轻松上手！ - 图4](/images/01abc91d4c32da821e4b959c11573bb9.webp)
...
![YashanDB 23.2 YAC 共享集群部署实战：轻松上手！ - 图5](/images/36d250b4ebd7e829f7108da4b92fc5a2.webp)

**📢 注意**：如需使用 DBLINK 功能和更丰富的内置函数（例如 LSFA\_LISTAGG），需先下载 plugin 插件包并在安装命令中指定 `--plugin` 参数（**安装完成后，无法单独安装该插件包**）。
...
部署命令成功执行后将会在 $YASDB\_HOME 目录下的 conf 文件夹中生成 <<集群名称>>.bashrc 环境变量文件：
...
其中，节点级别的 ycsctl 命令要求节点上的 YCS 启动后才能执行，并配置 **$YASCS\_HOME** 环境变量：

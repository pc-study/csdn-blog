...
tags:
  ...
  - kwdb
abbrlink: 147016494
csdn_url: https://luciferliu.blog.csdn.net/article/details/147016494
description: '大家好，这里是 DBA学习之路，专注于提升数据库运维效率。 目录 前言 KWDB 介绍 安装准备 环境信息 配置要求 操作系统 软件依赖 端口要求 安装包下载 部署 KWDB 简单实用 连接数据库 创建数据库 创建用户 创建时序表 前言 今天无意间在墨天轮看到一个征文活动 征文大赛 「码」上数据库—'
keywords: '数据库, kwdb'
cover: '/images/a09d0d5bbfc70d04031e5c4a1a656924.webp'
---
...
![【KWDB创作者计划】_KaiwuDB 2.1.0 单节点裸机部署](/images/a09d0d5bbfc70d04031e5c4a1a656924.webp)
...
* 部署操作文档：https://www.kaiwudb.com/kaiwudb\_docs/#/oss\_v2.1.0/quickstart/overview.html
...
| 磁盘 | 1、推荐使用 SSD 或者 NVMe 设备，尽量避免使用 NFS、CIFS、CEPH 等共享存储。 2、磁盘必须能够实现 500 IOPS 和 30 MB/s 处理效率。 |
| 文件系统 | 建议使用 ext4 文件系统。 |
...
| Anolis | 8.6 | ARM\_64 |
| Anolis | 8.6 | x86\_64 |
| KylinOS | V10 SP3 2403 V10 SP3 2303 | ARM\_64 |
| KylinOS | V10 SP3 2403 V10 SP3 2303 | x86\_64 |
| Ubuntu | V20.04 | ARM\_64 |
| Ubuntu | V20.04 | x86\_64 |
| Ubuntu | V22.04 | ARM\_64 |
| Ubuntu | V22.04 | x86\_64 |
| Ubuntu | V24.04 | ARM\_64 |
| Ubuntu | V24.04 | x86\_64 |
| UOS | 1060e | x86\_64 |
| UOS | 1060e | ARM\_64 |
...
![【KWDB创作者计划】_KaiwuDB 2.1.0 单节点裸机部署 - 图2](/images/bbf3fb7e62592e2a710a5970a2c8ed7f.webp)

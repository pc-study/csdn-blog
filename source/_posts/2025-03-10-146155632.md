...
date: 2025-03-10 15:22:22
categories:
  - 多媒体处理
tags:
  - ffmpeg
abbrlink: 146155632
csdn_url: https://luciferliu.blog.csdn.net/article/details/146155632
description: '大家好，这里是公众号 DBA学习之路，分享一些学习国产数据库路上的知识和经验。 目录 前言 问题分析 解决方案 安装时区补丁 升级时区 写在最后 前言 最近遇到好几次数据泵导入报错 ORA-39405 的问题，需要升级时区，本文正好记录一下解决过程。 问题分析 两套 19C 数据库，补丁版本不一致，'
keywords: 'ffmpeg'
cover: '/images/253959e262ff31928891d4642737147d.webp'
---
...
![数据泵导入报错 ORA-39405 提示时区要升级，怎么办？看这篇！](/images/253959e262ff31928891d4642737147d.webp)

![数据泵导入报错 ORA-39405 提示时区要升级，怎么办？看这篇！ - 图2](/images/64504ad5e820a25deafd43ad257d465b.webp)
...
![数据泵导入报错 ORA-39405 提示时区要升级，怎么办？看这篇！ - 图3](/images/5518f070874c73d20199de050f110a86.webp)
...
1. using `DBMS_DST package`： **[4.7.2 Upgrading the Time Zone Data Using the DBMS\_DST Package](https://docs.oracle.com/en/database/oracle/oracle-database/19/nlspg/datetime-data-types-and-time-zone-support.html#GUID-42DDBBFA-FF58-41B6-81A1-515FD7968A38)**
2. using the `utltz_* Scripts` in the `$ORACLE_HOME/rdbms/admin` directory：**[4.7.1 Upgrading the Time Zone Data Using the utltz\_\* Scripts](https://docs.oracle.com/en/database/oracle/oracle-database/19/nlspg/datetime-data-types-and-time-zone-support.html#GUID-8815B03F-473E-4E77-919B-7A3066442C21)**

...
tags:
  ...
  - oracle
abbrlink: 148435505
csdn_url: https://luciferliu.blog.csdn.net/article/details/148435505
description: '大家好，这里是 DBA 学习之路，专注于提升数据库运维效率。 目录 前言 数据库版本确认 组件安装状态检查 查看已安装组件 功能使用情况监控 DBA\FEATURE\USAGE\STATISTICS MMON 的采样机制解析 组件使用分析 Oracle Text Oracle Workspace M'
keywords: '数据库, oracle'
cover: '/images/2bf6cf00ed5f0c266a14d09e28cf1e55.webp'
---
...
* + [查看已安装组件](#_37)
* [功能使用情况监控](#_77)
* + [DBA\_FEATURE\_USAGE\_STATISTICS](#DBA_FEATURE_USAGE_STATISTICS_79)
  + [MMON 的采样机制解析](#MMON__104)
* [组件使用分析](#_155)
* + [Oracle Text](#Oracle_Text_158)
  + [Oracle Workspace Manager](#Oracle_Workspace_Manager_179)
  + [Spatial](#Spatial_231)
  + [XML Database (XDB)](#XML_Database_XDB_319)
  + [OLAP](#OLAP_646)
  + [OJVM](#OJVM_686)
  + [APEX](#APEX_730)
* [总结](#_741)
...
![DBA 必看：Oracle 许可合规性检查终极指南](/images/2bf6cf00ed5f0c266a14d09e28cf1e55.webp)
...
![DBA 必看：Oracle 许可合规性检查终极指南 - 图2](/images/525ef5bfe11153228491bf09d3e88f58.webp)
...
![DBA 必看：Oracle 许可合规性检查终极指南 - 图3](/images/48919c8b3bf27ccd644f9b37ec76198d.webp)
...
如果数据库中不存在包含 SDO\_GEOMETRY 列的表，则表示该数据库未使用 Spatial 功能。
...
![DBA 必看：Oracle 许可合规性检查终极指南 - 图4](/images/60cbde43dd0ca3e8c9f3ef5077e09a8d.webp)
...
* [Information About DBA\_FEATURE\_USAGE\_STATISTICS Table (Doc ID 2535290.1)](https://support.oracle.com/epmos/faces/DocContentDisplay?id=2535290.1)
* [DBA\_FEATURE\_USAGE\_STATISTICS reports Oracle Spatial is used (Doc ID 1381022.1)](https://support.oracle.com/epmos/faces/DocContentDisplay?id=1381022.1)
* [DBA\_FEATURE\_USAGE\_STATISTICS Does Not Show Accurate OLAP Usage (Doc ID 2729617.1)](https://support.oracle.com/epmos/faces/DocContentDisplay?id=2729617.1)
...
* [How To Verify If APEX Is Being Used in an 11.x Database Installation When APEX Shows as INVALID in DBA\_REGISTRY (Doc ID 1518046.1)](https://support.oracle.com/epmos/faces/DocContentDisplay?id=1518046.1)
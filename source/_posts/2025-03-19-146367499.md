...
tags:
  ...
  - 数据库
abbrlink: 146367499
csdn_url: https://luciferliu.blog.csdn.net/article/details/146367499
description: '大家好，这里是公众号 DBA学习之路，分享一些学习国产数据库路上的知识和经验。 目录 前言 问题分析 处理过程 关闭自动扩展 重建临时表空间 重建 REDO 文件 写在最后 前言 上周给客户巡检的时候，发现有一套 Oracle RAC 11GR2 数据库的 ASM 磁盘使用率 99.9% 了，来不及'
keywords: 'oracle, ffmpeg, 数据库'
cover: '/images/b2295d74649eb3b944fb0c9414421145.webp'
---
...
![Oracle RAC ASM 磁盘组满了，无法扩容怎么在线处理？](/images/82fb3e17d3bd8ce4135c01e326aa7bc7.webp)
...
![Oracle RAC ASM 磁盘组满了，无法扩容怎么在线处理？ - 图2](/images/0d89a86c1351e910512436c457b9cf8d.webp)
...
1. 已经部署了 ASM 磁盘使用率监控，且是每天都发送邮件，为什么没有被重视？  
    ![Oracle RAC ASM 磁盘组满了，无法扩容怎么在线处理？ - 图3](/images/b2295d74649eb3b944fb0c9414421145.webp)
2. DATA1 磁盘组明显是因为之前 DATA 磁盘组使用空间不足才添加的，为什么新的数据文件还是建在了 DATA 磁盘组下？  
    ![Oracle RAC ASM 磁盘组满了，无法扩容怎么在线处理？ - 图4](/images/b9b305f9f4b6b7bf764fd526f3317b4e.webp)

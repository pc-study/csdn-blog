...
tags:
  ...
  - rhel10
abbrlink: 143955255
csdn_url: https://luciferliu.blog.csdn.net/article/details/143955255
description: '大家好，这里是 Lucifer三思而后行，专注于提升数据库运维效率。 目录 社群交流 前言 RHEL10 Beta 更新概述 RHEL10 Beta 安装 初始界面 磁盘分区 配置主机名和网络 配置时区 配置 root 密码 创建用户 开始安装 新版体验 基本信息 配置本地软件源 VNC 写在最后'
keywords: 'linux, 红帽, rhel10'
...
* [社群交流](#_3)
* [前言](#_12)
* [RHEL10 Beta 更新概述](#RHEL10_Beta__17)
* [RHEL10 Beta 安装](#RHEL10_Beta__51)
* + [初始界面](#_54)
  + [磁盘分区](#_71)
  + [配置主机名和网络](#_92)
  + [配置时区](#_109)
  + [配置 root 密码](#_root__118)
  + [创建用户](#_129)
  + [开始安装](#_135)
* [新版体验](#_156)
* + [基本信息](#_157)
...
![](https://img-blog.csdnimg.cn/img_convert/2a7f34cbcab49ebf44cfb8df5f3c2f6b.png)
...
![](https://img-blog.csdnimg.cn/img_convert/f4c77c5390ca5caf61e60bddad775cd9.png)

老样子，选择语言（默认英文）：

![](https://img-blog.csdnimg.cn/img_convert/70adc3f7de475f1f3d6b184fb834d647.png)

由于是测试版，有一个确认提示：

![](https://img-blog.csdnimg.cn/img_convert/04883fdaf8d6d71528dfbca8f16dcb06.png)

进入熟悉的安装界面：

![](https://img-blog.csdnimg.cn/img_convert/e4250aa699e0856f883c3b1b9d9cafba.png)

### 磁盘分区

配置磁盘分区：

![](https://img-blog.csdnimg.cn/img_convert/98f8abf43b2eadbdd60800091eb35cc3.png)

选择自定义：

![](https://img-blog.csdnimg.cn/img_convert/2dc8abfa1d6fccd761cdbfa9013d3a9f.png)

自动创建分区：

![](https://img-blog.csdnimg.cn/img_convert/3b7cc082e7be4a7814c13414e7b1efc5.png)

可根据需要自行配置分区，我这里默认不做修改：

![](https://img-blog.csdnimg.cn/img_convert/fc5206dd7839ebb55cfd1f76afe4601d.png)

完成磁盘分区：

![](https://img-blog.csdnimg.cn/img_convert/83b397a1a87c6c0cae08296e5b90788f.png)

### 配置主机名和网络

选择主机名和网络配置进入配置详情页：

![](https://img-blog.csdnimg.cn/img_convert/20c6d71573ef10ed8de2561a8938ef6f.png)

填写主机名并生效，启用网卡并配置网络：

![](https://img-blog.csdnimg.cn/img_convert/401938e9bc97099c025a1d6af3ac1864.png)

配置网络信息：

![](https://img-blog.csdnimg.cn/img_convert/a71960e2eeb243c592319bf66ec4a3ca.png)

配置完成：

![](https://img-blog.csdnimg.cn/img_convert/f76d81f7357336fe32c61af892e3043d.png)

### 配置时区

相对于之前的版本，配置时区这里不再是一个世界地图，而是改成了纯选项框：

![](https://img-blog.csdnimg.cn/img_convert/1658936fac8b8e6a500b0b396ab78057.png)

这里还增加了一个 NTP 配置选项，前提是需要先配置好网络：

![](https://img-blog.csdnimg.cn/img_convert/e37e27b90b9fb9bb9cfaa24efb965539.png)

### 配置 root 密码

默认不启用 root 账户：

![](https://img-blog.csdnimg.cn/img_convert/50eca22c8498ab9cd4cf19b8c64d9b3c.png)

选择启用 root 用户并设置可以使用密码连接：

![](https://img-blog.csdnimg.cn/img_convert/f19a0ac03acd1fc744939ff9b12c235a.png)
...
![](https://img-blog.csdnimg.cn/img_convert/aa7a3356d77d26effa82f4a4c16c7ae1.png)
...
![](https://img-blog.csdnimg.cn/img_convert/018ee49df4ea6e922bc38ff85e10a2bf.png)

![](https://img-blog.csdnimg.cn/img_convert/a0a5bb0dc4ad83289c51b654911221a4.png)

等到一段时间后，即可安装完成：

![](https://img-blog.csdnimg.cn/img_convert/cd80c8a4f4ed611c7ca38dc738b32415.png)

重启之后，进入操作系统登录界面：

![](https://img-blog.csdnimg.cn/img_convert/2f4621dc79e14e2c7243779e3be99e3d.png)

进入系统后，映入眼帘的是一个大大的 10：

![](https://img-blog.csdnimg.cn/img_convert/104eb15a975588dd74fbbc947f95a361.png)

...
SQL语言有40多年的历史，从它被应用至今几乎无处不在。我们消费的每一笔支付记录，收集的每一条用户信息，发出去的每一条消息，都会使用数据库或与其相关的产品来存储，而操纵数据库的语言正是 SQL ！  
 ![](/csdn-blog/images/151ce3dd95c108f1ff4e8eeffec661da.png)  
 SQL 对于现在的互联网公司生产研发等岗位几乎是一个必备技能，如果不会 SQL 的话，可能什么都做不了。你可以把 SQL 当做是一种工具，利用它可以帮助你完成你的工作，创造价值。

**![](/csdn-blog/images/0478555753002083b8b124e824e319e3.gif)  
...
![](/csdn-blog/images/70812ce089f38c5c21e3549671283123.png)  
...
打个比方，每个人家里都会有冰箱，冰箱是用来干什么的？冰箱是用来存放食物的地方。  
 ![](/csdn-blog/images/37c8fd82fdc1c47d68795f4784874beb.png)  
...
Microsoft
 Access等等。  
 ![](/csdn-blog/images/b8052ee6e73d9a6cc2a3f28f68c67459.png)  
...
Id\_P 列的数据类型是 int，包含整数。其余 4 列的数据类型是 varchar，最大长度为 255 个字符。  
 ![](/csdn-blog/images/569290866817fec8246fccb69f7ae883.png)  
 ![](/csdn-blog/images/8644fdf1c40acc4cb1c2e9353ba19952.png)  
 **空的 “Persons” 表类似这样：**  
 ![](/csdn-blog/images/149ce765bebb19b0574efa9a49d85ff2.png)   
...
![](/csdn-blog/images/65a42f746f863059d466820f3ed43518.png)  
 **插入成功后，数据如下：**  
 ![](/csdn-blog/images/86652a4296693ef8a8b77f7669b2aa42.png)  
...
![](/csdn-blog/images/f3adb82be4a06d0cdb350ae58f273f02.png)  
 **📢 注意：** 星号（\*）是选取所有列的快捷方式。
...
![](/csdn-blog/images/5965b0f7121b18f5d91d4a1229e5dbb2.png)
...
![](/csdn-blog/images/85775797066bf9c0f1c7822b598a7176.png)  
...
![](/csdn-blog/images/7596a0f3f1ca13761948d167ef9e24da.png)  
...
![](/csdn-blog/images/b5cc16f7a7ec682e09b831cf241a9d4b.png)  
...
![](/csdn-blog/images/bc2ed3d5bc53fc6271f00b139df775b2.png)  
 **AND 运算符实例：**
...
![](/csdn-blog/images/290d9a69a1db2c3895309a358cd6e15e.png)  
 **OR 运算符实例：**
...
![](/csdn-blog/images/baa3a80dabdda80b1d7b7e8961f90f19.png)  
 **结合 AND 和 OR 运算符：**
...
![](/csdn-blog/images/e9bca0790a35c4ba31679cbcd2ea1b49.png)
...
![](/csdn-blog/images/4c4e7f5f8794fe283f53cd4e0c531c6d.png)  
 空值（NULL）默认排序在有值行之后。
...
![](/csdn-blog/images/cb2a673e5808db82470b48b1f7797789.png)  
 以数字降序显示`ID_P`：
...
![](/csdn-blog/images/34efba718f61275be2ad58a08933baa1.png)  
...
![](/csdn-blog/images/aef13357afe67e95f969db5f6e51eac9.png)  
 **更新某一行中的若干列：**
...
![](/csdn-blog/images/a65af7bbf6088a8bb7193c739ca20aab.png)
...
![](/csdn-blog/images/b63c2baa93df8951f938869f7419af52.png)  
 **删除所有行：**
...
![](/csdn-blog/images/d561ed95ff0ce496a44d62ef4ef352dd.png)
...
![](/csdn-blog/images/2f7b22e79c8334fbbaf36fc3ca1e7452.png)  
...
![](/csdn-blog/images/e89e52627018141cb814b65a910c6ab8.png)  
...
![](/csdn-blog/images/5d82ce047a4aa27d7cb1353d441cc7a6.png)  
...
![](/csdn-blog/images/677a413da85e8d3d04c1acbf3c6ae8df.png)  
...
![](/csdn-blog/images/a4ac6ffc89b6b8e86a392aa2109edde6.png)  
...
![](/csdn-blog/images/f505ce9cdae8c12cbd306c8b0b17cab3.png)  
...
![](/csdn-blog/images/5d48d9c40c727934f196ce5a30e971da.png)
...
![](/csdn-blog/images/abf3c185b32f48cfc4d65f3c54688dec.png)  
...
![](/csdn-blog/images/ab07c99516de3575a191bf8a47f2f00a.png)  
...
![](/csdn-blog/images/576f3b038b13ff5336c5e2a952cf0193.png)  
 **使用列名别名：**
...
![](/csdn-blog/images/fd67867a7ac619e88092c358d22eb3fb.png)  
...
数据库中的表可通过键将彼此联系起来。主键（Primary Key）是一个列，在这个列中的每一行的值都是唯一的。在表中，每个主键的值都是唯一的。这样做的目的是在不重复每个表中的所有数据的情况下，把表间的数据交叉捆绑在一起。  
 ![](/csdn-blog/images/b058a7a2653e7f56249958bc15472875.png)  
...
![](/csdn-blog/images/4e018d72ea7fe7124617ef60dda94f85.png)  
...
![](/csdn-blog/images/3318863f5bdd92888c919ee5078d053b.png)  
...
![](/csdn-blog/images/41e0db72b4588bf2567c2c4a9165add5.png)
...
![](/csdn-blog/images/d59aeb89afe68367b567c63ed4b92efe.png)  
 **实例：**
...
![](/csdn-blog/images/971a7275d517625a4bf6e7851a403799.png)  
...
![](/csdn-blog/images/31d623822f1bc011a1b963ad266c7a29.png)  
...
![](/csdn-blog/images/49606eca682dc4a2c2de86dc35e82955.png)  
 同理，`NULL` 也可：
...
![](/csdn-blog/images/a032591bc7a2b30f5d64fdfde07e0a8a.png)  
 查询上面这个视图：  
 ![](/csdn-blog/images/0e2913e1f0d8b372cfdcd656b14b37fb.png)  
...
![](/csdn-blog/images/0457e6d6911de8231e723d61637084b6.png)  
 ![](/csdn-blog/images/c8e426543dbf28e8932401b610619641.png)  
...
![](/csdn-blog/images/02d785b6d9d5296e69d41576b8de2ada.png)  
...
![](/csdn-blog/images/91acb8f2dde47757fbe696f9458207b4.png)  
...
![](/csdn-blog/images/803a1c0474b17819dd0fdbdae14fd476.png)
...
![](/csdn-blog/images/f184f4d2d089d9bdc55a6a50ec8dce39.png)  
 **COUNT(DISTINCT 列名) ：**
...
![](/csdn-blog/images/fc620e839d872220c653d8633f0ef9c7.png)  
 **COUNT(列名) ：**
...
![](/csdn-blog/images/8114da9188198dcdaad0bbc59cd62bb7.png)
...
![](/csdn-blog/images/9da0842c525f7cbc099bf045950a4990.png)
...
![](/csdn-blog/images/925a3dd2e35b7146735f7c0793feafe3.png)
...
![](/csdn-blog/images/cda8a96f727537f3fe91c83b56fb4c73.png)
...
![](/csdn-blog/images/1243cf316d43b26e9abd1253013a082f.png)  
 如果不加 `GROUP BY`  则会报错：  
 ![](/csdn-blog/images/81a5cc51f6f0735063a422cd0c6e1be9.png)  
...
![](/csdn-blog/images/62636dbc1624061c759828d824ee28db.png)
...
![](/csdn-blog/images/9d1b90dec4bb4de8d151e17daedad44c.png)
...
![](/csdn-blog/images/26aae03175e7ae77d04a5b276a8b73ed.png)
...
![](/csdn-blog/images/da9196df75065ed2a41fa22603c05274.png)
...
![](/csdn-blog/images/5aac38435d4ffce495450801288a9174.png)  
 ![](/csdn-blog/images/a8a6ed09b08de1d249ae5df5beddd56c.png)  
 📢 注意：`ROUND` 取舍是 **四舍五入** 的！
...
![](/csdn-blog/images/801361796a73d46b78a48ac367e5f441.png)
...
![](/csdn-blog/images/7e4ad2de863a47d5a5e5ffd4a5de6f14.png)  

---
title: '统信 UOS V20 1070(a) 一键安装 Oracle 11GR2 单机 ASM'
...
tags:
  ...
  - 数据库
abbrlink: 139777323
csdn_url: https://luciferliu.blog.csdn.net/article/details/139777323
description: '前言 Oracle 一键安装脚本，演示 统信 UOS V20 1070(a) 一键安装 Oracle 11GR2 单机 ASM（全程无需人工干预）。 ⭐️ 脚本下载地址：Shell脚本安装Oracle数据库 前置准备 1、安装好操作系统，建议安装图形化 2、配置好网络 3、挂载本地 ISO 镜像源'
keywords: 'oracle, 数据库'
cover: '/img/covers/oracle.svg'
---
## 前言

Oracle 一键安装脚本，演示 统信 UOS V20 1070(a) 一键安装 Oracle 11GR2 单机 ASM（全程无需人工干预）。
...
-rwxr-xr-x 1 root root     213304  5月 24 13:45 OracleShellInstall
...
-rwx------ 1 root root 1205251894  5月 24 13:44 p13390677_112040_Linux-x86-64_3of7.zip
-rwx------ 1 root root  174911877  5月 24 13:44 p18370031_112040_Linux-x86-64.zip
...
OracleShellInstall 开始安装，详细安装过程可查看日志： tail -2000f /soft/print_shell_install_20240524135110.log                                                                                  
...
正在解压 Grid 安装包以及补丁......已完成 (耗时: 25 秒)
正在解压 Oracle 安装包以及补丁......已完成 (耗时: 30 秒)
正在安装 Grid 软件以及补丁......已完成 (耗时: 349 秒)
正在安装 Oracle 软件以及补丁......已完成 (耗时: 240 秒)
正在创建数据库......已完成 (耗时: 334 秒)
正在优化数据库......已完成 (耗时: 25 秒)

恭喜！Oracle 单机 ASM 安装成功 (耗时: 1088 秒)，现在是否重启主机：[Y/N] Y
...
--------------------------------------------------------------------------------
ora.DATA.dg
               ONLINE  ONLINE       uos1070                                      
ora.asm
               ONLINE  ONLINE       uos1070                  Started             
ora.ons
               OFFLINE OFFLINE      uos1070                                      
--------------------------------------------------------------------------------
Cluster Resources
--------------------------------------------------------------------------------
ora.cssd
      1        ONLINE  ONLINE       uos1070                                      
ora.diskmon
      1        OFFLINE OFFLINE                                                   
ora.evmd
      1        ONLINE  ONLINE       uos1070                                      
ora.lucifer.db
      1        ONLINE  ONLINE       uos1070                  Open
```
...
LSNRCTL for Linux: Version 11.2.0.4.0 - Production on 04-JUN-2024 16:51:29
...
Start Date                04-JUN-2024 16:50:53
...
SQL*Plus: Release 11.2.0.4.0 Production on Tue Jun 4 16:51:31 2024
...
sys@LUCIFER 2024-06-04 16:51:31> show parameter name

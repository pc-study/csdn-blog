...
tags:
  ...
  - YashanDB
abbrlink: 142649947
csdn_url: https://luciferliu.blog.csdn.net/article/details/142649947
description: '大家好，这里是公众号 DBA学习之路，分享一些学习国产数据库路上的知识和经验。 目录 前言 环境介绍 安装前准备 openssl 检查 关闭防火墙 创建用户和组 创建目录 系统参数配置 资源配置 关闭透明大页 安装步骤（使用yashan用户） 解压安装软件 生成安装配置文件 安装 yasom 安装'
...
* + [openssl 检查](#openssl__17)
  ...
  + [资源配置](#_128)
  + [关闭透明大页](#_142)
* [安装步骤（使用yashan用户）](#yashan_189)
* + [解压安装软件](#_196)
  + [生成安装配置文件](#_204)
  + [安装 yasom](#_yasom_221)
  + [安装 yasagent](#_yasagent_226)
  + [配置环境变量](#_236)
  + [连接数据库](#_246)
  + [创建用户](#_255)
* [配置开机自启](#_261)
* [YashanDB 常用命令](#YashanDB__310)

...
tags:
  ...
  - 数据库
abbrlink: 154742448
csdn_url: https://luciferliu.blog.csdn.net/article/details/154742448
description: '前言 昨天安装一套 EMCC13.5，安装过程中 VNC 卡死导致安装失败，清理目录后重新执行安装，结果安装过程中报错了： 应该是 OMS 数据库在前一次安装过程中已经创建了用户以及一些对象，导致 OMS 数据库不干净了，一般建议重建 OMS 数据库，但是时间比较久，今天介绍一下另一种解决这个问题的'
keywords: 'oracle, 数据库'
cover: '/images/906c9e9e996746d92d2a284c33fbf3ac.webp'
---
## 前言
...
![EMCC 13.5 安装中断，如何清理 OMS 库？](/images/7b109b723b3c5334918c056d8ff6edb8.webp)
...
![EMCC 13.5 安装中断，如何清理 OMS 库？ - 图2](/images/906c9e9e996746d92d2a284c33fbf3ac.webp)

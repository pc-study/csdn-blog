...
tags:
  ...
  - 数据库
abbrlink: 142978918
csdn_url: https://luciferliu.blog.csdn.net/article/details/142978918
description: '大家好，这里是公众号 Lucifer三思而后行，分享一些学习国产数据库路上的知识和经验。 目录 前言 介绍 19.25 RU 补丁安装 环境准备 README 升级 OPatch 冲突检查 补丁升级 一键安装补丁 写在最后 前言 今天一早打开邮箱收到 Oracle 的邮件，开头内容如下： 原来是 O'
keywords: 'oracle, 数据库'
...
* [前言](#_4)
* [介绍](#_20)
* [19.25 RU 补丁安装](#1925_RU__47)
* + [环境准备](#_59)
  + [README](#README_144)
  + [升级 OPatch](#_OPatch_157)
  + [冲突检查](#_186)
  + [补丁升级](#_218)
* [一键安装补丁](#_577)
* [写在最后](#_711)
...
原来是 Oracle 第四季度补丁发布了，**Oracle 19C 补丁限时下载链接，明天删除**！！！

* [《Oralce 19C 19.25 RU 20241015 Linux 最新补丁（GI+DB+OPatch+OJVM）》](https://www.modb.pro/doc/136718)
...
![](https://img-blog.csdnimg.cn/img_convert/bc805c6b18c97620b2f04a97dc6f8e5f.png)

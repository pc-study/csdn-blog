---
title: 'RedHat 8.9 一键安装 Oracle 11GR2 单机'
date: 2024-06-18 16:01:24
categories:
  - Oracle 数据库
tags:
  - oracle
  - 数据库
abbrlink: 139776232
csdn_url: https://luciferliu.blog.csdn.net/article/details/139776232
description: '前言 Oracle 一键安装脚本，演示 RedHat 8.9 一键安装 Oracle 11GR2 单机过程（全程无需人工干预）。 ⭐️ 脚本下载地址：Shell脚本安装Oracle数据库 安装准备 1、安装好操作系统，建议安装图形化 2、配置好网络 3、挂载本地 ISO 镜像源 4、上传软件安装包（'
keywords: 'oracle, 数据库'
cover: '/img/covers/oracle.svg'
---
## 前言

Oracle 一键安装脚本，演示 RedHat 8.9 一键安装 Oracle 11GR2 单机过程（全程无需人工干预）。
...
OracleShellInstall 开始安装，详细安装过程可查看日志： tail -2000f /soft/print_shell_install_20240613154617.log                                                                                  
正在获取操作系统信息......已完成 (耗时: 1 秒)
正在配置本地软件源......已完成 (耗时: 1 秒)
正在安装依赖包......已完成 (耗时: 132 秒)
正在禁用防火墙......已完成 (耗时: 1 秒)
...
正在创建监听......已完成 (耗时: 14 秒)
正在创建数据库......已完成 (耗时: 230 秒)
正在优化数据库......已完成 (耗时: 39 秒)

恭喜！Oracle 一键安装执行完成 (耗时: 672 秒)，现在是否重启主机：[Y/N] Y
...
LSNRCTL for Linux: Version 11.2.0.4.0 - Production on 13-JUN-2024 16:02:37
...
Start Date                13-JUN-2024 16:01:23
...
SQL*Plus: Release 11.2.0.4.0 Production on Thu Jun 13 16:02:38 2024
...
sys@LUCIFER 2024-06-13 16:02:38> show parameter name

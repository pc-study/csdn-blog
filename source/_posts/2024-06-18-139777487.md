---
title: '统信 UOS V20 1001(c) 一键安装 Oracle 12CR2 单机'
date: 2024-06-18 16:33:09
categories:
  - Oracle 数据库
tags:
  - c语言
  ...
  - 开发语言
abbrlink: 139777487
csdn_url: https://luciferliu.blog.csdn.net/article/details/139777487
description: '前言 Oracle 一键安装脚本，演示 统信 UOS V20 1001© 一键安装 Oracle 12CR2 单机（全程无需人工干预）。 ⭐️ 脚本下载地址：Shell脚本安装Oracle数据库 前置准备 1、安装好操作系统，建议安装图形化 2、配置好网络 3、挂载本地 ISO 镜像源 4、上传软件'
keywords: 'c语言, oracle, 开发语言'
cover: '/img/covers/oracle.svg'
---
## 前言

Oracle 一键安装脚本，演示 统信 UOS V20 1001© 一键安装 Oracle 12CR2 单机（全程无需人工干预）。
...
OracleShellInstall 开始安装，详细安装过程可查看日志： tail -2000f /soft/print_shell_install_20240617224544.log                                          
...
正在安装 Oracle 软件以及补丁......已完成 (耗时: 329 秒)
正在创建监听......已完成 (耗时: 3 秒)
正在创建数据库......已完成 (耗时: 371 秒)
正在优化数据库......已完成 (耗时: 14 秒)

恭喜！Oracle 一键安装执行完成 (耗时: 816 秒)，现在是否重启主机：[Y/N] Y
...
LSNRCTL for Linux: Version 12.2.0.1.0 - Production on 17-JUN-2024 23:06:14
...
Start Date                17-JUN-2024 23:04:11
...
SQL*Plus: Release 12.2.0.1.0 Production on Mon Jun 17 23:06:28 2024
...
sys@LUCIFER 2024-06-17 23:06:28> show parameter name

...
tags:
  ...
  - arm开发
abbrlink: 140035242
csdn_url: https://luciferliu.blog.csdn.net/article/details/140035242
description: '前言 Oracle 一键安装脚本，演示 Oracle Linux 8.10 ARM 一键安装 Oracle 19C 单机（全程无需人工干预）。 ⭐️ 脚本下载地址：Shell脚本安装Oracle数据库 前置准备 1、系统组安装好操作系统（支持最小化安装） 2、网络组配置好主机网络，通常只需要一个公网'

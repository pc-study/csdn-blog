...
tags:
  ...
  - vagrant
abbrlink: 119845979
csdn_url: https://luciferliu.blog.csdn.net/article/details/119845979
...
cover: '/images/aaa7a3fa8bfa445092bb51c0645f6c6a.webp'
---
#### 目录
...
* + [下载项目](#_25)
  + [安装软件](#_37)
  + [下载 Oracle 安装包](#_Oracle__41)
* [安装](#_53)
* + [编辑 vagrant.yml 文件](#_vagrantyml__55)
  + [开始安装](#_108)
* [使用方式](#_122)
* + [连接主机](#_126)
  + [关闭主机](#_136)
...
![《零基础安装 Oracle 数据库》单机系列 ⑤ 一键快速安装 Oracle 21C 数据库](/images/6498280d0b8037bd8fce04581e1ee035.webp)
...
![《零基础安装 Oracle 数据库》单机系列 ⑤ 一键快速安装 Oracle 21C 数据库 - 图2](/images/c5e2867b4275c3a593372dd147463e2c.webp)

**📢 注意：** 项目 `single_db/software/21300` 目录中有一个 `software.txt` 文件，内容为你需要上传的 Oracle 安装包。请确保安装包名称与以下名称相同，否则安装 **失败**！
...
![《零基础安装 Oracle 数据库》单机系列 ⑤ 一键快速安装 Oracle 21C 数据库 - 图5](/images/aaa7a3fa8bfa445092bb51c0645f6c6a.webp)
...
![《零基础安装 Oracle 数据库》单机系列 ⑤ 一键快速安装 Oracle 21C 数据库 - 图6](/images/3d6bf124ce6cc5797d1667188a9ec43f.webp)

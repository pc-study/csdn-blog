...
date: 2024-08-15 09:51:57
categories:
  - 技术文章
tags:
  - python
abbrlink: 141211888
csdn_url: https://luciferliu.blog.csdn.net/article/details/141211888
description: '大家好，这里是 Lucifer 三思而后行，专注于提升数据库运维效率。 目录 一篇文章让你彻底掌握 Python 解释器 注释 数据类型 操作符 - 算术运算符 比较运算符 赋值运算符 位运算符 逻辑运算符 成员运算符 身份运算符 运算符优先级 控制语句 - 条件语句 循环语句 while for'
keywords: 'python'
cover: '/img/covers/tech.svg'
---
> 大家好，这里是 **Lucifer 三思而后行**，专注于提升数据库运维效率。

#### 目录

* [一篇文章让你彻底掌握 Python](#_Python_5)
* + [解释器](#_16)
  + [注释](#_28)
  + [数据类型](#_52)
  + [操作符](#_63)
  ...
  + - [条件语句](#_165)
    ...
    - * [while](#while_178)
      * [for](#for_185)
      * [range()](#range_192)
      * [break 和 continue](#break__continue_199)
      * [pass](#pass_204)
  + [函数](#_213)
  + - [函数变量作用域](#_222)
    - [关键字参数](#_246)
...
**\_\_private\_method**：两个下划线开头，声明该方法为私有方法，不能在类地外部调用。在类的内部调用  **slef.\_\_private\_methods**。

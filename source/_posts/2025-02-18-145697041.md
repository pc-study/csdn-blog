...
cover: '/images/ddd98524b5ab32850a1d20202a1bd937.webp'
---
...
![实战篇：JS kgl get object wait 等待事件分析](/images/ddd98524b5ab32850a1d20202a1bd937.webp)

可以看到 Top10 等待事件排名第一是 `JS kgl get object wait` 等待事件：

![实战篇：JS kgl get object wait 等待事件分析 - 图2](/images/4a369e237906f308a40edb14e74bc190.webp)
...
![实战篇：JS kgl get object wait 等待事件分析 - 图3](/images/82671cd903c643d75f3f038c3503a5a1.webp)
...
![实战篇：JS kgl get object wait 等待事件分析 - 图4](/images/b4072394adb2d4b963f059b22544fada.webp)

而 **Bug 36623712** 是在 `job creations` 的时候：

![实战篇：JS kgl get object wait 等待事件分析 - 图5](/images/848ab9af4504a357b221d11f65be34d6.webp)
...
![实战篇：JS kgl get object wait 等待事件分析 - 图6](/images/3fec1130ce24ec707a534b818802c07f.webp)
...
![实战篇：JS kgl get object wait 等待事件分析 - 图7](/images/95de78658e0bca36f44c6c1a90c20b41.webp)

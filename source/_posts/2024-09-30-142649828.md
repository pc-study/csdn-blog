...
tags:
  ...
  - 数据库
abbrlink: 142649828
csdn_url: https://luciferliu.blog.csdn.net/article/details/142649828
description: '大家好，这里是 Lucifer三思而后行，专注于提升数据库运维效率。 目录 前言 资源分享 阅读官方文档 Database Concepts Administrator''s Guide Database Reference Install and Upgrade Development Perfor'
keywords: 'oracle, 数据库'
...
* [资源分享](#_7)
* [阅读官方文档](#_48)
* + [Database Concepts](#Database_Concepts_62)
  + [Administrator's Guide](#Administrators_Guide_75)
  + [Database Reference](#Database_Reference_86)
  + [Install and Upgrade](#Install_and_Upgrade_95)
  + [Development](#Development_110)
  + [Performance](#Performance_117)
* [往期精彩文章推荐](#_128)
...
![image.png](https://img-blog.csdnimg.cn/img_convert/20d4257e6b2c5296eb667b3ce482c58d.png)
...
![](https://img-blog.csdnimg.cn/img_convert/f44c576848c9b6a5d5d48a3b1b65422a.png)

打开之后，可以通过对应的章节查询需要了解的信息，比如我要查看数据库内存结构相关的部分：

![](https://img-blog.csdnimg.cn/img_convert/9c68651e507537cf0dca25e70973fc15.png)
...
![](https://img-blog.csdnimg.cn/img_convert/5aabd9b90b4fb426cde81388f5cd1af1.png)

这本书介绍了各种管理 Oracle 数据库的场景，包括管理表，索引，表空间，控制文件，redo，undo 等等。比如，我们想要查询如何管理控制文件：

![](https://img-blog.csdnimg.cn/img_convert/01152ea21d938b7bc3b98f4f631bbe9b.png)
...
![](https://img-blog.csdnimg.cn/img_convert/02d09a0253b2530f13ef058df30f18da.png)

比如我们想要快速找到 db\_block\_size 相关的介绍：

![](https://img-blog.csdnimg.cn/img_convert/7f3c7aa0772b44f304dc383d4bdf84ba.png)

### Install and Upgrade

作为每一个 Oracle DBA 都避不过的一件事就是安装和升级 Oracle 数据库，在这方面，Oracle 提供了非常全面的详细的文档：《Install and Upgrade》，这本书里面囊括了各种操作系统的安装手册和注意事项。

![](https://img-blog.csdnimg.cn/img_convert/fa4344d54107976afc5454054148ef4e.png)

比如我现在需要在 Linux 主机上安装一套 Oracle 19C 的数据库，安装前我发现对数据库所需的配置和依赖包不太了解，这时就可以查询官方文档：

![](https://img-blog.csdnimg.cn/img_convert/ddfaa8577b36945948c7f12e2ed71a62.png)

选择对应的章节【Operating System Requirements for x86-64 Linux Platforms】：

![](https://img-blog.csdnimg.cn/img_convert/4b7d327a98f374b8fb21ea3b4f98cbca.png)
...
![](https://img-blog.csdnimg.cn/img_convert/32dc350709603e7d7d4251d9409c5725.png)
...
![](https://img-blog.csdnimg.cn/img_convert/7b9531f59a0a90dad370d94e68455407.png)

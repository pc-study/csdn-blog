...
tags:
  ...
  - bash
abbrlink: 141211766
csdn_url: https://luciferliu.blog.csdn.net/article/details/141211766
description: '大家好，这里是 Lucifer三思而后行，专注于提升数据库运维效率。 文章目录 一篇文章让你彻底掌握 Shell 简介 什么是 shell 什么是 shell 脚本 Shell 环境 - 指定脚本解释器 模式 - 交互模式 非交互模式 基本语法 - 解释器 注释 echo printf printf'
keywords: 'shell, bash'
...
* [一篇文章让你彻底掌握 Shell](#_Shell_3)
* [简介](#_17)
* + [什么是 shell](#_shell_19)
  + [什么是 shell 脚本](#_shell__27)
  + [Shell 环境](#Shell__33)
  + - [指定脚本解释器](#_45)
  + [模式](#_71)
  + - [交互模式](#_75)
  ...
  + - [条件语句](#_1177)
    ...
    - [循环语句](#_1269)
    - * [for 循环](#for__1280)
      * [while 循环](#while__1319)
      * [until 循环](#until__1354)
      * [select 循环](#select__1374)
      * [break 和 continue](#break__continue_1420)
  + [函数](#_1461)
  + - [位置参数](#_1529)
    - [函数处理参数](#_1590)
  + [Shell 扩展](#Shell__1643)
  + - [大括号扩展](#_1649)
    - [命令置换](#_1664)
    - [算数扩展](#_1676)
    - [单引号和双引号](#_1695)

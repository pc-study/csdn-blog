---
title: 'RedHat 8.9 一键安装 Oracle 12CR2 单机'
date: 2024-06-18 16:04:00
categories:
  - Oracle 数据库
tags:
  - oracle
  - 数据库
abbrlink: 139776325
csdn_url: https://luciferliu.blog.csdn.net/article/details/139776325
description: '前言 Oracle 一键安装脚本，演示 RedHat 8.9 一键安装 Oracle 12CR2 单机过程（全程无需人工干预）。 ⭐️ 脚本下载地址：Shell脚本安装Oracle数据库 安装准备 1、安装好操作系统，建议安装图形化 2、配置好网络 3、挂载本地 ISO 镜像源 4、上传软件安装包（'
keywords: 'oracle, 数据库'
cover: '/img/covers/oracle.svg'
---
## 前言

Oracle 一键安装脚本，演示 RedHat 8.9 一键安装 Oracle 12CR2 单机过程（全程无需人工干预）。
...
# 安装包存放在 /soft 目录下
[root@rhel8 soft]# ll
-rwxr-xr-x. 1 root root     214424 Jun 13 15:42 OracleShellInstall
-rwx------. 1 root root 3453696911 Jun 13 15:06 LINUX.X64_122010_db_home.zip
```
...
OracleShellInstall 开始安装，详细安装过程可查看日志： tail -2000f /soft/print_shell_install_20240613163037.log                                                                                  
...
正在安装 Oracle 软件以及补丁......已完成 (耗时: 468 秒)
正在创建监听......已完成 (耗时: 17 秒)
正在创建数据库......已完成 (耗时: 513 秒)
...
LSNRCTL for Linux: Version 12.2.0.1.0 - Production on 13-JUN-2024 16:53:53
...
Start Date                13-JUN-2024 16:53:25
...
SQL*Plus: Release 12.2.0.1.0 Production on Thu Jun 13 16:54:01 2024
...
sys@LUCIFER 2024-06-13 16:54:02> show parameter name

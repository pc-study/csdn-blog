...
tags:
  ...
  - database
abbrlink: 121915597
csdn_url: https://luciferliu.blog.csdn.net/article/details/121915597
description: '函数是在 Oracle 11gR2 中引入的，以使字符串聚合更简单。在 Oracle 12cR2 中，它被扩展为包括溢出错误处理。 Oracle 19c 更新了 LISTAGG 功能，通过 关键字从结果中删除重复项。 配置 本文中的示例使用下表： 问题 该LISTAGG函数的默认操作如下所示： 让我'

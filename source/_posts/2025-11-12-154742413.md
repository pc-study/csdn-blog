...
tags:
  ...
  - 数据库
abbrlink: 154742413
csdn_url: https://luciferliu.blog.csdn.net/article/details/154742413
description: '目录 前言 备份方案 如何备份数据？ 如何管理备份数据？ 如何选择备份存储？ 如何恢复数据？ TiDB 快照备份 备份流程 恢复流程 备份文件 - 文件类型 备份文件目录结构 日志备份 PITR 日志备份文件 部署和使用 BR 通过命令行工具（推荐） 通过 SQL 语句 在 Kubernetes 环'
keywords: 'tidb, 数据库'
cover: '/images/2bb46896f408fb2cfc9f840ddc5a80ee.webp'
---
#### 目录
...
* + [通过命令行工具（推荐）](#_282)
  + [通过 SQL 语句](#_SQL__291)
  + [在 Kubernetes 环境下通过 TiDB Operator](#_Kubernetes__TiDB_Operator_297)
* [快照备份使用](#_300)
* + [对集群进行快照备份](#_301)
  + [恢复快照备份数据](#_331)
  + [恢复备份数据中指定库表的数据](#_346)
...
![TiDB 备份与恢复整理](/images/2bb46896f408fb2cfc9f840ddc5a80ee.webp)

### 备份流程

集群快照数据备份的流程如下：

![TiDB 备份与恢复整理 - 图2](/images/57c7023d1e041c8458e9d9291ff6dcb4.webp)
...
![TiDB 备份与恢复整理 - 图3](/images/8246f36bc80483c5bce2052ae215abde.webp)
...
![TiDB 备份与恢复整理 - 图4](/images/344ee7cceff59bde4980d9dd41b5cb08.webp)

日志备份的流程如下：

![TiDB 备份与恢复整理 - 图5](/images/8130ef602c4c49304f69b8113326cd64.webp)
...
![TiDB 备份与恢复整理 - 图6](/images/a399955c7472707ea0e18a95b9c9f6bc.webp)

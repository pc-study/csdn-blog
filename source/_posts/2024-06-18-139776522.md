---
title: '华为欧拉 openEuler 20.03 LTS SP4 一键安装 Oracle 19C 单机'
date: 2024-06-18 16:08:38
categories:
  - Oracle 数据库
tags:
  - oracle
  - 数据库
abbrlink: 139776522
csdn_url: https://luciferliu.blog.csdn.net/article/details/139776522
description: '前言 Oracle 一键安装脚本，演示华为欧拉 openEuler 20.03 LTS SP4 一键安装 Oracle 19C 单机版过程（全程无需人工干预）。 ⭐️ 脚本下载地址：Shell脚本安装Oracle数据库 安装准备 1、安装好操作系统，建议安装图形化 2、配置好网络 3、挂载本地 IS'
keywords: 'oracle, 数据库'
cover: '/img/covers/oracle.svg'
---
## 前言

Oracle 一键安装脚本，演示华为欧拉 openEuler 20.03 LTS SP4 一键安装 Oracle 19C 单机版过程（全程无需人工干预）。
...
-rwx------. 1 root root 2159353856 May 14 13:46 LINUX.X64_193000_db_home.zip
-rwxr-xr-x. 1 root root     207906 May 14 13:46 OracleShellInstall
...
OracleShellInstall 开始安装，详细安装过程可查看日志： tail -2000f /soft/print_shell_install_20240514134651.log                                                                                  
...
正在安装 Oracle 软件以及补丁......已完成 (耗时: 135 秒)
正在创建监听......已完成 (耗时: 4 秒)
正在创建数据库......已完成 (耗时: 700 秒)
正在优化数据库......已完成 (耗时: 29 秒)

恭喜！Oracle 单机安装成功 (耗时: 1035 秒)，现在是否重启主机：[Y/N] Y
...
LSNRCTL for Linux: Version 19.0.0.0.0 - Production on 14-MAY-2024 14:21:17
...
Start Date                14-MAY-2024 14:14:37
...
SQL*Plus: Release 19.0.0.0.0 - Production on Tue May 14 14:21:18 2024
Version 19.3.0.0.0
...
sys@LUCIFER 2024-05-14 14:21:18> show parameter name

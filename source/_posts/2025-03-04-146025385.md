...
![](/csdn-blog/images/2470a201bceb2d41064f342afc7b935a.png)
...
![](/csdn-blog/images/77b1115a6b7c56057b2d5fb88f60ba92.png)
...
![](/csdn-blog/images/5db57893a0ba234b44075ffcba727c38.png)

![](/csdn-blog/images/45303602c1de9c7bb88609f36b23cbfb.png)

初始化界面如下：

![](/csdn-blog/images/77167fa02697963f2fe24a68c9b5e633.png)
...
![](/csdn-blog/images/6238f50f2c1967bd408dab32ba7aa365.png)
...
![](/csdn-blog/images/0c02d499f2975e6508a867e742a3e80b.png)

填写数据库连接信息，点击测试连接：

![](/csdn-blog/images/fc13cc505c0bb734561df4392432b4a7.png)
...
![](/csdn-blog/images/d98197658c60e0283784e65416ac6bf0.png)

选择我们需要转换的数据库字符集：`AL32UTF8`

![](/csdn-blog/images/a2b20fe95a882da0d32d4db40c96b53f.png)

这里我选择 SYSAUX 表空间，大家也可以单独创建一个表空间：

![](/csdn-blog/images/a9d112b7aba33da0ddb75138846366a8.png)

点击完成：

![](/csdn-blog/images/c11b698a587332ef62006406e5949cef.png)

等待一会儿，会提示安装完成：

![](/csdn-blog/images/16110c6877f52e128ab7feef04338d8d.png)

可以看到转换字符集一共需要 4 步，目前已经完成第一步：

![](/csdn-blog/images/382aa36f4375ac10ff1246aaeb80754a.png)

### 扫描数据库

第二步需要扫描数据库，点击链接即可跳转：

![](/csdn-blog/images/8b94a8707186bfae96318af9cb137791.png)

配置一些参数用于扫描数据库，可根据实际情况进行配置：

![](/csdn-blog/images/6a55c6d4526efdeedeeed17ba53b69a5.png)

选择需要扫描的用户：

![](/csdn-blog/images/287db78c1b2528d086f9a129ec8eeb1a.png)

点击下一步：

![](/csdn-blog/images/9ba10dff009ebb8627015d38e3d2f713.png)

默认全部转换：

![](/csdn-blog/images/c93078a47c062198d4bdf47cfaa52c69.png)

等待扫描完成（**扫描时间取决于数据库对象数量以及大小**）：

![](/csdn-blog/images/38570b50a842ece43ff84b1361afad4c.png)

扫描完成，这里显示有一些有问题的对象，可以通过 `scan report` 查看：

![](/csdn-blog/images/939aa173805ebb0854dadde6b44e2f3e.png)

检查是否存在会转换失败的对象：

![](/csdn-blog/images/27c9a872261ad1d2192d9d1925a237bf.png)
...
![](/csdn-blog/images/50636c1daa7b16ee90e71627313c937d.png)
...
![](/csdn-blog/images/0591496eb54b1fcf1c8b1066f189bd0b.png)
...
![](/csdn-blog/images/47b9b87619be12fdfcf1f3169c4c9b05.png)

![](/csdn-blog/images/8c21210677ce0569c10b9ca47abb43f4.png)

扫描完成后，这个问题已经修复。

但是，发现还是有感叹号，再次查看，发现还有一个视图 `WRH$_SQLSTAT` 有问题：

![](/csdn-blog/images/96dfaac67000ff52aa690ec76076a6c9.png)

参考文档是需要重建 AWR 存储库：

![](/csdn-blog/images/ae72d134b49f9389a5854da40e481a16.png)
...
![](/csdn-blog/images/476dd4207a43661e5f6ee28bacf31a21.png)
...
![](/csdn-blog/images/1d2307ff6e2a659a7532844452a5c227.png)

第一个问题可以修改配置，这 2 个建议都改成 Yes：

![](/csdn-blog/images/f20b38282c0e12d0f2e1d01a19116e2f.png)

修改完之后，再次 `Retest` 一下：

![](/csdn-blog/images/d4163de5e25b0244ce48338d5005c080.png)

还有一个问题需要解决，这个是因为有表空间开启了 force logging：

![](/csdn-blog/images/a2fe0ec0f63e93aabf3161539d09a8f4.png)
...
![](/csdn-blog/images/b4eb634d460d3c3813b938f8aed61bec.png)
...
![](/csdn-blog/images/ba5376bf73d4093c1d4f3cd6a1667103.png)

确认没问题，执行转换：

![](/csdn-blog/images/26b0a44016dc7acebe2531f6aed32792.png)

这里需要注意的是，在转换时最好确保没有用户连接数据库，否则报错：

![](/csdn-blog/images/089618cac6a6ce4dfab931281e435d37.png)

转换前确认：

![](/csdn-blog/images/3492595787344b82869f2a82e815cdfe.png)

![](/csdn-blog/images/711e67033e2139e8bbd5c4a28cf922aa.png)

正式开始转换：

![](/csdn-blog/images/418dad12fcd7172bb2704e8583eed594.png)

很快转换完成：

![](/csdn-blog/images/12d54daf130fe09886c4fc9d87b19760.png)
...
![](/csdn-blog/images/37c29cf80953cda70b3ac5da932de656.png)
...
![](/csdn-blog/images/de7ffb279b7fda9c09e4b03e7cfaa8ce.png)

如果重新插入测试数据，就不会乱码：

![](/csdn-blog/images/a233b2b58643c0199b3a41e3ca72b9d1.png)

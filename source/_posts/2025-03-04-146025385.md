...
cover: '/images/77b1115a6b7c56057b2d5fb88f60ba92.webp'
---
...
![Oracle 修改数据库字符集大法 - DMU 工具](/images/2470a201bceb2d41064f342afc7b935a.webp)
...
![Oracle 修改数据库字符集大法 - DMU 工具 - 图2](/images/77b1115a6b7c56057b2d5fb88f60ba92.webp)
...
![Oracle 修改数据库字符集大法 - DMU 工具 - 图3](/images/5db57893a0ba234b44075ffcba727c38.webp)

![Oracle 修改数据库字符集大法 - DMU 工具 - 图4](/images/45303602c1de9c7bb88609f36b23cbfb.webp)

初始化界面如下：

![Oracle 修改数据库字符集大法 - DMU 工具 - 图5](/images/77167fa02697963f2fe24a68c9b5e633.webp)
...
![Oracle 修改数据库字符集大法 - DMU 工具 - 图6](/images/6238f50f2c1967bd408dab32ba7aa365.webp)
...
![Oracle 修改数据库字符集大法 - DMU 工具 - 图7](/images/0c02d499f2975e6508a867e742a3e80b.webp)

填写数据库连接信息，点击测试连接：

![Oracle 修改数据库字符集大法 - DMU 工具 - 图8](/images/fc13cc505c0bb734561df4392432b4a7.webp)
...
![Oracle 修改数据库字符集大法 - DMU 工具 - 图9](/images/d98197658c60e0283784e65416ac6bf0.webp)

选择我们需要转换的数据库字符集：`AL32UTF8`

![Oracle 修改数据库字符集大法 - DMU 工具 - 图10](/images/a2b20fe95a882da0d32d4db40c96b53f.webp)

这里我选择 SYSAUX 表空间，大家也可以单独创建一个表空间：

![Oracle 修改数据库字符集大法 - DMU 工具 - 图11](/images/a9d112b7aba33da0ddb75138846366a8.webp)

点击完成：

![Oracle 修改数据库字符集大法 - DMU 工具 - 图12](/images/c11b698a587332ef62006406e5949cef.webp)

等待一会儿，会提示安装完成：

![Oracle 修改数据库字符集大法 - DMU 工具 - 图13](/images/16110c6877f52e128ab7feef04338d8d.webp)

可以看到转换字符集一共需要 4 步，目前已经完成第一步：

![Oracle 修改数据库字符集大法 - DMU 工具 - 图14](/images/382aa36f4375ac10ff1246aaeb80754a.webp)

### 扫描数据库

第二步需要扫描数据库，点击链接即可跳转：

![Oracle 修改数据库字符集大法 - DMU 工具 - 图15](/images/8b94a8707186bfae96318af9cb137791.webp)

配置一些参数用于扫描数据库，可根据实际情况进行配置：

![Oracle 修改数据库字符集大法 - DMU 工具 - 图16](/images/6a55c6d4526efdeedeeed17ba53b69a5.webp)

选择需要扫描的用户：

![Oracle 修改数据库字符集大法 - DMU 工具 - 图17](/images/287db78c1b2528d086f9a129ec8eeb1a.webp)

点击下一步：

![Oracle 修改数据库字符集大法 - DMU 工具 - 图18](/images/9ba10dff009ebb8627015d38e3d2f713.webp)

默认全部转换：

![Oracle 修改数据库字符集大法 - DMU 工具 - 图19](/images/c93078a47c062198d4bdf47cfaa52c69.webp)

等待扫描完成（**扫描时间取决于数据库对象数量以及大小**）：

![Oracle 修改数据库字符集大法 - DMU 工具 - 图20](/images/38570b50a842ece43ff84b1361afad4c.webp)

扫描完成，这里显示有一些有问题的对象，可以通过 `scan report` 查看：

![Oracle 修改数据库字符集大法 - DMU 工具 - 图21](/images/939aa173805ebb0854dadde6b44e2f3e.webp)

检查是否存在会转换失败的对象：

![Oracle 修改数据库字符集大法 - DMU 工具 - 图22](/images/27c9a872261ad1d2192d9d1925a237bf.webp)
...
![Oracle 修改数据库字符集大法 - DMU 工具 - 图23](/images/50636c1daa7b16ee90e71627313c937d.webp)
...
![Oracle 修改数据库字符集大法 - DMU 工具 - 图24](/images/0591496eb54b1fcf1c8b1066f189bd0b.webp)
...
![Oracle 修改数据库字符集大法 - DMU 工具 - 图25](/images/47b9b87619be12fdfcf1f3169c4c9b05.webp)

![Oracle 修改数据库字符集大法 - DMU 工具 - 图26](/images/8c21210677ce0569c10b9ca47abb43f4.webp)

扫描完成后，这个问题已经修复。

但是，发现还是有感叹号，再次查看，发现还有一个视图 `WRH$_SQLSTAT` 有问题：

![Oracle 修改数据库字符集大法 - DMU 工具 - 图27](/images/96dfaac67000ff52aa690ec76076a6c9.webp)

参考文档是需要重建 AWR 存储库：

![Oracle 修改数据库字符集大法 - DMU 工具 - 图28](/images/ae72d134b49f9389a5854da40e481a16.webp)
...
![Oracle 修改数据库字符集大法 - DMU 工具 - 图29](/images/476dd4207a43661e5f6ee28bacf31a21.webp)
...
![Oracle 修改数据库字符集大法 - DMU 工具 - 图30](/images/1d2307ff6e2a659a7532844452a5c227.webp)

第一个问题可以修改配置，这 2 个建议都改成 Yes：

![Oracle 修改数据库字符集大法 - DMU 工具 - 图31](/images/f20b38282c0e12d0f2e1d01a19116e2f.webp)

修改完之后，再次 `Retest` 一下：

![Oracle 修改数据库字符集大法 - DMU 工具 - 图32](/images/d4163de5e25b0244ce48338d5005c080.webp)

还有一个问题需要解决，这个是因为有表空间开启了 force logging：

![Oracle 修改数据库字符集大法 - DMU 工具 - 图33](/images/a2fe0ec0f63e93aabf3161539d09a8f4.webp)
...
![Oracle 修改数据库字符集大法 - DMU 工具 - 图34](/images/b4eb634d460d3c3813b938f8aed61bec.webp)
...
![Oracle 修改数据库字符集大法 - DMU 工具 - 图35](/images/ba5376bf73d4093c1d4f3cd6a1667103.webp)

确认没问题，执行转换：

![Oracle 修改数据库字符集大法 - DMU 工具 - 图36](/images/26b0a44016dc7acebe2531f6aed32792.webp)

这里需要注意的是，在转换时最好确保没有用户连接数据库，否则报错：

![Oracle 修改数据库字符集大法 - DMU 工具 - 图37](/images/089618cac6a6ce4dfab931281e435d37.webp)

转换前确认：

![Oracle 修改数据库字符集大法 - DMU 工具 - 图38](/images/3492595787344b82869f2a82e815cdfe.webp)

![Oracle 修改数据库字符集大法 - DMU 工具 - 图39](/images/711e67033e2139e8bbd5c4a28cf922aa.webp)

正式开始转换：

![Oracle 修改数据库字符集大法 - DMU 工具 - 图40](/images/418dad12fcd7172bb2704e8583eed594.webp)

很快转换完成：

![Oracle 修改数据库字符集大法 - DMU 工具 - 图41](/images/12d54daf130fe09886c4fc9d87b19760.webp)
...
![Oracle 修改数据库字符集大法 - DMU 工具 - 图42](/images/37c29cf80953cda70b3ac5da932de656.webp)
...
![Oracle 修改数据库字符集大法 - DMU 工具 - 图43](/images/de7ffb279b7fda9c09e4b03e7cfaa8ce.webp)

如果重新插入测试数据，就不会乱码：

![Oracle 修改数据库字符集大法 - DMU 工具 - 图44](/images/a233b2b58643c0199b3a41e3ca72b9d1.webp)

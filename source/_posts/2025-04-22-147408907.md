...
tags:
  ...
  - 运维
abbrlink: 147408907
csdn_url: https://luciferliu.blog.csdn.net/article/details/147408907
description: '大家好，这里是 DBA学习之路，专注于提升数据库运维效率。 目录 前言 Top SQL 表空间使用率 RMAN 备份 DataGuard 等待事件 行级锁 在线日志切换 用户信息 ASM 磁盘组 DBLink 数据文件收缩 AWR 写在最后 前言 作为一名 Oracle DBA，在日常数据库运维工作'
keywords: 'oracle, dba, 运维'

...
tags:
  ...
  - oracle
abbrlink: 147409010
csdn_url: https://luciferliu.blog.csdn.net/article/details/147409010
description: '大家好，这里是 DBA学习之路，专注于提升数据库运维效率。 前言 前几天看到 Debian 出了 12.10 版本，今天周末手痒就用脚本测了一把一键安装 Oracle，没想到安装很顺利，只花了 5 分钟左右。至于为什么要选 ARM 版本，是因为我的电脑是 ARM 芯片，所以只能安装 ARM 版本的操'
keywords: '数据库, oracle'

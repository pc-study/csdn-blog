...
cover: '/images/426656afcf085ea9acc794c9fa3701bb.png'
---
## 前言
...
![](/images/426656afcf085ea9acc794c9fa3701bb.png)
...
​​![](/images/c878c98f2499dc6019cb37a4096074d9.png)  
...
或者 [**点我跳转文末**](#jump99) 可以获取 **百度网盘下载链接** 以及博主的联系方式  
 ![](/images/698008ca3e55075a3d520e2382b489d4.png)  
...
![](/images/47d95c862db08090dc5f74217849307a.png)
...
![](/images/650eea64ed9b3824e01cd4a5fb83d03b.png)  
...
![](/images/3cce96b686d9a39d0ffe16b4bbee8f27.png)
...
![](/images/6d7fb1f49a975d31ba024a72df045508.png)  
...
![](/images/ba60cd2a213676548dbccc22348f1cb7.png)
...
![](/images/ee73b19cc282c0fc5dd4d40a5c706d3c.png)  
...
![](/images/585a9466141881b56ab9676e6c19f4c7.png)  
 跳过版本更新：  
 选择集群模式安装：  
 ![](/images/516668884d363c261f1159bd3aa7876a.png)  
 自定义模式安装：  
 ![](/images/2182f346c265a784739374f34e14bacf.png)  
 选择语言：  
 ![](/images/2229c5f66581c2205457294e6faebacd.png)  
 修改集群名称和 scan 名称：  
...
点击Test测试互信：  
 ![](/images/2513fe4f84da0eef8efd89c3f0b4a94e.png)  
 确认网络信息是否正确：  
 选择ASM模式安装：  
 ![](/images/3873e90c31caa9c73868a1ec20506500.png)  
 填写 OCR 裁决盘信息：  
...
填写 ASM 实例 SYS 用户密码为 oracle：  
 ...
 选择用户组，默认即可：  
 选择grid安装目录，默认即可：  
 ![](/images/a8c7930600070912491e57b8a8034e46.png)  
 ![](/images/6da28525847dbaa8df5d954804e7e2e7.png)  
 安装前预检查：  
 ![](/images/0dbad2d9ee342562d552b752c994c20c.png)  
 开始执行安装：  
 ![](/images/e816dae513617e2c22511568c03068cc.png)  
 ![](/images/3f1556b349fa9859ee1b2b3f5a6457b0.png)  
 执行 root 脚本：（rac01&rac02）  
 **📢 注意：** Linux7 安装 Oracle 11GR2 版本，执行 root.sh 时存在 BUG：  
 ![](/images/d8795c0408c910c6d286b2bd977a0586.png)  
...
![](/images/5e348ea6bb5922a251802a5ebe56b83b.png)  
...
由于我们没有配置 DNS 解析，因此下方的错误忽略即可：  
 ![DNS报错](/images/a0d73b4d230f70b2cd98349d27cda4c2.png)  
 ![](/images/16b002b5d5b03ae44d9c1341a2a77d8e.png)  
 **至此，Grid集群软件安装成功！**
...
![](/images/0ce156a9616955f26f7406e38db90033.png)  
 点击 create 创建 DATA：  
 ![](/images/9ac04a18daf8f510b375745a2771731f.png)  
 点击 OK 创建 DATA：  
...
![](/images/56fbfb0b21aaa9cbb4b16f1f27b02664.png)  
 ![](/images/766d5d51ebe6dab08a50f864691c4783.png)  
 右键打开终端：  
 开始安装：
...
不配置 Oracle 邮件发送：  
 ![](/images/0153d8fe4e2e4da7413dda035db630b8.png)  
 跳过软件更新：  
 选择仅安装 oracle 软件：  
 配置 oracle 用户互信：  
 输入密码，点击 setup 开始，成功之后点击 Test 。  
 ![](/images/bc1ac905b23f4eb160adb3f2471c7f6a.png)  
 选择语言：  
 ![](/images/052f203b0537985a91447ac21987a7a2.png)  
 选择企业版安装：  
 ![](/images/2b82a2e70559a4289d78089488b5cb87.png)  
 检查用户组，默认即可：  
 ![](/images/1258fd100870e78f3bd0f96d32bf7195.png)  
 安装前预检查：  
 ![](/images/5868e25ae5f7d29cbde2b368476dcbe9.png)  
 开始安装 Oracle 软件：  
 报错解决：  
...
执行 root.sh 脚本：（rac01&rac02）  
 ![](/images/10dd9f4bcd3a2d3ac291ff4ee109ceb6.png)  
 点击下一步，安装成功：  
 **至此，Oracle 软件已成功安装！**
...
选择rac模式：  
 选择创建数据库：  
 ![](/images/4e22097cbb702ab43b6b3ce3e41bf867.png)  
 选择自定义模板：  
 ![](/images/6f7df56fbab6c58a584715e44ee0c08c.png)  
 **📢 注意：** 这里我选择的是 `Custom Database` 选项，可以自定义安装组件！

填写数据库实例 ID：  
 关闭 EM，保留自动化系统 JOB：  
 ![](/images/3139a4353e464f94c4b0f61b8bbd6f6b.png)  
 填写 SYS 密码，需要记住：  
 选择存放数据的 ASM 盘：**DATA**  
 不开启闪回区，建库后可随时开启：  
 ![](/images/e8ed8e59ec07e185d926ae07a2cbda69.png)  
 选择自定义组件，默认即可！配置初始化参数：  
 **📢 注意：** 如果使用自动管理内存，建议使用 **70%~90%** 的物理内存，建议 `/etc/shm` 和物理内存一样大！

block 默认 `8192`（即数据文件默认最大 32G），进程数增加到 `1500`：  
 ![](/images/fce7c3efd4d3493a3fbb43738c3fc0f2.png)  

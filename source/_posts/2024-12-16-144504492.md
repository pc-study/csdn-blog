...
tags:
  ...
  - DMDSC
abbrlink: 144504492
csdn_url: https://luciferliu.blog.csdn.net/article/details/144504492
...
keywords: '数据库, 达梦, DMDSC'
cover: '/images/9a95a3c3da236b89ac4ac76359e64ff3.webp'
---
...
* [前言](#_13)
* [DSC 介绍](#DSC__23)
* [DMDSC 使用的环境](#DMDSC__37)
* [DMDSC 实现原理](#DMDSC__48)
* + [DMCSS 介绍](#DMCSS__51)
  + [DMASM 介绍](#DMASM__58)
  + [DMASM 镜像介绍](#DMASM__67)
* [写在最后](#_79)
* [往期精彩文章](#_82)
...
![达梦 DMDSC 共享存储集群介绍](/images/9a95a3c3da236b89ac4ac76359e64ff3.webp)
...
| 软件硬件环境 | 环境介绍 |
| --- | --- |
| 主机（2 台） | 内存：2 GB 以上；网络：双网卡；提供内部网络和外部网络服务； 主机用于部署数据库实例 dmserver、DMCSS、DMASMSVR。 |
...
![达梦 DMDSC 共享存储集群介绍 - 图2](/images/07658613324d236e2175eca80c9751de.webp)
...
![达梦 DMDSC 共享存储集群介绍 - 图3](/images/316675c515ac03641b1d2001184f7b97.webp)

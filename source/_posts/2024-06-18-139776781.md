---
title: '华为欧拉 openEuler 22.03 LTS 一键安装 Oracle 11GR2 单机'
date: 2024-06-18 16:15:11
categories:
  - Oracle 数据库
tags:
  - oracle
  - 数据库
abbrlink: 139776781
csdn_url: https://luciferliu.blog.csdn.net/article/details/139776781
description: '前言 Oracle 一键安装脚本，演示 openEuler 22.03 LTS 一键安装 Oracle 11GR2 单机过程（全程无需人工干预）。 ⭐️ 脚本下载地址：Shell脚本安装Oracle数据库 安装准备 1、安装好操作系统，建议安装图形化 2、配置好网络 3、挂载本地 ISO 镜像源 4'
keywords: 'oracle, 数据库'
cover: '/img/covers/oracle.svg'
---
## 前言

Oracle 一键安装脚本，演示 openEuler 22.03 LTS 一键安装 Oracle 11GR2 单机过程（全程无需人工干预）。
...
-rwxr-xr-x 1 root   root     201K May 31 10:47 OracleShellInstall
-rwx------ 1 oracle oinstall 1.3G May 29 10:44 p13390677_112040_Linux-x86-64_1of7.zip
-rwx------ 1 oracle oinstall 1.1G May 29 10:44 p13390677_112040_Linux-x86-64_2of7.zip
-rwx------ 1 oracle oinstall 315K May 29 10:44 rlwrap-0.44.tar.gz
```
...
!!! 免责声明：当前操作系统版本是 [ openEuler 22.03 LTS ] 不在 Oracle 官方支持列表，本脚本只负责安装，请确认是否继续安装 (Y/N): [Y] 

OracleShellInstall 开始安装，详细安装过程可查看日志： tail -2000f /soft/print_ora_install_20240531104808.log                                                                                  
...
正在安装 Oracle 软件以及补丁......已完成 (耗时: 213 秒)
正在创建监听......已完成 (耗时: 11 秒)
正在创建数据库......已完成 (耗时: 212 秒)
正在优化数据库......已完成 (耗时: 14 秒)

恭喜！Oracle 单机安装成功 (耗时: 509 秒)，现在是否重启主机：[Y/N] Y
...
LSNRCTL for Linux: Version 11.2.0.4.0 - Production on 31-MAY-2024 11:05:33
...
Start Date                31-MAY-2024 11:03:35
...
SQL*Plus: Release 11.2.0.4.0 Production on Fri May 31 11:05:34 2024
...
sys@LUCIFER 2024-05-31 11:05:34> show parameter name

...
tags:
  ...
  - 数据库
abbrlink: 147408828
csdn_url: https://luciferliu.blog.csdn.net/article/details/147408828
description: '大家好，这里是 DBA学习之路，专注于提升数据库运维效率。 目录 前言 介绍 19.27 RU 补丁安装 环境准备 README 升级 OPatch 冲突检查 补丁升级 一键安装补丁 写在最后 前言 前几天 19.27 补丁发布了，一直没时间安装测试，今天正好有空，测试一下。 介绍 Oracle 1'
keywords: 'oracle, 数据库'
cover: '/images/cf76115bc9fbbda5de026250ad41b2e0.webp'
---
...
* [前言](#_4)
* [介绍](#_7)
* [19.27 RU 补丁安装](#1927_RU__22)
* + [环境准备](#_34)
  + [README](#README_121)
  + [升级 OPatch](#_OPatch_134)
  + [冲突检查](#_163)
  + [补丁升级](#_195)
* [一键安装补丁](#_671)
* [写在最后](#_806)
...
![【纯干货】Oracle 19C RU 19.27 发布，如何快速升级和安装？](/images/42a7f71589cabb2cafd4fa21b1968a42.webp)
...
![【纯干货】Oracle 19C RU 19.27 发布，如何快速升级和安装？ - 图2](/images/cf76115bc9fbbda5de026250ad41b2e0.webp)
...
通过 MOS 可以查询到：[Datapatch -sanity\_checks Fails with Error “Queryable Inventory package - ERROR” (Doc ID 3055606.1)](https://support.oracle.com/epmos/faces/DocContentDisplay?id=3055606.1)

![【纯干货】Oracle 19C RU 19.27 发布，如何快速升级和安装？ - 图3](/images/214a1467fa02b295d9a2f4aa4e1bf61d.webp)

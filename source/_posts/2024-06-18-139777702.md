---
title: '统信 UOS V20 1070(e) 一键安装 Oracle 12CR2 单机'
date: 2024-06-18 16:38:40
categories:
  - Oracle 数据库
tags:
  - oracle
  - 数据库
abbrlink: 139777702
csdn_url: https://luciferliu.blog.csdn.net/article/details/139777702
description: '前言 Oracle 一键安装脚本，演示 统信 UOS V20 1070(e) 一键安装 Oracle 12CR2 单机（全程无需人工干预）。 ⭐️ 脚本下载地址：Shell脚本安装Oracle数据库 前置准备 1、安装好操作系统，建议安装图形化 2、配置好网络 3、挂载本地 ISO 镜像源 4、上传'
keywords: 'oracle, 数据库'
cover: '/img/covers/oracle.svg'
---
## 前言

Oracle 一键安装脚本，演示 统信 UOS V20 1070(e) 一键安装 Oracle 12CR2 单机（全程无需人工干预）。
...
-rw-r--r-- 1 root root 3453696911  6月 17 14:18 LINUX.X64_122010_db_home.zip
-rwxr-xr-x 1 root root     220548  6月 17 14:18 OracleShellInstall
```
...
OracleShellInstall 开始安装，详细安装过程可查看日志： tail -2000f /soft/print_shell_install_20240617141930.log                                          
...
正在解压 Oracle 安装包以及补丁......已完成 (耗时: 47 秒)
正在安装 Oracle 软件以及补丁......已完成 (耗时: 367 秒)
正在创建监听......已完成 (耗时: 9 秒)
正在创建数据库......已完成 (耗时: 323 秒)
正在优化数据库......已完成 (耗时: 16 秒)

恭喜！Oracle 一键安装执行完成 (耗时: 868 秒)，现在是否重启主机：[Y/N] Y
...
LSNRCTL for Linux: Version 12.2.0.1.0 - Production on 17-JUN-2024 23:08:12
...
Start Date                17-JUN-2024 14:35:05
Uptime                    0 days 8 hr. 33 min. 7 sec
Trace Level               off
...
SQL*Plus: Release 12.2.0.1.0 Production on Mon Jun 17 23:08:15 2024
...
sys@LUCIFER 2024-06-17 23:08:15> show parameter name

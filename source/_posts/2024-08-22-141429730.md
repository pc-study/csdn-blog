...
date: 2024-08-22 15:36:02
categories:
  - 数据库
tags:
  - 数据库
abbrlink: 141429730
csdn_url: https://luciferliu.blog.csdn.net/article/details/141429730
description: '大家好，这里是 Lucifer三思而后行，专注于提升数据库运维效率。 目录 前言 脚本下载 达梦数据库下载 系统安装 一键安装 安装前准备 安装命令 往期精彩文章推荐 前言 最近在学习 zCloud 平台，其中有纳管达梦数据库的功能，于是打算安装一套达梦 DM8 数据库进行测试。想起之前和朋友（达梦'
keywords: '数据库'
cover: '/images/d94f4725ff71822a1a94d58d07d95c7e.webp'
---
...
![达梦数据库 DM8 一键安装脚本教程（脚本免费）](/images/d94f4725ff71822a1a94d58d07d95c7e.webp)

直接点击克隆下载，选择 `<下载ZIP>` 进行下载即可：

![达梦数据库 DM8 一键安装脚本教程（脚本免费） - 图2](/images/ba538f69f6c4228e510ddffb27632c44.webp)
...
![达梦数据库 DM8 一键安装脚本教程（脚本免费） - 图3](/images/4d3578580a2dcec1de7c50429c088c6c.webp)
...
![达梦数据库 DM8 一键安装脚本教程（脚本免费） - 图4](/images/8c68fe0f7d0041ba26020d6baa90d593.webp)

选择上海时区：

![达梦数据库 DM8 一键安装脚本教程（脚本免费） - 图5](/images/c1a6f7fc08c190cb931196bfa46e4455.webp)

系统分区（达梦数据库对 swap 分区没什么要求，建议禁用，所以这里随便分一点就行）：

![达梦数据库 DM8 一键安装脚本教程（脚本免费） - 图6](/images/b7b8c5b6202a20c7fcbf0c758e32c261.webp)

最小化安装即可：

![达梦数据库 DM8 一键安装脚本教程（脚本免费） - 图7](/images/029ff3fb27ead0c0b728c4f1688b345b.webp)

配置静态网络：

![达梦数据库 DM8 一键安装脚本教程（脚本免费） - 图8](/images/08a519f5e76bee337bb966612e20b2d9.webp)

配置主机名：

![达梦数据库 DM8 一键安装脚本教程（脚本免费） - 图9](/images/47e040a76d23d4d30e64ca2b2033753b.webp)

设置 root 密码：

![达梦数据库 DM8 一键安装脚本教程（脚本免费） - 图10](/images/007c06108f7843d7d6317453203043f5.webp)

系统安装完成后，还需要手动挂载一下操作系统的 ISO 镜像源，用于脚本自动配置软件源：

![达梦数据库 DM8 一键安装脚本教程（脚本免费） - 图11](/images/10cf303a9db7e17b8a9b9595bc0090c1.webp)

...
tags:
  ...
  - 大数据
abbrlink: 139176675
csdn_url: https://luciferliu.blog.csdn.net/article/details/139176675
description: '前言 Oracle 一键安装脚本，演示 麒麟 Kylin V10 SP3 一键安装 Oracle 19C 单机 ASM（全程无需人工干预）。 ⭐️ 脚本下载地址：Shell脚本安装Oracle数据库 前置准备 1、安装好操作系统，建议安装图形化 2、配置好网络 3、挂载本地 ISO 镜像源 4、上传'

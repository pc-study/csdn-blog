...
tags:
  ...
  - 数据库
abbrlink: 143331477
csdn_url: https://luciferliu.blog.csdn.net/article/details/143331477
description: '大家好，这里是 Lucifer三思而后行，专注于提升数据库运维效率。 目录 前言 介绍 实战体验 采集程序下载 数据库巡检 巡检文件上传 巡检报告生成 写在最后 往期精彩文章 前言 上两周，偶然看到小墨发布的 墨天轮智能巡检v2.3发布，适配Oracle PDB并支持12c-23ai，想起之前也使用'
keywords: 'oracle, 数据库'
...
![](https://img-blog.csdnimg.cn/img_convert/52c4df1867c92b7e62a734aa33078ea6.png)

最近墨天轮智能巡检发布了新版本，**新增特性如下**：

* 采集程序新增采集 CDB、PDB 信息，并对 PDB 状态等进行巡检
* 全局新增 con\_id 字段，调整数据从 `CDB_` 视图采集、并适配 10g、11g 老版本
...
* 表空间使用率渗透到 PDB，并优化计算逻辑、不再采集 DBA\_FREE\_SPACE
...
* 修复 MogDB SELECT RATIO\_TO\_REPORT 报错 compressed data is corrupt 的问题
* 修复 OS 内核参数有空格无法匹配建议以及数据带逗号无法 TO\_NUMBER 的问题
...
![](https://img-blog.csdnimg.cn/img_convert/1da3d529aa496e5949768ef996b3234e.png)

支持 Oracle、PostgreSQL 和 MySQL 三种类型的数据库：

![](https://img-blog.csdnimg.cn/img_convert/6c7d0a3ca25118626c3a35c3e817abf9.png)
...
采集完成后，生成一个巡检文件：LUCIFER\_20241023115339.zip：
...
![](https://img-blog.csdnimg.cn/img_convert/0cc574501db59507aa14790a5bd27c8c.png)

点击上传文件，上传巡检文件：

![](https://img-blog.csdnimg.cn/img_convert/caebd8c5df1f8cbbf0af747ba1a285d4.png)
...
![](https://img-blog.csdnimg.cn/img_convert/611de749e32630d77668dcade43d1bdd.png)

点击查看报告就可以预览：

![](https://img-blog.csdnimg.cn/img_convert/6e16c1ea565b09d4c65ae56163a4cce4.png)

![](https://img-blog.csdnimg.cn/img_convert/50824e060ecee3c805cef70d8277a373.png)

会给出一些数据库建议：

![](https://img-blog.csdnimg.cn/img_convert/c4fef8eacd024fda0516db49e07bb028.png)

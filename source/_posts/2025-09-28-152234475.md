---
title: '【金仓数据库产品体验官】KingbaseES V9R1C10 版本安装指南'
date: 2025-09-28 23:39:31
categories:
  - 数据库
tags:
  - 数据库
  ...
  - 金仓产品体验官
abbrlink: 152234475
csdn_url: https://luciferliu.blog.csdn.net/article/details/152234475
description: '大家好，这里是公众号 DBA学习之路，分享一些学习国产数据库路上的知识和经验。 目录 前言 环境准备 安装包下载 安装前配置 检查操作系统版本 关闭防火墙 创建用户 创建目录 系统参数配置 资源配置 配置 RemoveIPC 配置环境变量 KES 安装 安装 ISO 挂载 配置语言环境 命令行安装'
keywords: '数据库, 金仓, kingbasse, oracle, 数据库平替用金仓, 金仓产品体验官'
...
![【金仓数据库产品体验官】KingbaseES V9R1C10 版本安装指南](/images/be77d8837fa990dc889354269756b708.webp)
...
| 参数名 | 默认值 | 说明 |
| --- | --- | --- |
| INSTALL\_PATH | /opt/Kingbase/ES/V9 | 安装目录绝对路径，必须指定，否则报错退出安装过程。路径分隔符使用/'。 |
| LICENSE\_PATH |  | 授权文件的绝对路径，如果指定该参数，就会选择用户指定的license文件；如果未指定，则会使用软件自带试用版授权，请在有效期内及时更换正式授权文件。 |
| COMPONENTS | Server,Interface, KingbaseHA, KStudio,KDTS, DeployTool | 1) SERVER，服务器 2) INTERFACE，接口 3) KINGBASEHA，高可用组件 4) KSTUDIO，数据库开发管理工具 5) KDTS，数据库迁移工具 6) DEPLOY，数据库部署工具 多值用逗号分隔。大小写不敏感。如果是错误的组件名称则忽略。 |
| CREATE\_SHORTCUT | yes | 是否创建创建方式，yes:创建；no:不创建 |
| SHORTCUT\_USER | 1 | 用户范围，1:当前用户；2:所有用户 |
| SHORTCUT\_GROUP\_NAME | KingbaseES V009R001 | 快捷方式组名，默认:KingbaseESV009R001 |
...
![【金仓数据库产品体验官】KingbaseES V9R1C10 版本安装指南 - 图2](/images/458c19c26df2a1549b928c02a8c8961b.webp)

高级配置：

![【金仓数据库产品体验官】KingbaseES V9R1C10 版本安装指南 - 图3](/images/69399c22a4e5a851a1bf1bdaa247060d.webp)

![【金仓数据库产品体验官】KingbaseES V9R1C10 版本安装指南 - 图4](/images/d21fa7e9e26e9d37c23a5ca4948efbf3.webp)

![【金仓数据库产品体验官】KingbaseES V9R1C10 版本安装指南 - 图5](/images/e5aa40233e2983602bd15d2f5290ae06.webp)

![【金仓数据库产品体验官】KingbaseES V9R1C10 版本安装指南 - 图6](/images/60b8690857b4eb1c7f48caad4d206c80.webp)

![【金仓数据库产品体验官】KingbaseES V9R1C10 版本安装指南 - 图7](/images/1fdd4806002195c42af5f4bf05bdf726.webp)

![【金仓数据库产品体验官】KingbaseES V9R1C10 版本安装指南 - 图8](/images/22cb18e4b99a648a72675ff54f7404ec.webp)

![【金仓数据库产品体验官】KingbaseES V9R1C10 版本安装指南 - 图9](/images/a1fa4e349872aae105f8f3d4186bd596.webp)

![【金仓数据库产品体验官】KingbaseES V9R1C10 版本安装指南 - 图10](/images/a9db7efe5192b55415da5d61cb74cd14.webp)

![【金仓数据库产品体验官】KingbaseES V9R1C10 版本安装指南 - 图11](/images/0cf42898c7b7c72739bacae84e3afa24.webp)

![【金仓数据库产品体验官】KingbaseES V9R1C10 版本安装指南 - 图12](/images/d4437c75a7c18e05ff10e4c50b35e86e.webp)

![【金仓数据库产品体验官】KingbaseES V9R1C10 版本安装指南 - 图13](/images/7922f366a2d57377124f9a5748b978cc.webp)

![【金仓数据库产品体验官】KingbaseES V9R1C10 版本安装指南 - 图14](/images/33052a50faac79001f298a2c52f1256c.webp)

![【金仓数据库产品体验官】KingbaseES V9R1C10 版本安装指南 - 图15](/images/abe37aa61af485f47b6a966134f9bce5.webp)

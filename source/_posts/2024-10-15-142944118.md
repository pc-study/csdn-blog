...
date: 2024-10-15 12:13:24
categories:
  - 数据库
tags:
  - gbase
abbrlink: 142944118
csdn_url: https://luciferliu.blog.csdn.net/article/details/142944118
description: '大家好，这里是公众号 DBA学习之路，分享一些学习国产数据库路上的知识和经验。 目录 前言 介绍 安装包下载 安装前准备 关闭防火墙 关闭 SELINUX 配置 hosts 文件 创建组和用户 创建安装目录及授权 检查依赖项 上传安装包 GBase 8s 安装 典型安装 - 安装 GBase 8s'
keywords: 'gbase'
...
* [安装前准备](#_61)
* + [关闭防火墙](#_73)
  + [关闭 SELINUX](#_SELINUX_82)
  + [配置 hosts 文件](#_hosts__92)
  + [创建组和用户](#_105)
  + [创建安装目录及授权](#_120)
  + [检查依赖项](#_126)
  + [上传安装包](#_145)
* [GBase 8s 安装](#GBase_8s__164)
* + [典型安装](#_171)
  + - [安装 GBase 8s 软件](#_GBase_8s__172)
    - * [图形化安装](#_173)
      * [命令行安装](#_216)
  + [静默安装](#_423)
  + - [生成响应文件](#_424)
    - [静默安装 GBase 8s 软件](#_GBase_8s__458)
  + [创建数据库实例](#_465)
  + - [GBaseInit\_gbasedbt.sh 创建](#GBaseInit_gbasedbtsh__473)
    - [手工创建实例](#_638)
  + [脚本一键安装](#_815)
* [GBase 8s 使用](#GBase_8s__1048)
* + [查看数据库状态](#_1049)
  + [关闭数据库](#_1055)
  + [开启数据库](#_1060)
  + [连接数据库](#_1104)
  + [查看数据库 IP、端口](#_IP_1123)
  + [数据库常用脚本：](#_1140)
* [GBase 8s 卸载](#GBase_8s__1242)
* + [图形化卸载](#_1249)
  + [命令行卸载](#_1271)
  + [清除残余目录](#_1378)
* [写在最后](#_1385)
...
> **Gbase 8s V8.8 x86 的数据库安装介质下载地址：**[GBase8sV8.8\_TL\_3.5.1\_3x\_x86\_64.zip](https://www.gbase.cn/download/gbase-8s-1?category=INSTALL_PACKAGE)

![](https://img-blog.csdnimg.cn/img_convert/73bdde06bd553d24e215e1f2528f8520.png)
...
这里暂时只关注安装前的配置条件，关于 AutoInit\_GBase8s.sh 脚本在下面安装的一键安装的章节再讲，这里暂且不表。
...
![](https://img-blog.csdnimg.cn/img_convert/a9462ec8f4b798715ca7a798393c67b6.png)

注意，这里需要把许可协议拉到底才可以选择接受：

![](https://img-blog.csdnimg.cn/img_convert/2e150545f7d845c10ba4e3a253efda7f.png)

选择安装目录：

![](https://img-blog.csdnimg.cn/img_convert/8792eeb76d2bea9089baf87adf84d24b.png)

选择典型安装（安装所有组件），这里如果选择自定义安装，就是可以选择安装哪些组件：

![](https://img-blog.csdnimg.cn/img_convert/2296ea8ff4ca0fd29d8db3eb1ff41492.png)

不创建数据库实例：

![](https://img-blog.csdnimg.cn/img_convert/0250baff14b3d71ae0d78c9e5f665e38.png)

开始安装：

![](https://img-blog.csdnimg.cn/img_convert/14e2fbd406a77c19e275232dc1c22bd7.png)

![](https://img-blog.csdnimg.cn/img_convert/92cc385bd6d167f0905c6109233af86f.png)

![](https://img-blog.csdnimg.cn/img_convert/d5073e3afcd5f5b046a546fb9b84c67a.png)
...
选择数据库字符集（默认为 en\_US.8859-1），这里选择 utf8：
...
切换到 gbasedbt 用户，将默认环境变量 .bash\_profile 文件复制一份，命名为 profile.gbaseserver：
...
为了 gbasedbt 用户在登录后自动应用这些环境变量，可以在 .bash\_profile 文件中添加：
...
官方提供了 GBase 8s 的一键安装脚本，也就是的安装包中的 AutoInit\_GBase8s.sh 脚本，这个我们在安装包下载有说过一个 readme 文件中有看到过：
...
没错，这就是官方提供的一键安装脚本，GBase 8s 一键安装只需要上传 AutoInit\_GBase8s.sh 和 GBase8sV8.8\_TL\_3.5.1\_x86\_64.tar 到主机上即可。
...
![](https://img-blog.csdnimg.cn/img_convert/300090bb1206ab6df7ba741f5e50a01d.png)

选择移除 GBase 8s 数据库组件和全部的数据库：

![](https://img-blog.csdnimg.cn/img_convert/a891e8a20b0de5e5bea6611823a26792.png)

等待卸载完成：

![](https://img-blog.csdnimg.cn/img_convert/b15539403d98cae07f5b6743bc5ad2df.png)

![](https://img-blog.csdnimg.cn/img_convert/0fc78373d0ed78a6b5aa52489f29ba18.png)

![](https://img-blog.csdnimg.cn/img_convert/5b6c3187896b76aeed06349ce24a6826.png)

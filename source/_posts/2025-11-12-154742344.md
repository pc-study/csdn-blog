...
date: 2025-11-12 16:09:40
categories:
  - 数据库
tags:
  - tidb
abbrlink: 154742344
csdn_url: https://luciferliu.blog.csdn.net/article/details/154742344
description: '前言 前面测试了 BR 备份 TiDB 到 AWS S3 和阿里云 OSS 存储，但是因为是走公网，所以备份速度感人，太慢了！最终还是放弃了，打算在本地搭建一套 minIO 存储来存储 TiDB 备份文件。 本文记录一下 minIO 存储搭建过程以及 BR 备份脚本。 搭建 minIO 存储 环境信'
keywords: 'tidb'
cover: '/images/1bb1046c31a7b7f0bb1dbaba699b8d52.webp'
---
## 前言
...
![使用 BR 备份 TiDB 到本地 minIO 存储](/images/1bb1046c31a7b7f0bb1dbaba699b8d52.webp)

输入上面定义的用户和密码，登陆成功：

![使用 BR 备份 TiDB 到本地 minIO 存储 - 图2](/images/68a5155fd65aefd7413da9b417dd89eb.webp)
...
![使用 BR 备份 TiDB 到本地 minIO 存储 - 图3](/images/659d915d68e835b945ec9bc71f874095.webp)

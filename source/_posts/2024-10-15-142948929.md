...
date: 2024-10-15 13:17:02
categories:
  - 数据库
tags:
  - kingbase
abbrlink: 142948929
csdn_url: https://luciferliu.blog.csdn.net/article/details/142948929
description: '大家好，这里是公众号 DBA学习之路，分享一些学习国产数据库路上的知识和经验。 目录 前言 介绍 KSQL 连接数据库 常规连接方式 免密连接方式 alias 方式 环境变量方式 kbpass 文件方式 最佳免密方式 alias + kbpass 环境变量 + kbpass 总结 后记 前言 经常使'
keywords: 'kingbase'
...
* + [alias 方式](#alias__112)
  + [环境变量方式](#_131)
  + [kbpass 文件方式](#kbpass__152)
* [最佳免密方式](#_181)
* + [alias + kbpass](#alias__kbpass_182)
  + [环境变量 + kbpass](#__kbpass_226)
* [总结](#_282)
* [后记](#_285)
...
在查阅官方文档之后发现，可以通过环境变量的方式，将 KINGBASE\_DATABASE、 KINGBASE\_HOST、KINGBASE\_PORT、KINGBASE\_USER 以及 KINGBASE\_PASSWORD 设置为适当的值来实现免密登录：
...
所以，看起来最佳免密方式为：sys\_hba.conf + alias

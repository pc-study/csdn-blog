...
cover: '/images/593371bf87e9caae483a3006ac29f683.png'
---
{% raw %}
#### 目录
...
![在这里插入图片描述](/images/593371bf87e9caae483a3006ac29f683.png)
...
![在这里插入图片描述](/images/79d3bbfbb840f96a3b8c1256ef8b0a99.png)  
 **安装完后，方便使用，启用命令行自动补全：**
...
![在这里插入图片描述](/images/0fa3c33b8b38e0b07e8cadbb2b847a4b.png)  
...
![在这里插入图片描述](/images/5c9234c639663626aef716c57bd26fa4.png)  
 查看当前 Vagrant 版本。
...
![在这里插入图片描述](/images/d3fb9155af1c33a146ad831230569477.png)  
 通过该命令可以查看当前系统已安装的虚拟机系统详细信息，非常方便。

### 2️⃣ Vagrant Box 管理

本节主要介绍 Vagrant Box 的基本管理命令：  
 ![在这里插入图片描述](/images/e94ba6ef9de841498f79ed7f3b5f5ea5.png)  
 **查看所有已添加 box**
...
![在这里插入图片描述](/images/0388d85303f7546d5456eb875fa42126.png)  
...
![在这里插入图片描述](/images/6ecbcdcccb5413caebdc6b8e3ef7c033.png)  
...
![在这里插入图片描述](/images/67ff41c228d2a4be07636235dd22c679.png)  
...
![在这里插入图片描述](/images/e233958d00cffdec7a19be35ab303947.png)  
...
![在这里插入图片描述](/images/276d2c786b7b9e8c3eae19340506d48b.png)  
 显而易见，查看当前虚拟机系统的运行状态。
...
![在这里插入图片描述](/images/d4cb4c9c25c1d489ca1dc387aed06bac.png)  
...
![在这里插入图片描述](/images/c76632344393f1a74f74f828da3b4d2a.png)  
 **卸载插件**
...
![在这里插入图片描述](/images/df24dd4efa23d11bc822ee743136c47f.png)  
...
![在这里插入图片描述](/images/70e5ba23fac3c5e49fdec56635534fd3.png)  
...
这边输入密码后，已经连接进虚拟机环境了，我这是一套 Oracle RAC 环境的其中一个节点：  
 ![在这里插入图片描述](/images/03680cf4c46cf608844657f4f1dd8bd4.png)  
...
![在这里插入图片描述](/images/a4661479ed48797c47fd029bdac321e2.png)  
...
![在这里插入图片描述](/images/d5474dd7403c4212fc25e1e50b349b4f.png)  
 **第四步：** 打开刚 
git
...
修改内容如上，读者可根据实际环境填写。  
 ![在这里插入图片描述](/images/dd53f771ef9a276c83a2c470f54a4af6.png)  
 **需要注意：读者主要修改的部分为：**  
 **1、iso的存放位置：**  
...
言归正传，经过一段时间的等待后，我们的 `packer` 也跑完了：  
 ![在这里插入图片描述](/images/bc850bd407185d0fe64145d3406c6118.png)  
 ...
 **再一次，事不过三啊，给爷冲！！！**  
 **🎉 皇天不负有心人，成了 Nice！👌🏻**  
 ![在这里插入图片描述](/images/28803273bdbe086766504dea80763d99.png)  
...
![在这里插入图片描述](/images/2eae846ea47bd434d7f559d318008151.png)  
 连接使用：
...
![在这里插入图片描述](/images/0b635c494d499cf28dcdb442087a345b.png)  

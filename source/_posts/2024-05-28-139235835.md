...
tags:
  ...
  - iotdb
abbrlink: 139235835
csdn_url: https://luciferliu.blog.csdn.net/article/details/139235835
description: '文章目录 前言 部署选型 选择模式 配置介绍 安装包下载 安装部署 MacOS 安装 - 检查 JAVA 环境 解压安装 启动 IoTDB 数据库 连接 IoTDB 数据库 关闭 IoTDB 数据库 配置快捷命令 Windows 安装 - 检查 JAVA 环境 解压安装 启动 IoTDB 数据库 连'
keywords: '时序数据库, apache, iotdb'
cover: '/images/01ffa65ecddf5e346d7cfc5dd75af406.webp'
---
#### 文章目录
...
* [安装部署](#_72)
* + [MacOS 安装](#MacOS__85)
  + - [检查 JAVA 环境](#_JAVA__86)
    - [解压安装](#_116)
    - [启动 IoTDB 数据库](#_IoTDB__147)
    - [连接 IoTDB 数据库](#_IoTDB__170)
    - [关闭 IoTDB 数据库](#_IoTDB__249)
    - [配置快捷命令](#_259)
  + [Windows 安装](#Windows__307)
  + - [检查 JAVA 环境](#_JAVA__310)
    - [解压安装](#_324)
    - [启动 IoTDB 数据库](#_IoTDB__331)
    - [连接 IoTDB 数据库](#_IoTDB__340)
    - [关闭 IoTDB 数据库](#_IoTDB__346)
    - [配置快捷命令](#_354)
  + [Linux 安装](#Linux__374)
  + - [检查 JAVA 环境](#_JAVA__383)
    - [解压安装](#_420)
    - [启动 IoTDB 数据库](#_IoTDB__440)
    - [连接 IoTDB 数据库](#_IoTDB__447)
    - [关闭 IoTDB 数据库](#_IoTDB__470)
    - [配置快捷命令](#_478)
  + [Docker 安装](#Docker__514)
  + - [获取镜像](#_517)
    - [创建 docker bridge 网络](#_docker_bridge__538)
    - [创建 docker 容器](#_docker__552)
    - [关闭 IoTDB 数据库](#_IoTDB__575)
    - [启动 IoTDB 数据库](#_IoTDB__584)
    - [连接 IoTDB 数据库](#_IoTDB__599)
...
| DataNode 个数 | 1 | ≥1 | ≥3 | ≥3 |
| 元数据副本 schema\_replication\_factor | 1 | 1 | 3 | 3 |
| 数据副本 data\_replication\_factor | 1 | 1 | 2 | 3 |
| ConfigNode 协议 config\_node\_consensus\_protocol\_class | Simple | Ratis | Ratis | Ratis |
| SchemaRegion 协议 schema\_region\_consensus\_protocol\_class | Simple | Ratis | Ratis | Ratis |
| DataRegion 协议 data\_region\_consensus\_protocol\_class | Simple | IoT | IoT | Ratis |
...
![一文教你学会时序数据库 Apache IoTDB 安装部署，直接上手！！！](/images/9d7329875295daf29e21b3e1d71d68ea.webp)
...
![一文教你学会时序数据库 Apache IoTDB 安装部署，直接上手！！！ - 图2](/images/53da7488160045888bcdb95ff1dd4c5c.webp)

![一文教你学会时序数据库 Apache IoTDB 安装部署，直接上手！！！ - 图3](/images/f295f8c14831d75d4a0c6664ef1ddcc5.webp)

#### 启动 IoTDB 数据库

进入 sbin 目录双击 `start-standalone.bat` 打开 IoTDB 数据库：

![一文教你学会时序数据库 Apache IoTDB 安装部署，直接上手！！！ - 图4](/images/f538e8f7327d8d74451753465ae00366.webp)

会打开两个窗口，当提示 `Congratulation, IoTDB DataNode is set up successfully. Now, enjoy yourself!` 即打开 IoTDB 成功：

![一文教你学会时序数据库 Apache IoTDB 安装部署，直接上手！！！ - 图5](/images/01ffa65ecddf5e346d7cfc5dd75af406.webp)

#### 连接 IoTDB 数据库

![一文教你学会时序数据库 Apache IoTDB 安装部署，直接上手！！！ - 图6](/images/be9fe15968edb433416740c6f72612ca.webp)

![一文教你学会时序数据库 Apache IoTDB 安装部署，直接上手！！！ - 图7](/images/e99ad0a62eecc936a0245ffad042da28.webp)

#### 关闭 IoTDB 数据库

![一文教你学会时序数据库 Apache IoTDB 安装部署，直接上手！！！ - 图8](/images/6f2043c733b694c09172037abc55a812.webp)

执行关闭后，两个窗口提示按任意键退出，回车退出即可：

![一文教你学会时序数据库 Apache IoTDB 安装部署，直接上手！！！ - 图9](/images/d3c91632864bad3d15540f5a855f2076.webp)

#### 配置快捷命令

Windows 没有 alias 命令，所以使用环境变量的方式来简化：

![一文教你学会时序数据库 Apache IoTDB 安装部署，直接上手！！！ - 图10](/images/0772623ed77aa7228d6ceabebd052d6d.webp)

...
![](/csdn-blog/images/9d7329875295daf29e21b3e1d71d68ea.png)
...
![](/csdn-blog/images/53da7488160045888bcdb95ff1dd4c5c.png)

![](/csdn-blog/images/f295f8c14831d75d4a0c6664ef1ddcc5.png)

#### 启动 IoTDB 数据库

进入 sbin 目录双击 `start-standalone.bat` 打开 IoTDB 数据库：

![](/csdn-blog/images/f538e8f7327d8d74451753465ae00366.png)

会打开两个窗口，当提示 `Congratulation, IoTDB DataNode is set up successfully. Now, enjoy yourself!` 即打开 IoTDB 成功：

![](/csdn-blog/images/01ffa65ecddf5e346d7cfc5dd75af406.png)

#### 连接 IoTDB 数据库

![](/csdn-blog/images/be9fe15968edb433416740c6f72612ca.png)

![](/csdn-blog/images/e99ad0a62eecc936a0245ffad042da28.png)

#### 关闭 IoTDB 数据库

![](/csdn-blog/images/6f2043c733b694c09172037abc55a812.png)

执行关闭后，两个窗口提示按任意键退出，回车退出即可：

![](/csdn-blog/images/d3c91632864bad3d15540f5a855f2076.png)

#### 配置快捷命令

Windows 没有 alias 命令，所以使用环境变量的方式来简化：

![](/csdn-blog/images/0772623ed77aa7228d6ceabebd052d6d.png)

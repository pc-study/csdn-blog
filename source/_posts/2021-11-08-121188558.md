...
![](/csdn-blog/images/46046eb887e3f953cf417768712ace57.png)

由于是 19C RAC，因此配置物理内存为 8G：

![](/csdn-blog/images/eec0917f5ad6e3969bd6986fb2bab6e7.png)

至少需要2张网卡，因此添加一个网卡作为心跳：

挂载官网下载好的镜像源：

![](/csdn-blog/images/e3826b2cbdfbe729356696b270ca92ab.png)

继续：

![](/csdn-blog/images/20d2379ad2109d4c4a71e2112bd1196b.png)

上面的步骤，其他的虚拟机或许不一样，下面的正式开始安装流程都是一致的：

![](/csdn-blog/images/06f2eb7572694839db6e1b2d46487d60.png)

选择语言环境和版本：

跳过注册：

![](/csdn-blog/images/7d65a5115af5ba7465b6d10c7d97fe6f.png)
...
![](/csdn-blog/images/08842da8f82bf26dff3627af7b75d0b1.png)

eth1：

![](/csdn-blog/images/4247adbd8ebbf2bde09cb2519c2b0923.png)

![](/csdn-blog/images/1556c3a40ae897ae94e8efa0e4976611.png)

已配置好两张网卡：

配置主机名：

![](/csdn-blog/images/f267bc4de888d6a5436309be662a0355.png)

继续安装：

![](/csdn-blog/images/dfdb0aeb8ce877c64c95fdaa7ef4dffb.png)

![](/csdn-blog/images/5919ca97c330ae2d57134ca4b707970b.png)

![](/csdn-blog/images/e59d1ad060e000f2680fea2991201ac5.png)

![](/csdn-blog/images/a7376433ff7a747a18c2f6b4f02b0508.png)

手工配置系统分区：

![](/csdn-blog/images/cfc4f0e522e48aaa949ab107996c37aa.png)

首先创建一个 /boot 分区：

![](/csdn-blog/images/79355aa8b95ec7c4451792aa5415ffa2.png)

![](/csdn-blog/images/005aa49052498f3e9315dd31d05ce13a.png)

将剩余磁盘空间创建为 LVM，用于系统安装：

![](/csdn-blog/images/821263b30e81f84a3f5a4e608b528870.png)

创建 rootvg 分区：

![](/csdn-blog/images/6e4b95ed39243e7ee188aad690bd0e94.png)

![](/csdn-blog/images/fa2bed83a2f5959aac6988fb0e4a51da.png)

![](/csdn-blog/images/975734877b4476706741ec51d807b76b.png)

创建 swaplv 分区：

![](/csdn-blog/images/ec4a3f6c32c0245356961e636405a961.png)

![](/csdn-blog/images/f25e078922fc38d4469b6e644c5ebfd2.png)

![](/csdn-blog/images/e2c9db1e0c99a0a94dbfc682f31a3279.png)

![](/csdn-blog/images/8b9e67ada22c27f22e6279e4c634a900.png)

![](/csdn-blog/images/c1d260770edb3efeda5ba6ded4a529aa.png)

创建根分区 rootlv：

![](/csdn-blog/images/19a1369781f67bf1c34bd466a05f3b5a.png)

![](/csdn-blog/images/62782e19d9c0e85290c3cab2b5746a04.png)

![](/csdn-blog/images/bde2e6bf4b2d8ef88a9f7aa0a492d317.png)

选择时区：

不创建用户：

![](/csdn-blog/images/4261f17125d2481aede5c28e3c8d6fc3.png)

输入 root 密码：

![](/csdn-blog/images/d455514c1346ed29f6ae3a05ae543c51.png)

关闭防火墙和kdump：

![](/csdn-blog/images/629e54e4cac4eccf2bfffce61ca50340.png)

![](/csdn-blog/images/09ce387cf1917ebbb565f8acf7d01a42.png)

开始安装：

![](/csdn-blog/images/f10bbf35c98b675609f4b5400a609ca2.png)

安装完成：

![](/csdn-blog/images/035829b0840e95cfa65e0889e1d97498.png)
...
![](/csdn-blog/images/cf795aeabc1f4f90841cb556d2266061.png)
...
![](/csdn-blog/images/e67035038c5ea2e9f67b0e41b36da5df.png)
...
![](/csdn-blog/images/2060684f96c9a416ec8ab24f33101e88.png)
...
![](/csdn-blog/images/0d9f46fb8b4b355e4ae3cb0232d5c307.png)
...
![](/csdn-blog/images/3fa3e85dce537bdc0965a26a4d60d215.png)
...
![](/csdn-blog/images/a21495c6b10b5a89249b793850617757.png)
...
![](/csdn-blog/images/e3cf393ea7ac7b8a2f1164b733b1a70d.png)
...
![](/csdn-blog/images/92f60181e49dfa7eab43292b4062b93f.png)
...
![](/csdn-blog/images/572f274d08ffda2313e45b1a16cbecca.png)
...
![](/csdn-blog/images/8003423ea62292a7008187892c30187f.png)
...
![](/csdn-blog/images/31da46ad5d862f0a07351b54b26afa59.png)
...
![](/csdn-blog/images/7793cdc656d28eb9a760e295976ce362.png)
...
![](/csdn-blog/images/ec6c265fa8a4e5ed63b066a36b0b8d3a.png)

在 vnc 客户端界面输入 10.211.55.100:2，输入刚才输入的密码即可连接：

打开终端命令行：

![](/csdn-blog/images/f813256192c98002294adc7a0802b01d.png)
...
![](/csdn-blog/images/33722775f4feaebee1f927fe873a5d46.png)

添加节点二信息，进行互信：

输入 grid 用户密码，创建用户时两节点必须保持一致。先执行 setup，再执行 test，开始互信：

![](/csdn-blog/images/a3f1f2a7807a0f7fa032ff4f6b039a37.png)
...
![](/csdn-blog/images/3ffda045b0c04fd1901725d17c302762.png)

GIMR，这里不选择安装：

安装时填创建 OCR 盘，一块盘冗余 External，目录选择 udev 绑的路径：

![](/csdn-blog/images/70bc881c9e9a2aa5520a2f9f6fe11116.png)
...
![](/csdn-blog/images/1418fcf012beb21812300801ae943dd6.png)

默认即可：

![](/csdn-blog/images/13aafb1ae61ea3e868294e69846fc93e.png)

![](/csdn-blog/images/c3d7e6691dfb0052b562ac0417a03d25.png)
...
![](/csdn-blog/images/a0602ea337234cad25adf511a19b6a6d.png)

开始安装 grid：

![](/csdn-blog/images/34b1cd8d47df8593139ec492ef408599.png)
...
![](/csdn-blog/images/88f5068829a59a1b3d83275d524b5e06.png)
...
![](/csdn-blog/images/b74f511af2c03f93d137484287bf6f03.png)
...
![](/csdn-blog/images/6e1570fc132528e0fcbcb048d8ca130d.png)

选择集群模式：

![](/csdn-blog/images/0def4b4deaed794d63c787e6809cd72c.png)
...
![](/csdn-blog/images/e6282c8871daa053da0b0deb8e1dbfaf.png)
...
![](/csdn-blog/images/c8164e277df1ab1767cb9c7bb43bc96b.png)
...
![](/csdn-blog/images/71df14ecf7fd9c21225e6e0ac8b4ccf2.png)

选择创建数据库实例：

![](/csdn-blog/images/7a80a30612c32baeb91338dbcef98d81.png)
...
![](/csdn-blog/images/9c53dc74409d618b6ce31feeed6c0959.png)

![](/csdn-blog/images/cb2dbf0d961c3210c12a1bff199417da.png)

配置内存，使用 ASMM 模式，数据库总内存占用物理内存 70%-90% 之间：

使用基础模式安装，block\_size 是无法修改的，process 进程数修改为1500，根据实际情况修改：

![](/csdn-blog/images/950cbdc78e616aeee7e1f4d6712b34ba.png)
...
![](/csdn-blog/images/175dd66012877476b50d5df758592b91.png)

安装预检查，DNS 相关忽略：

![](/csdn-blog/images/9bf155fe3e2b13e4e649f7be29d31b60.png)

开始安装：

![](/csdn-blog/images/177a912f37285e5b79ea30aa4e56e1d6.png)

经过漫长的等待，数据库建完了：

![](/csdn-blog/images/47f65741e903e0959385eae3f5ef1458.png)

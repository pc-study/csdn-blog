---
title: '华为欧拉 openEuler 22.03 LTS 一键安装 Oracle 12CR2 单机'
date: 2024-06-18 16:14:05
categories:
  - Oracle 数据库
tags:
  - oracle
  - 数据库
abbrlink: 139776741
csdn_url: https://luciferliu.blog.csdn.net/article/details/139776741
description: '前言 Oracle 一键安装脚本，演示 openEuler 22.03 LTS 一键安装 Oracle 12CR2 单机过程（全程无需人工干预）。 ⭐️ 脚本下载地址：Shell脚本安装Oracle数据库 安装准备 1、安装好操作系统，建议安装图形化 2、配置好网络 3、挂载本地 ISO 镜像源 4'
keywords: 'oracle, 数据库'
cover: '/img/covers/oracle.svg'
---
## 前言

Oracle 一键安装脚本，演示 openEuler 22.03 LTS 一键安装 Oracle 12CR2 单机过程（全程无需人工干预）。
...
-rwx------ 1 root root 3.3G May 31 17:03 LINUX.X64_122010_db_home.zip
-rwxr-xr-x 1 root root 202K May 31 17:02 OracleShellInstall
-rwx------ 1 root root 315K May 31 17:02 rlwrap-0.44.tar.gz
```
...
OracleShellInstall 开始安装，详细安装过程可查看日志： tail -2000f /soft/print_shell_install_20240531170444.log                                                                                  

正在去除密码复杂度配置......已完成 (耗时: 1 秒)
正在配置 YUM 源......已完成 (耗时: 1 秒)
正在清理 Oracle 旧环境......已完成 (耗时: 5 秒)
...
正在安装 Oracle 软件以及补丁......已完成 (耗时: 273 秒)
正在创建监听......已完成 (耗时: 8 秒)
正在创建数据库......已完成 (耗时: 322 秒)
正在优化数据库......已完成 (耗时: 9 秒)

恭喜！Oracle 单机安装成功 (耗时: 671 秒)，现在是否重启主机：[Y/N] Y
...
LSNRCTL for Linux: Version 12.2.0.1.0 - Production on 31-MAY-2024 17:20:18
...
Start Date                31-MAY-2024 17:17:05
...
SQL*Plus: Release 12.2.0.1.0 Production on Fri May 31 17:20:19 2024
...
sys@LUCIFER 2024-05-31 17:20:19> show parameter name

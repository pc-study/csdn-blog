...
keywords: 'oracle, 数据库'
cover: '/images/3e0eaa46e3f81a3bf5a28bfbbb804ebe.png'
---
...
![表空间使用率接近100%](/images/3e0eaa46e3f81a3bf5a28bfbbb804ebe.png)

### 部署并执行自动扩展脚本

1、**上传脚本**：将 `tbs_autoext.sh` 脚本上传到服务器指定目录（例如 `/home/oracle/tbs_check/`）

![脚本上传示意](/images/a7044d4fcafa50b96b9ad6cd7a9d02d7.png)
...
![脚本执行输出示意](/images/7c5d313ab291cd3af0f959a0ca256176.png)

3、**查看执行日志**：脚本运行完成后，可通过日志文件查看详细的操作记录

![日志文件内容示意](/images/2e5dbbf4c39e6b28c505525b27f67255.png)

...
tags:
  ...
  - 数据库
abbrlink: 122318652
csdn_url: https://luciferliu.blog.csdn.net/article/details/122318652
description: 'In this Document APPLIES TO: PURPOSE TROUBLESHOOTING STEPS REFERENCES APPLIES TO: Oracle Net Services - Version 11.1.0.7 and later Oracle Database - E'
keywords: 'oracle, dba, 数据库'
...
* + [APPLIES TO:](#APPLIES_TO_2)
  + [PURPOSE](#PURPOSE_8)
  + [TROUBLESHOOTING STEPS](#TROUBLESHOOTING_STEPS_120)
  + [REFERENCES](#REFERENCES_216)
...
The TRACE\_FILELEN parameter is for the size of a trace file.  
 The TRACE\_FILENO parameter is the number of traces per process.

...
tags:
  ...
  - vagrant
abbrlink: 119878261
csdn_url: https://luciferliu.blog.csdn.net/article/details/119878261
...
cover: '/images/f0b76787497ac9c46eaf5e8b261b97e8.webp'
---
## 前言
...
![《零基础安装 Oracle 数据库》RAC集群系列 ❷ 简单两步快速安装 Oracle 12CR2 RAC 数据库](/images/6498280d0b8037bd8fce04581e1ee035.webp)
...
下载好之后，将 Oracle 安装包拷贝到项目中的 `rac_db/software/12201` 目录下，由于 12CR2 在 Linux7 上安装有 
BUG 
，建议上传最新 PSU 补丁！

![《零基础安装 Oracle 数据库》RAC集群系列 ❷ 简单两步快速安装 Oracle 12CR2 RAC 数据库 - 图2](/images/f0b76787497ac9c46eaf5e8b261b97e8.webp)

**📢 注意：** 项目 `rac_db/software/12201` 目录中有一个 `software.txt` 文件，内容为你需要上传的 Oracle 安装包。请确保安装包名称与以下名称相同，否则安装 **失败**！
...
![《零基础安装 Oracle 数据库》RAC集群系列 ❷ 简单两步快速安装 Oracle 12CR2 RAC 数据库 - 图5](/images/4ae7e82aed5e9ef2b241abc9862fd72c.webp)
...
![《零基础安装 Oracle 数据库》RAC集群系列 ❷ 简单两步快速安装 Oracle 12CR2 RAC 数据库 - 图6](/images/b38c240f475faef0f45e97f4a8b3b221.webp)
...
![《零基础安装 Oracle 数据库》RAC集群系列 ❷ 简单两步快速安装 Oracle 12CR2 RAC 数据库 - 图7](/images/4e9d824b031edb18f4ac6c8e319c4614.webp)
...
![《零基础安装 Oracle 数据库》RAC集群系列 ❷ 简单两步快速安装 Oracle 12CR2 RAC 数据库 - 图8](/images/6e8f31fd3ffc2245987dfea0b7454fab.webp)

...
tags:
  ...
  - vagrant
abbrlink: 119843603
csdn_url: https://luciferliu.blog.csdn.net/article/details/119843603
...
![《零基础安装 Oracle 数据库》单机系列 ② 一键快速安装 Oracle 12CR2 数据库](/images/6498280d0b8037bd8fce04581e1ee035.webp)
...
**📢 注意：** 项目 `single_db/software/12201` 目录中有一个 `software.txt` 文件，内容为你需要上传的 Oracle 安装包。请确保安装包名称与以下名称相同，否则安装 **失败**！
...
![《零基础安装 Oracle 数据库》单机系列 ② 一键快速安装 Oracle 12CR2 数据库 - 图4](/images/644c43399983590f415749804cc0f3b4.webp)
...
![《零基础安装 Oracle 数据库》单机系列 ② 一键快速安装 Oracle 12CR2 数据库 - 图5](/images/3d6bf124ce6cc5797d1667188a9ec43f.webp)

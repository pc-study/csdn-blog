...
![](/csdn-blog/images/6977003e7e707502fed50cd1114a2f03.png)

如果使用 `S3 Browser` 记得要选择 `Virtual hosted style`：

![](/csdn-blog/images/efb36a4c82955cdd7db9be7dc7cfe969.png)

阿里云 OSS 不支持 `Path style`，会报错：

![](/csdn-blog/images/a2c1ed4311607373d01d3321a1e70ba5.png)

连接后可以看到创建好的 OSS 存储以及里面的内容，测试可以正常上传文件：

![](/csdn-blog/images/367abbdea19194dabc2b766d4ebd3a8f.png)
...
![](/csdn-blog/images/ec78baff1e3d79fe8d1d98229c40b7d1.png)

是因为在 provider 是 alibaba 的情况下，没有使用到环境变量中 AK/SK 的问题导致的这个报错，但是在 **BR v7.5.3** 版本已经进行修复：

![](/csdn-blog/images/98cc07a52cdb6916e8e51fbf6a83251a.png)
...
![](/csdn-blog/images/d79668c15893073180573777965306e5.png)

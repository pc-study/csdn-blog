---
title: 'Ubuntu 22.04 一键安装 Oracle 19C 单机'
date: 2024-06-18 17:01:08
categories:
  - Linux 运维
tags:
  - ubuntu
  ...
  - postgresql
abbrlink: 139778523
csdn_url: https://luciferliu.blog.csdn.net/article/details/139778523
description: '前言 Oracle 一键安装脚本，演示华为 Ubuntu 22.04 一键安装 Oracle 19C 单机版过程（全程无需人工干预）。 ⭐️ 脚本下载地址：Shell脚本安装Oracle数据库 安装准备 1、安装好操作系统，建议安装图形化 2、配置好网络 3、上传软件安装包（安装基础包，补丁包） 4'
keywords: 'ubuntu, oracle, postgresql'
cover: '/img/covers/linux.svg'
---
## 前言

Oracle 一键安装脚本，演示华为 Ubuntu 22.04 一键安装 Oracle 19C 单机版过程（全程无需人工干预）。
...
-rwx------ 1 root root 3059705302  6月  6 12:21 LINUX.X64_193000_db_home.zip
-rwxr-xr-x 1 root root     218544  6月  6 12:20 OracleShellInstall
```
...
正在配置网络软件源......已完成 (耗时: 43 秒)
正在获取操作系统信息......已完成 (耗时: 1 秒)
正在安装依赖包......已完成 (耗时: 220 秒)
...
正在解压 Oracle 安装包以及补丁......已完成 (耗时: 108 秒)
正在安装 Oracle 软件以及补丁......已完成 (耗时: 160 秒)
正在创建监听......已完成 (耗时: 21 秒)
正在创建数据库......已完成 (耗时: 702 秒)
正在优化数据库......已完成 (耗时: 30 秒)

恭喜！Oracle 单机安装成功 (耗时: 1302 秒)，现在是否重启主机：[Y/N] Y
...
LSNRCTL for Linux: Version 19.0.0.0.0 - Production on 06-JUN-2024 12:56:03

Copyright (c) 1991, 2019, Oracle.  All rights reserved.

Connecting to (DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=Ubuntu22)(PORT=1521)))
STATUS of the LISTENER
------------------------
Alias                     LISTENER
Version                   TNSLSNR for Linux: Version 19.0.0.0.0 - Production
Start Date                06-JUN-2024 12:52:44
...
SQL*Plus: Release 19.0.0.0.0 - Production on Thu Jun 6 12:56:03 2024
Version 19.3.0.0.0

---
title: 'RAC：Oracle 12CR2 数据库一键安装'
date: 2022-07-17 12:13:08
categories:
  - Oracle 数据库
tags:
  - oracle
  ...
  - linux
abbrlink: 125830413
csdn_url: https://luciferliu.blog.csdn.net/article/details/125830413
description: '前言 本文将演示如何使用脚本一键安装 Oracle 12CR2 RAC 2 节点数据库的全过程。 安装前准备 在生产环境中，Linux 操作系统和网络一般不是由 DBA 来配置，为了更贴合生产使用，本脚本仅用于安装 Oracle 数据库，请提前安装好 Linux 操作系统。 环境信息 主机版本 主机'
...
[RAC：Oracle 12CR2 2 节点数据库一键安装](https://www.bilibili.com/video/BV1oa411n78P)

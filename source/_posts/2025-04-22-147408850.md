...
tags:
  ...
  - 数据库
abbrlink: 147408850
csdn_url: https://luciferliu.blog.csdn.net/article/details/147408850
description: '大家好，这里是 DBA学习之路，专注于提升数据库运维效率。 目录 前言 环境信息 Oracle 一键安装 主库环境 备库环境 ADG 快速搭建 主库开启归档和强制日志 主库增加 standby redo 日志 配置 hosts 配置 TNS DBCA 搭建 ADG 主库设置 ADG 参数 备库设置'
keywords: 'oracle, 数据库'
...
* [前言](#_4)
* [环境信息](#_16)
* [Oracle 一键安装](#Oracle__24)
* + [主库环境](#_30)
  + [备库环境](#_100)
* [ADG 快速搭建](#ADG__164)
* + [主库开启归档和强制日志](#_167)
  + [主库增加 standby redo 日志](#_standby_redo__181)
  + [配置 hosts](#_hosts_218)
  + [配置 TNS](#_TNS_241)
  + [DBCA 搭建 ADG](#DBCA__ADG_301)
  + [主库设置 ADG 参数](#_ADG__335)
  + [备库设置 ADG 参数](#_ADG__345)
  + [备库开启日志应用](#_356)
  + [检查同步情况](#_363)
...
![别再手动搭建 Oracle ADG 了！这个脚本让你效率翻倍](/images/ce61867d8fd053397ea43ecbb5e4580b.webp)
...
|角色|IP|数据库版本|DB\_NAME|DB\_UNIQUE\_NAME|SERVICES\_NAME|TNS\_NAME|  
 |–|–|–|–|–|–|–|–|  
 |主|192.168.6.191|19C|orcl|orcl|orcl|ORCL\_PRI|  
 |备|192.168.6.121|19C|orcl|orcldg|orcldg|ORCL\_STB|

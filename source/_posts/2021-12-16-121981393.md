---
title: 'New DocumentApache Log4j Security Alert CVE-2021-44228 Products and Versions (Doc ID 2828594.1)'
date: 2021-12-16 18:51:05
categories:
  - 数据库
tags:
  - log4j
  - 数据库
abbrlink: 121981393
csdn_url: https://luciferliu.blog.csdn.net/article/details/121981393
description: 'In this Document PURPOSE SCOPE DETAILS Applicability of Security Alert CVE-2021-44228 to Oracle Clouds Applicability of Security Alert CVE-2021-44228'
keywords: 'log4j, 数据库'
...
* [SCOPE](#SCOPE_4)
* [DETAILS](#DETAILS_7)
* + [Applicability of Security Alert CVE-2021-44228 to Oracle Clouds](#Applicability_of_Security_Alert_CVE202144228_to_Oracle_Clouds_20)
  + [Applicability of Security Alert CVE-2021-44228 to Oracle on-premises products](#Applicability_of_Security_Alert_CVE202144228_to_Oracle_onpremises_products_24)
  + [1.0 Oracle products with patches or mitigation available](#10_Oracle_products_with_patches_or_mitigation_available_28)
  + [2.0 Oracle products with patches pending](#20_Oracle_products_with_patches_pending_130)
  + [3.0 Oracle products under investigation](#30_Oracle_products_under_investigation_176)
  + [4.0 Oracle products with impacted underlying Oracle components](#40_Oracle_products_with_impacted_underlying_Oracle_components_224)
  + [5.0 Oracle products not requiring patches](#50_Oracle_products_not_requiring_patches_229)

## PURPOSE

This document details the Oracle Products and Versions affected by CVE-2021-44228, an Apache Log4j 2 vulnerability described in Security Alert CVE-2021-44228.
...
The impact of the Apache Log4j vulnerability CVE-2021-44228 on Oracle products, for releases and versions that are in Premier Support or Extended Support under the Oracle Lifetime Support Policy, is listed in the appropriate categories below.

**Note:**

* Oracle is aware of CVE-2021-45046 and this document and related documents will be updated to indicate the patching status for CVE-2021-45046.
...
* **Reminder:** Oracle **strongly** recommends that customers remain on actively-supported versions and apply Critical Patch Update security patches without delay. For the most recent Critical Patch Updates, see <https://www.oracle.com/security-alerts/>.
...
**This page was last updated on: December 15, 2021 at 03:49 PM PST.**

### Applicability of Security Alert CVE-2021-44228 to Oracle Clouds
...
Oracle has determined that the following Oracle products are vulnerable and have patches or mitigation available for CVE-2021-44228. For patch and mitigation availability information refer to the individual Patch Availability Documents referenced in the table below.
...
| Autonomous Health Framework / Trace File Analyzer [Product ID 10655] | 2796575.1 |
| Autovue for Agile Product Lifecycle Management [Product ID 4434] | 2827700.1 |
| Communications Convergent Charging Controller [Product ID 12985] | 2827826.1 |
| Communications Evolved Communications Application Server [Product ID 10994] | 2828268.1 |
| Communications Instant Messaging Server [Product ID 8495] | 2827846.1 |
| Communications IP Service Activator [Product ID 2261] | 2827897.1 |
| Communications Messaging Server [Product ID 8496] | 2827846.1 |
| Communications Network Charging and Control [Product ID 4623] | 2827826.1 |
| Communications Offline Mediation Controller [Product ID 2269] | 2827844.1 |
| Communications Pricing Design Center [Product ID 9437] | 2827844.1 |
| Communications Unified Inventory Management [Product ID 4516] | 2827890.1 |
| Communications WebRTC Session Controller [Product ID 10811] | 2828270.1 |
| Enterprise Manager for Peoplesoft [Product ID 2131] | 2828293.1 |
| Enterprise Manager Ops Center [Product ID 9835] | 2828286.1 |
| Health Insurance Enterprise Commissions [Product ID 12596] | 2827793.1 |
| Health Sciences Data Management Workbench [Product ID 9581] | 2827966.1 |
| Health Sciences Empirica Signal [Product ID 9646] | 2828060.1 |
| Health Sciences Information Manager [Product ID 9177] | 2827979.1 |
| Healthcare Foundation [Product ID 12950] | 2828054.1 |
| Hyperion Data Relationship Management [Product ID 4375] | 2828248.1 |
| Hyperion Essbase [Product ID 4379] | 2827793.1 |
| Identity Manager Connector [Product ID 1999] | 2828241.1 |
...
| Managed File Transfer [Product ID 10198] | 2828548.1 |
| MySQL Enterprise Monitor [Product ID 8480] | 2827698.1 |
| Oracle Agile Engineering Collaboration [Product ID 4439] | 2827700.1 |
| Oracle Agile PLM MCAD Connector [Product ID 4440] | 2827700.1 |
| Oracle Analytics Desktop [Product ID 12791] | 2828540.1 |
| Oracle Analytics Server [Product ID 2025] | 2828398.1 |
| Oracle API Gateway [Product ID 9195] | 2828365.1 |
| Oracle Banking Deposits and Lines of Credit Servicing [Product ID 13928] | 2828115.1 |
| Oracle Banking Enterprise Collections [Product ID 13390] | 2828115.1 |
| Oracle Banking Loans Servicing [Product ID 13927] | 2828115.1 |
| Oracle Banking Party Management [Product ID 13929] | 2828115.1 |
| Oracle Banking Platform [Product ID 9178] | 2828115.1 |
| Oracle Big Data Appliance [Product ID 9734] | 2828023.1 |
| Oracle Communications ASAP [Product ID 2260] | 2827910.1 |
| Oracle Communications Billing and Revenue Management [Product ID 2136] | 2827844.1 |
| Oracle Communications BRM Elastic Charging Engine [Product ID 9742] | 2827844.1 |
| Oracle Communications Convergence [Product ID 8501] | 2827846.1 |
| Oracle Communications Diameter Signaling Router [Product ID 10899] | 2828201.1 |
...
| Oracle Data Integrator (ODI) [Product ID 2196] | 2827929.1 |
...
| Oracle Enterprise Performance Management [Product ID 4392] | 2828262.1 |
| Oracle Enterprise Repository [Product ID 5326] | 2827793.1 |
| Oracle Fusion Middleware Infrastructure [Product ID 1032] | 2827793.1 |
| Oracle GoldenGate Application Adapters [Product ID 5760] | 2828058.1 |
| Oracle GoldenGate Studio [Product ID 10945] | 2828091.1 |
...
| Oracle Healthcare Translational Research [Product ID 9427] | 2828329.1 |
| Oracle Hospitality Gift and Loyalty [Product ID 11600] | 2827908.1 |
| Oracle Hospitality Labor Management [Product ID 11601] | 2827908.1 |
| Oracle Hospitality OPERA 5 [Product ID 12726] | 2827653.1 |
| Oracle Hospitality Reporting and Analytics [Product ID 11599] | 2827908.1 |
| Oracle Hospitality RES 3700 [Product ID 11596] | 2828515.1 |
| Oracle Hospitality Simphony [Product ID 11594] | 2828331.1 |
| Oracle Hospitality Simphony First Edition [Product ID 11591] | 2828514.1 |
| Oracle Hospitality Token Proxy Service [Product ID 13387] | 2827732.1 |
...
| Oracle Policy Automation [Product ID 5624] | 2827722.1 |
| Oracle Real Time Decision Server (RTD Server) [Product ID 2104] | 2827793.1 |
| Oracle Reports Developer [Product ID 159] | 2827793.1 |
| Oracle Retail Invoice Matching [Product ID 1810] | 2828547.1 |
| Oracle Spatial and Graph [Product ID 619] [See | 2828303.1] |
| Oracle Unified Directory (OUD) [Product ID 9118] | 2827793.1 |
| Oracle WebCenter Sites [Product ID 9617] | 2827793.1 |
...
| Product Lifecycle Analytics [Product ID 9387] | 2828294.1 |
| Siebel UI Framework [Product ID 9011] | 2828323.1 |
| SQL Developer and SQL Developer Data Modeler [Product ID 1875] | 2796575.1 |
| Utilities Network Management System [Product ID 2241] | 2827974.1 |
| WebCenter Portal [Product ID 1696] | 2827977.1 |
...
* Oracle Analytics Client Tools [Product ID 2025]
* Oracle Data Gateway [Product ID 2025]
...
* Outside In Technology [Product ID 2276]
